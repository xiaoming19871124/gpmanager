...
(function (J) {
    ...
    J.register("module", ["private", "modules.renderer.js-gradientlegend",
        function () {
            function a(d, h) {
                (function k(t, h) {
                    var x, p;
            ...
            y = function () {
                function d(k) {
                    ...
                    for (p = k.length; x < p; x++)
                        if (G = k[x].maxvalue) k[x].maxvalue =
                            q.getCleanValue(G)
                }
                var h, q, k = {
                    legendCarpetConf: {
                ...
                return {
                    init: function (k) {
                        q = k.chart;
                        h = q.components
                    }, setConf: function (k) {}, legacyDataParser: function (k, q) {
                        var x = {},
                            p = h.numberFormatter,
                            G, u, g, f, a, L, y, U, n;
                        if (!k) return !1;
                        ...
                        for (k in q)
                            for (t in h = q[k], h)
                                if (x = h[t], x instanceof Array)
                                    for (d = 0, O = x.length; d < O; d++) x[d] && x[d].hide();
                                else x.hide()
                    }
                    var t, O = {},
                        x;
            ...
            W.prototype.getLogicalSpace = function (d, h) {
                ...
                q.x += k.h;
                q.y += k.v;
                for (u in t) O = t[u], k = a(q, {}), k.y += p, p = q.height * O.conf.spreadFactor, k.height = p + b, p = O.getLogicalSpace(a(k, {}), d, h), b = k.height - p.height, G[u] = p, p = p.height;
            ...
            W.prototype.draw = function (d) {
                var h = this.conf,
                    ...
                    t = d.parentGroup,
                    O = d.componentPool,
                    x, p, G = O.getChart().get("config", "animationObj").duration,
                    u, b = O.getKeys();
            ...
            B.prototype.getLogicalSpace = function (d, h, q) {
                ...
                for (g = B.SC_STACK.length; b <
                    g; b++)
                    if (t = O[B.SC_STACK[b]]) x = G(x, t.conf.spreadFactor), x = t.getLogicalSpace(a(x, {}), h, q), u += this.getSpaceTaken(x);
            ...
            M.prototype.getLogicalSpace = function (d, h, q) {
                ...
                L = h.getSmartText("W");
                p = 0;
                for (t = x.length; p < t; p++)(b = x[p].label) ? (w++, P.push({
                    oriIndex: p,
                    label: b
                })) : f[p] = void 0;
                t = P.length;
            ...
            M.prototype.draw = function () {
                ...
                for (O = x.length; p < O; p++)
                    if (k = x[p]) G = t.y + k.height / 2, u = p === O - 1 ? t.x + k.x - k.width / 2 : p ? t.x + k.x : t.x + k.x + k.width / 2, this.node.push(b({}, d).attr({
                        text: k.text,
                        x: u,
                        y: G,
                        lineHeight: this._metaStyle.lineHeight,
            ...
            R.prototype.draw =
                function () {
                    ...
                    p = 0;
                    for (O = x.length; p < O; p++)
                        if (k = x[p]) G = t.x + k.height / 2, u = p === O - 1 ? t.y + k.y - k.width / 2 : p ? t.y + k.y : t.y + k.y + k.width / 2, this.node.push(b({}, d).attr({
                            text: k.text,
                            x: G,
                            y: u,
                            lineHeight: this._metaStyle.lineHeight,
            ...
            r.prototype.draw = function () {
                ...
                for (p = k.length; q < p; q++)
                    if (u = G[q]) k = x.y + u.height / 2, t = q === p - 1 ? x.x + u.x - u.width / 2 : q ? x.x + u.x : x.x + u.x + u.width / 2, b({}, O).attr({
                        text: u.text,
                        x: t,
                        y: k,
                        lineHeight: this._metaStyle.lineHeight,
            ...
            v.prototype.draw = function () {
                var d, h = this.conf,
                    q = h.line,
                    k = (h.bound || {}).style || {},
                    t, O, x = this.compositionsByCategory,
                    p, G, u, b, g, f;
    ...
    J.register("module", ["private", "modules.renderer.js-msstepline",
        function () {
            var a = this.hcLib,
                c = this.window,
            ...
            J.register("module", ["private", "modules.renderer.js-dataset-group-msstepline",
                function () {
            ...
            J.register("component", ["dataset", "MSStepLine", {
                    ...
                    _addLegend: function () {
                        ...
                        var b = this,
                            ...
                            P, ka, d = f.graphics;
                        L = d.datalabelsGroup;
                        var N, T, h, q, k, t, O = b.components.data,
                            x, p = b.components.removeDataArr || [],
                            G = p.length,
                            u = m.linethickness,
                            ...
                            La = d.datasetGroup,
                            aa, d = m.shadow,
                            db, c = b.graphics.dataLabelContainer,
                            ta = {},
                            C, e, ta = f.get(R, r),
                            Qa = ta.dummyObj,
                            Ea = ta.animObj,
                            ...
                            fa, ha = [],
                            ca = !1,
                            Aa, ya = b.graphics.lineElement,
                            Y = b.visible,
                            ua = m.drawverticaljoins,
                            xa = m.useforwardsteps,
                            za, Ga = ta.animType,
                            Ma = 0,
                            ra, f = f.config.stepatmiddle ? .5 * g.getPVR() : 0,
                            Ba, Ua = ga.canvasTop,
                            Ja = ga.canvasBottom;
                        m.imagesLoaded = 0;
                        ...
                        L = g.getCategoryLen();
                        for (w = 0; w < L; w++)
                            if (x = O[w]) e = x.config, q = e.setValue, h = e.setLink, k = e.setLevelTooltext, ta = e.anchorProps,
    ...
    J.register("module", ["private", "modules.renderer.js-powercharts",
        function () {
            var a = this.hcLib,
                c = a.Raphael,
                E = a.pluckNumber,
    ...
    J.register("module", ["private", "modules.renderer.js-spline",
        function () {
            var a = this.hcLib,
                c = Math.round,
            ...
            a("spline", {
                ...
                getSplineExtremities: function (a, c, E, S, I) {
                    ...
                    for (I = 0; 10 > I; ++I)
                        for (B = 0; B < a.length; ++B) X = 0 === B ? (3 * (a[B + 1].y - a[B].y) - S["D" + a[B + 1].index]) / 2 : B === a.length - 1 ? (3 * (a[B].y - a[B - 1].y) - S["D" + a[B - 1].index]) / 2 : (3 * (a[B +
    ...
    J.register("module", ["private", "modules.renderer.js-splinearea",
        function () {
            var a = this.hcLib,
                c = a.HUNDREDSTRING,
                E = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-mssplinearea",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-mssplinedy",
        function () {
            var a =
                this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-multiaxisline",
        function () {
            var a = this.hcLib,
                c = this.window,
                E = a.pluck,
            ...
            a("multiaxisline", {
                ...
                _createDatasets: function () {
                    var b = this.components,
                        ...
                        w = f.axis,
                        U, g, y, P, n = 0,
                        d, N, T = this.defaultDatasetType,
                        h = this.applicableDSList,
                        q = b.legend.components.items || [],
                        k, t, O, x, p = this.config.isstacked,
                        G, u = {},
                        da = 0,
                        ma;
                    if (w) {
                    ...
                    for (U = 0; U < w; U += 1) {
                        ...
                        Infinity === y && (y = 0); - Infinity === g && (g = y + 1);
                        b[U].setDataLimit(g, y);
                        g = -Infinity;
                        y = Infinity
                    }
                }, _spaceManager: function () {
                    var b, a, f, w = this.config,
                        U = w.axesArr,
                        g = this.components;
                    f = w.legendPosition;
                    var y = g.xAxis;
                    ...
                    var f = a.components.dataset,
                        ...
                        U;
                    if (this.checked)
                        for (U in f) f.hasOwnProperty(U) && (f[U].visible || f[U].axisIndex !==
                            b || f[U].show());
                    else
                        for (U in f) f.hasOwnProperty(U) && f[U].visible && f[U].axisIndex === b && f[U].hide();
                    w.drawLegend()
                    ...
                    for (z = aa.length - 1; 0 <= z; --z)
                        if (0 !== aa[z].showAxis && (u = a.canvasLeft -
                            ...
                            v.height = ma;
                            if (d[G])
                                for (ma = d[G].attr(v), ma.show(), u = 0, da = ma.events.length; u < da; u++) ma.events[u].unbind(), ma.events.splice(u, 1), --da;
                            else ma = d[G] = y.rect(v, N);
                            ma.data("axisDetails", {
                                iapi: this,
                                position: "l",
                                index: z
                    ...
                    if (!b)
                        for (z = 0, x = g.length; z < x; z++) g[z].draw();
                    z = 0;
    ...
    J.register("module", ["private", "modules.renderer.js-inversemsline",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                E = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-inversemsarea",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-inversemscolumn2d",
        function () {
            var a =
                this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-logmsline",
        function () {
            var a = this.hcLib,
                c = a.preDefStr.line,
                E = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-logmscolumn2d",
        function () {
            var a = this.hcLib,
    ...
    J.register("module", ["private", "modules.renderer.js-logstackedcolumn2d",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-errorbar2d",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-errorline",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
    ...
    J.register("module", ["private", "modules.renderer.js-errorscatter",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
    ...
    J.register("module", ["private", "modules.renderer.js-waterfall2d",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                E = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-multilevelpie",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                E = !a.CREDIT_REGEX.test(this.window.location.hostname),
            ...
            c("multilevelpie", {
                ...
                _createDatasets: function () {
                    ...
                    R = a.dataset ||
                        (a.dataset = []);
                    for (a = 0; a < M; a += 1)
                        if (c = E[a], c.seriesname && (c.seriesname = e(c.seriesname)), r = c.parentyaxis || ba, r = (r = r.toLowerCase() === W ? S(c.renderas, this.sDefaultDatasetType) : S(c.renderas, D)) && r.toLowerCase(), v[r] || (r = D), A = J.get("component", ["dataset", r])) void 0 === F[r] ? F[r] = 0 : F[r]++, R[0] ? (r = R[0], r.JSONData = c) : (r = new A, R.push(r), r.chart = this, r.index = a), r.init(E)
                }, _spaceManager: function () {
                    var a = this.config;
    ...
    J.register("module", ["private", "modules.renderer.js-radar",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                a = !a.CREDIT_REGEX.test(this.window.location.hostname);
    ...
    J.register("module", ["private", "modules.renderer.js-dragbase",
        function () {
            var a = this,
                c = a.hcLib,
                E = a.window,
            ...
            m("dragbase", {
                configure: function () {
                        ...
                        var b = this,
                            ...
                            n, g, y, P = b.components,
                            c, d, N, z = b.linkedItems.smartLabel,
                            h = b.config,
                            q = h.showRestoreBtn,
                            k = h.formAction,
                            t = h.restoreBtnTitle,
                    ...
                    eiMethods: {
                        getDataWithId: function () {
                            for (var b = this.jsVars.instanceAPI.getJSONData(), a = [
                                [B]
                            ], f = b.dataset, b = b.categories && b.categories[0] && b.categories[0].category, g = f && f.length || 0, n = 0, c, z, d, N, r, h; g--;)
                                if (z = f[g])
                            ...
                            var f = this.jsVars.instanceAPI,
                                ...
                                d = 0,
                                r, m;
                            if (b) g = /^json$/ig.test(b) ? n : a.core.transcodeData.call(f.chartInstance, n, "json", b);
                            else
                                for (; z--;)
                                    if (b = y[z])
                            ...
                            else return f.changeUpperLimits(b)
                            ...
                            else return f.changeLowerLimits(b)
                            ...
                            var a = this.apiInstance,
                                ...
                                a = a.getJobList();
                            if (g)
                                if (b) a.eiMethods.push(C.addJob(function () {
                                    b(g.config.axisRange.min)
                                }, H.postRender));
                                else return g.config.axisRange.min
                            ...
                            if (g)
                                ...
                                else return g.config.axisRange.max
                        }
                        ...
                        var b = this.components,
                            ...
                            b = b.legend,
                            g = f.length,
                            n, z = this.graphics.hiddenAxisLabels || [],
                            r;
                        ...
                        var b = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(),
                            ...
                            a = [],
                            d;
                        if (f && f.getJSONData) a = f.getJSONData();
                        else
                            for (f = 0; f < z; f++) n = b[f], d = n.getJSONData(), n = g[f] || {}, delete n.data,
                                a.push(D(n, d));
                        b = D({}, c);
                        b.dataset = a;
                        return b
                        ...
                        var a = b.data.mouseTracker,
                            ...
                            q, k, t = !1,
                            O = d.length,
                            x, p = a._lastDatasetIndex,
                            N = a._lastPointIndex,
                            G, f = f.dragTolerance || 0;
                        void 0 !== N && (G = d[p].components.data[N].config.dragStart);
                        if (!G && m > g - f && m < n + f && h > r - f && h < z + f || !G && this.config.plotOverFlow)
                            for (; O-- && !t;)(q = d[O]) && q.visible && (k = q._getHoveredPlot && q._getHoveredPlot(m, h)) && k.hovered && (t = !0, k.datasetIndex = O, x = a._getMouseEvents(b, k.datasetIndex, k.pointIndex));
                        ...
                        if (t)
                            for (d = x.events && x.events.length, a._lastDatasetIndex = k.datasetIndex, N = a._lastPointIndex = k.pointIndex, a = 0; a < d; a += 1) q && q._firePlotEvent && q._firePlotEvent(x.events[a], N, b)
                    }
            }, m.mscartesian)
        }
    ]);
    J.register("module", ["private", "modules.renderer.js-dragnode",
        function () {
            var a = this,
                c = a.hcLib,
                E = c.ZEROSTRING,
                ...
                configure: function () {
                        ...
                        if (A) {
                            ...
                            for (A in U)
                                if (f = U[A],
                                    ...
                                    for (e = 0; e < l; e++) "dragnode" === A ? (v.removeNodeDataset(ga), v._clearConnectors(), n.removeItem(f[e].legendItemId)) : "connectors" === A ? v.removeConnectorSet(ga) : v.removeLabelSet(ga), I.call(f[e]), ga += 1;
                            a.datasetMap = y
                        } else this.setChartMessage()
                    }, addConfigureOptions: function () {
                    ...
                    deleteConnector: function (r) {
                        ...
                        var a = this.components["datasetGroup_" + this.defaultDatasetType],
                            ...
                            A = a.connectorSet,
                            F, l, C, H, Q = a.labelSet,
                            n = function (b) {
                                var a, f;
                                for (a = 0; a < b.length; a++)
                                    if (C = b[a], delete C.removed, C.config.add)
                                        for (f in H = b[a].graphics, H) H[f].remove()
                            };
                        ...
                        var a = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(),
                            ...
                            c = [],
                            l;
                        if (e) c = e.getJSONData();
                        else
                            for (e = 0; e < F; e++) l = a[e], l = l.getJSONData(), c.push(l);
                        a = S({}, A);
                        a.dataset =
                            c.dataset;
                        ...
                        C = m.length;
                        for (H = 0; H < C; H++) A = m[H].getDataLimits(), Z(A); - Infinity === Q && (Q = 0);
                        Infinity === n && (n = 0);
                        this.config.yMax = Q;
                        this.config.yMin = n;
                        F[0].setAxisConfig({
                        ...
                        if (-Infinity !== z || Infinity !== b) {
                            ...
                            for (C = c.length; H < C; H++)
                                if (v = c[H], v = v.x) v < b && (b = v), v > z && (z = v);
    ...
    J.register("module", ["private", "modules.renderer.js-dragarea",
        function () {
            var a = this.hcLib,
                c = a.HUNDREDSTRING,
                E = !a.CREDIT_REGEX.test(this.window.location.hostname),
    ...
    J.register("module", ["private", "modules.renderer.js-dragline",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                a = !a.CREDIT_REGEX.test(this.window.location.hostname);
    ...
    J.register("module", ["private", "modules.renderer.js-dragcolumn2d",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                a = !a.CREDIT_REGEX.test(this.window.location.hostname);
    ...
    J.register("module", ["private", "modules.renderer.js-selectscatter",
        function () {
            var a = this,
                c = a.hcLib,
                E = a.window,
                e = !c.CREDIT_REGEX.test(E.location.hostname),
                ba = c.getValidValue,
                W = c.extend2,
                S = c.toRaphaelColor,
                I = c.preDefStr,
            ...
            Q("selectscatter", {
                ...
                getData: function (n) {
                    var b = this.getCollatedData(),
                        ...
                        m = 0,
                        Z;
                    if (n) c = /^json$/ig.test(n) ? b : /^csv$/ig.test(n) ? this.getCSVString() : a.core.transcodeData(b, "json", n);
                    else
                        for (; e < l; e += 1)
                            if (b = f[e]) {
                        ...
                        if (e = b[z])
                            for (w = e.startX, U = e.endX, g = e.startY, y = e.endY, r = l.length; r--;)
                                if (c[r].visible)
                                    for (P[r] || (P[r] = {
                                        data: []
                                    }), L = (Z = l[r].data) && Z.length; L--;) m = Z[L],
                                        e = m.x, m = m.y, e > w && e < U && m < g && m > y && (P[r].data[L] = !0);
                    for (r = l.length; r--;)
                        for (L = (Z = l[r].data) && Z.length; L--;) P[r] && P[r].data[L] || Z.splice(L, 1);
    ...
    J.register("module", ["private", "modules.renderer.js-candlestick",
        function () {
            var a = this.hcLib,
                c = !a.CREDIT_REGEX.test(this.window.location.hostname),
                E = a.chartAPI,
            ...
            E("candlestick", {
                ...
                init: function (b, a, f, d) {
                    ...
                    var b, a, f, d = this.components.colorManager,
                    ...
                    if (d) {
                        ...
                        for (d in z)
                            if (aa = z[d], h = aa.length)
                                for (g = 0; g < h; g++) L.removeItem(aa[g].legendItemId), M.call(aa[g]);
                        b.datasetMap = l
                    } else this.setChartMessage()
                }, _spaceManager: function () {
                    var b, a, f, d = this.config,
                        g = this.components,
                        c = d.legendPosition,
                        h = g.xAxis && g.xAxis[0],
                        q = g.xAxis && g.xAxis[1],
                    ...
                    a = this.hasLegend;
                    var O = g.legend,
                        x, p = this.config.showVolumeChart,
                    ...
                    var b = this.components,
                        ...
                        Z, A = this.config.showVolumeChart,
                        V = k.shadow,
                    ...
                    var b = this.components,
                        a, g = J.register("component", ["axis", "cartesian"]),
            ...
            c("kagi", {
                    ...
                    _postSpaceManagement: function () {
                        ...
                        var A = a.dataset[0],
                            ...
                            Q = H,
                            n = [];
                        for (a = 0; a < l; a++) c = A[a].config, e = c.setValue, (E = A[a]) || (A[a] = {
                                graphics: {}
                        ...
                        n(this._getTrendLineMinMax("h")); - Infinity === v && (v = 0);
                        Infinity === A && (A = 0);
                        this.config.yMax = v;
                        this.config.yMin = A;
                        E[0].setAxisConfig({
    ...
    J.register("module", ["private", "modules.renderer.js-boxandwhisker2d",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                E = a.pluck,
            ...
            c("boxandwhisker2d", {
                ...
                _drawDataset: function () {
                    ...
                    a.flag = !0;
                    for (b = 0; b < n; b++)
                        for (a[b].components.mean && a[b].components.mean.draw(), a[b].components.sd && a[b].components.sd.draw(), a[b].components.md && a[b].components.md.draw(), a[b].components.qd && a[b].components.qd.draw(), z = a[b].config.maxNumberOfOutliers || a[b].components.outliers.length, c = 0; c < z; c++) a[b].config.showOutliersLegend ||
                    ...
                    var a = this.components,
                        ...
                        b = n.dataset,
                        z = b && b.length,
                        f, l, r, m = this.defaultDatasetType,
                        v = this.applicableDSList,
                        A = this.components.legend;
                    f = A.components.items || [];
                    var L, w, U, g, y = this.isStacked,
                        P, C, d = [],
                        N = this.isRealTime,
    ...
    J.register("module", ["private", "modules.renderer.js-heatmap",
        function () {
            var a = this.hcLib,
                c = a.chartAPI,
                E = a.pluckFontSize,
            ...
            c("heatmap", {
                ...
                _createAxes: function () {
                    ...
                    this._adjustCanvasPadding()
                }, _adjustCanvasPadding: function () {}, _feedAxesRawData: function () {
                    ...
                    c.configure();
                    this._setCategories()
                }, _setAxisLimits: function () {}, _setCategories: function () {
                    var a = this.components,
                        c = this.jsonData,
                        r = a.xAxis,
                        a = a.yAxis,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorbar2d",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.colors,
            ...
            J.register("component", ["dataset", "ErrorBar2D", {
                configure: function () {
                    var k = this.chart,
                        ...
                        m, y = da.getPlotColor(this.index || this.positionIndex),
                        ...
                        V = a.parseTooltext,
                        H, ga, D, E, ka,
                        B, M, I, W, S, X, R, ba, J, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za, Ga, Ma = a.getDashStyle,
                    ...
                    for (eb = 0; eb < c; eb++) B = x && x[eb], ea = (E = ra[eb]) && E.config, E || (E = ra[eb] = {
                            graphics: {}
                        ...
                        ea.toolTipValue = ga = Ba.dataLabels(E, ja), ea.setDisplayValue = y = r(B.displayvalue), ea.displayValue = Q(y, ga), ga = b(B.dashed), y = b(B.dashlen, M), H = I = b(B.dashgap, I), ea.plotBorderDashStyle = H = 1 === ga ? Ma(y, H, L) : 0 === ga ? "none" : aa, y = Q(B.color, d.plotColor), R = Q(B.alpha, d.plotFillAlpha), 0 > E && !W && (ka = X, X = Ua ? 180 - X : 360 - X), ea.colorArr = sa = a.graphics.getColumnColor(y + "," + J, R, ba, X, W, ia, la.toString(), Ua ? 1 : 0, Ja ? !0 : !1), ea.label = ga = n(r(Q(p[eb].tooltext, p[eb].label))), 0 !== S && (fa = Q(B.hovercolor, q.hovercolor, u.plotfillhovercolor, u.columnhovercolor,
                            ...
                            fill: Ja ? [f(y[0]), !d.use3DLighting] : f(y[0]),
                            stroke: m && f(y[1]),
                            "stroke-width": R,
                            "stroke-dasharray": xa
                    ...
                    var k = this.chart,
                        ...
                        f,
                        w, e, y = this.components.data,
                        m = k(c.yaxisname),
                        l = k(c.xaxisname),
                        L, r = b(c.seriesnameintooltip, 1),
                        N, P = k(Q(c.tooltipsepchar, K)),
                        Z, v, A, V, ga, E, D, B = -Infinity,
                        F = Infinity,
                        M, I, W, S, X, R = function (k) {
                    ...
                    var A, H, K = a.parseUnsafeString,
                        ...
                        ia, ba = Fa.xPosOffset || 0,
                        Fa = Fa.height,
                        ea, sa, J = k.components.data,
                        fa, ha, ca, Aa, ya, wa = v.getLimit(),
                        Y = wa.min,
                        wa = 0 < wa.max && 0 > Y,
                        Y = v.getAxisBase(),
                    ...
                    if (h)
                        for (k = 0; k < f; k++) c[k].graphics.element && c[k].graphics.element.attr(D, r);
                    else k.show();
                    a.show();
                    d && d.show();
                    b && b.show();
                    ...
                    var a = this.chart,
                        ...
                        D, E, Q, B, F, ka, I, R, ba, J, ia, ea, sa, fa, ha, ca = 5 < T ? T / 2 : 2.5,
                        Aa;
                    ...
                    for (h = 0; h < b; h++) {
                        ...
                        if (f && (void 0 === E || null === E))
                            for (f.graphics.element && (f.graphics.element.hide(), f.graphics.element.shadow(!1)), f.graphics.hotElement && f.graphics.hotElement.hide(), R = f.graphics.error && f.graphics.error.length, c = 0; c < R; c++) f.graphics.error && f.graphics.error[c] && (f.graphics.error[c].hide(), f.graphics.error[c].shadow({
                                opacity: 0
                            }));
                        if (void 0 !== f && void 0 !== E && null !== E)
                            if (f.errorBar && delete f.errorBar, ka = g.errorValueArr, Aa.errorLen = R = ka.length, !f.graphics.error && (f.graphics.error = []), !f.graphics.errorTracker && (f.graphics.errorTracker = []), g.errorValue === C || void 0 === g.errorValue || null === g.errorValue && null === g.positiveErrorValue && null === g.negativeErrorValue)
                                for (c = 0; c < R; c++) f.graphics.error && f.graphics.error[c] && (f.graphics.error[c].hide(), f.graphics.error[c].shadow({
                                    opacity: 0
                                }));
                            else {
                                J = k + "_" + h;
                                ...
                                if (!g.notHalfErrorBar)
                                    for (c = 2; 4 > c; c++) f.graphics.error && f.graphics.error[c] && f.graphics.error[c].hide() && f.graphics.error[c].shadow({
                                        opacity: 0
                                    })
                            }
                    }
                    ...
                    if (q && (q = q.errorBar))
                        for (c = q && q.length; c--;)
                            for (g = (f = q[c]) && f.length; g--;)
                                if (f[g] && f[g]._xPos && (h = f[g]._xPos, w = f[g]._yPos, e = f[g]._height, z = f[g]._width, n = f[g]._toolText, h = d >= h && d <= h + z && a >= w && a <= w + e)) return {
                                    pointIndex: k,
                                    hovered: h,
                                    pointObj: b[k],
                                    toolText: n
                    ...
                    for (g = 0; g < q; g++)
                        if (h = a[0], a.splice(0, 1), h && h.graphics) {
                            ...
                            for (n = 0; 4 > n; n++) c.error && c.error[n] && c.error[n].hide() && c.error[n].shadow({
                                opacity: 0
                            });
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorline",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.colors.AAAAAA,
            ...
            J.register("component", ["dataset", "ErrorLine", {
                    ...
                    ErrorValueConfigure: function () {
                        ...
                        var ma = -Infinity,
                            ...
                            aa, C = d(l.yaxisname),
                            F = d(l.xaxisname),
                            ta, I = R(l.tooltipsepchar, A),
                            W, Qa, Ea, S, ba = D(l.seriesnameintooltip, 1),
                            J = function (d) {
                        ...
                        var a = this.config,
                            ...
                            da, v, Z, aa, A, H, V, K, C, D, E = 5 < t ? t / 2 : 2.5,
                            B, M;
                        ...
                        for (c = 0; c < g; c++)
                            if (p = N[c], M = p.errorTrackerConfig = {}, M.errorTrackerArr = [], aa = (m = p && p.config) && m.setValue, void 0 === p || void 0 === aa ||
                                null === aa) {
                                if (p.graphics.error)
                                    for (m = 0; m < p.graphics.error.length; m++) p.graphics.error[m].hide(), p.graphics.errorTracker[m].hide(), p.graphics.error[m].shadow(!1)
                            ...
                            for (m = 0; m < aa; m++) p.graphics.error && p.graphics.error[m] && (p.graphics.error[m].hide(),
                            ...
                            for (p.errorBar = []; aa--;) M.errorTrackerArr[aa] = {}, l = K[aa], M.errorTrackerArr[aa].tooltext = l.tooltext, C = Z, A = l.errorValue, null === A || isNaN(A) ? p.graphics.error && p.graphics.error[aa] && (p.graphics.error[aa].hide(), p.graphics.error[aa].shadow({
                                opacity: 0
                            ...
                            if (!m.notHalfErrorBar)
                                for (m = 2; 4 > m; m++) p.graphics.error && p.graphics.error[m] && p.graphics.error[m].hide() && p.graphics.error[m].shadow({
                                    opacity: 0
                                })
                        }
                    ...
                    _firePlotEvent: J.get("component", ["dataset", "ErrorBar2D"]).prototype._firePlotEvent,
                    ...
                    _checkPointerOverPlot: function (a, b, f) {
                        var c = this.components.data[a],
                            ...
                            n;
                        if (c) {
                            if (n = this.isWithinShape(c, a, b, f)) c.errorBarHovered = !1, g.finalTooltext = !1 !== g.toolText && g.toolText + g.toolTipValue;
                            else if (n = this._checkPointerOverErrorBar(a, b, f)) c.errorBarHovered = !0, g.finalTooltext = n.toolText;
                            return n
                        }
                    }, _getHoveredPlot: J.get("component", ["dataset", "ErrorBar2D"]).prototype._getHoveredPlot,
                    manageSpace: function () {
                        var a = .5 * this.config.errorBarWidth,
                            ...
                            e, z;
                        e = {};
                        var m, d, l, r = f.linkedItems.smartLabel,
                            h = {
                                paddingLeft: 0,
                                paddingRight: 0
                            };
                        ...
                        if (a) {
                            ...
                            for (f = 0; 4 > f; f++) a.graphics.error && a.graphics.error[f] && a.graphics.error[f].hide() && a.graphics.error[f].shadow({
                                opacity: 0
                            });
                            b.hotElement &&
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorscatter",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.colors.AAAAAA,
            ...
            J.register("component", ["dataset", "ErrorScatter", {
                ErrorValueConfigure: function () {
                    var b = this.chart,
                        ...
                        d, N, T, h = this.components.data,
                        q = c.numberFormatter,
                        k, t, O, x, p, G, u, da, ma, La, aa = r(g.tooltipsepchar, A),
                        F = C(g.yaxisname),
                        M = C(g.xaxisname),
                        ta = e.parentYAxis,
                        I, W, Qa, Ea, S, ba, J, pa, Na, Ra, Va, Da, Ia, va, Fa, wa, oa, qa, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za = -Infinity,
                        Ga = Infinity,
                        Ma = Infinity,
                        ra = -Infinity,
                        Ba = function (k, b) {
                    ...
                    for (t = 0; t < P; t++) l && (d = l && l[t], T = (N = h[t]) && N.config, N || (N = h[t] = {
                            graphics: {}
                    ...
                    var c = this.chart,
                        ...
                        ma, V, aa, K, C, D, E, Q, B, Ea, R, X, J, pa, Na = [],
                        Ra;
                    ...
                    for (n = 0; n < m; n++)
                        if (G = d[n], Ra = G.errorTrackerConfig = {}, Ra.errorTrackerArr = [], K = (C = G && G.config) && C.setValue, Q = C.errorValueArr,
                            ...
                            if (null === C.vErrorValue && null === C.vPositiveErrorValue && null === C.vNegativeErrorValue)
                                for (T = 0; 4 > T; T++) G.graphics.error && G.graphics.error[T] && (G.graphics.error[T].hide(), G.graphics.error[T].shadow({
                                    opacity: 0
                                }));
                            if (null === C.hErrorValue && null === C.hPositiveErrorValue && null === C.vPositiveErrorValue)
                                for (T = 4; 8 > T; T++) G.graphics.error && G.graphics.error[T] &&
                            ...
                            if (!(null === C.hErrorValue && null === C.vErrorValue && C.hPositiveErrorValue && C.hNegativeErrorValue && C.vPositiveErrorValue && C.vNegativeErrorValue))
                                for (ma = C.setLink, R = G._xPos, aa = X = G._yPos, V = R, pa = 0; pa < K; pa++)
                                    if (!C.useHorizontalErrorBar && (0 === pa || 1 === pa || 2 === pa || 3 === pa) || !C.useVerticalErrorBar && (4 === pa || 5 === pa || 6 === pa || 7 === pa) || (2 === pa || 3 === pa) && C.halfHorizontalErrorBar || (6 === pa || 7 === pa) && C.halfVerticalErrorBar) G.graphics.error && G.graphics.error[pa] &&
                                    ...
                                    else if (Ra.errorTrackerArr[pa] = {}, g = Q[pa], Ra.errorTrackerArr[pa].tooltext = g.tooltext, B = aa, D = g.errorValue, null === D || void 0 === D || isNaN(D)) G.graphics.error && G.graphics.error[pa] && (G.graphics.error[pa].hide(), G.graphics.error[pa].shadow({
                                    opacity: pa
                                ...
                                if (N)
                                    if (N = R + (f.getAxisPosition(0) - f.getAxisPosition(1)) * D * E, D = H(B) + T % 2 / 2, E = H(N) + T % 2 / 2, g.errorEdgeBar)
                                        for (N = ["M", E, D - Ea, "V", D + Ea], J = 2 * Ea, B = D - Ea, Ea = h; Ea < J; Ea += 2 * h) Na.push({
                                            x: E,
                                            y: B + Ea,
                                            r: h,
                                            index: n,
                                        ...
                                        for (N = ["M", V, D, "H", E], J = b(V - E), B = V > E ? E : V, Ea = h; Ea < J; Ea += 2 * h) Na.push({
                                            x: B + Ea,
                                            y: D,
                                            r: h,
                                            index: n,
                                    ...
                                    for (N = ["M", E - Ea, D, "H", E + Ea], J = 2 * Ea, B = E - Ea, Ea = h; Ea <= J; Ea += 2 * h) Na.push({
                                        x: B + Ea,
                                        y: D,
                                        r: h,
                                        index: n,
                                    ...
                                    for (N = ["M", E, B, "V", D], J = b(B - D), B = B > D ? D : B, Ea = h; Ea <= J; Ea += 2 * h) Na.push({
                                        x: E,
                                        y: B + Ea,
                                        r: h,
                                        index: n,
                    ...
                    for (z = 0; z < f; z++)
                        if (n = b[0], b.splice(0, 1), n && n.graphics) {
                            ...
                            for (m = 0; 8 > m; m++) e.error && e.error[m] && e.error[m].hide() && e.error[m].shadow({
                                opacity: 0
                            });
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-multiaxisline",
        function () {
            var a = this.hcLib,
                c = a.pluckNumber,
                E = a.preDefStr.line,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-multilevelpie",
        function () {
            var a = this.hcLib,
            ...
            J.register("component", ["dataset", "multiLevelPie", {
                init: function (a) {
                    ...
                    a && (g.events = {
                        mouseOver: function () {
                            for (var d = this.data("plotItem").selfRef, a = n.conf; d.graphics.element;) d.graphics.element.attr({
                                fill: a.hoverFillColor
                            }), d = d.linkedItems.parent
                        }, mouseOut: function () {
                            for (var d = this.data("plotItem"), a = d.selfRef; a.graphics.element;) a.graphics.element.attr({
                    ...
                    var c, f, n = a.components && a.components.data,
                        g, e = a.graphics;
                    if (n)
                        for (g = n.length, c = 0; c < g; c += 1) this.removeGraphics(n[c]);
                    if (a.graphics)
                        for (f in e) e.hasOwnProperty(f) && this.removalFn(a.graphics[f], b, f)
                }, removeChild: function (a, b, c) {
                    var f, n;
                    if (a.length)
                        for (f = 0; f < a.length; f += 1) n = a[f], c ? this.removalFn(n, b, c) : this.removeGraphics(n, b);
                    else
                        for (f in a) this.removeChild(a[f], b, f)
                }, addMSPieCat: function (a, b, f, n, e) {
                    var g, z, V, H = a.length,
                        d = this,
                        N = f.components.data,
                    ...
                    var T = C.canvasWidth,
                        ...
                        x, p, G, u, da, ma, K = d.datasetGroup.trackTooltip(!0),
                        aa = r.get(I,
                            B),
                        D = aa.duration || 0,
                        Q = aa.dummyObj,
                        F = aa.animObj,
                        aa = aa.animType,
                        M, W, Qa, Ea = d.datalabels || (d.datalabels = q.group("datalabels").insertAfter(K)),
                        X = g.events || {},
                        J = function (d) {
                            var k = X.mouseOver;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragnode",
        function () {
            var a = this.hcLib,
                ...
                configure: function () {
                    ...
                    _drawNode: function (a) {
                        var b = this.chart,
                            ...
                            z = p.symbol,
                            w, y, A, V, H, K, E, D, U = G.colorObj.lineColor,
                        ...
                        var W = V.group,
                            ...
                            ka, S, ga = this.rolloverResponseSetter,
                        ...
                        if (void 0 !== x && !isNaN(x)) {
                            ...
                            z = (K = u.element) && K.type; - 1 === ua.indexOf(z) && K && (K.remove(), K = u.element = null, xa && xa.remove(), Y && Y.remove(), delete u.label, delete u.image, Y = null);
                        ...
                        var b = this.chart,
                            ...
                            l, w, y = b.config,
                            v, K, A, e = e.animType,
                            C, V, H = this.rolloverResponseSetter,
                            E = this.rolloutResponseSetter,
                            U = this.dragUp,
                            D = this.dragMove,
                            L = this.dragStart,
                            F, Q, Z = b.linkedItems.smartLabel;
                        ...
                        var b = this.components.pool || (this.components.pool = {}),
                            c, f, q, k;
                        if (a)
                            for (f in a = a.graphics, a) c = b[f] || (b[f] = {}), q = (k = a[f]) && k.type, c = c[q] || (c[q] = []), k.hide && "function" === typeof k.hide && (k.attr({
                                "text-bound": []
                        ...
                        var c = this.data("drag-options"),
                            ...
                            v = {},
                            K,
                            A, V, C, H, E = k.graphics.cloneGraphic,
                            U = k.graphics.cloneImage,
                            D = function (a) {
                                var b;
                                if (a)
                                    for (b in a)
                                        if (H = a[b]) V = H.config.datasetIndex, K = H.config.fromPointObj, A = H.config.toPointObj, (C = e.connectorSet[V]) && C && C.connectors.drawConnector(H, K, A)
                            };
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-connector",
        function () {
            var a = this.hcLib,
            ...
            J.register("component", ["dataset", "Connector", {
                type: "connector",
                configure: function () {
                    ...
                    l = c.config = {
                        ...
                        color: m,
                        index: a,
                        dashStyle: I(b.dashed, f.conDashed) ? X(I(b.dashlen, f.conDashLen), I(b.dashgap, f.conDashGap), f.stdThickness) : "none",
                        dashed: b.dashed,
                        dashlen: b.dashlen,
                        dashgap: b.dashgap,
                    ...
                    var c =
                        ...
                        r = c.components.data,
                        m, v, A = c.chart.components.paper,
                        C = b.getJobList();
                    v = f.datasetGroup;
                    ...
                    if (!a.removed) {
                        var f = this.chart,
                            ...
                            F = a.config;
                        v = F.toolText;
                        var d, Q, B = F.eventArgs || (F.eventArgs = {}),
                            h = this.config,
                    ...
                    var b = this,
                        ...
                        H = v.animType,
                        w = v.duration,
                        E, g, y, F, D = f.config.dataLabelStyle,
                        d, Q, B, h, q, k, f = b.components.data,
                        t = b.components.pool || {},
                        v = f.length,
                        O = function (a) {
                            E = a.config;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragablelabels",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.configStr,
            ...
            J.register("component", ["dataset", "DragableLabels", {
                configure: function () {
                    ...
                    var e = this.JSONData,
                        ...
                        l, f = this.chart.config.style.inCanvasStyle,
                        v = f.fontSize;
                    l = b[a];
                    !l && (l = b[a] = {});
                    !l.graphics &&
                    ...
                    var c = this,
                        ...
                        y, P, R, d, N, T, h, q, k, t, O, x, p, G, u, da = l.length,
                        ma = c.components.removeDataArr || [],
                        La = ma.length,
                        aa = c.components.pool || {},
                        S, X, w = c.graphics.dataLabelContainer = c.graphics.dataLabelContainer || m.group("datalabels", w);
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragcolumn",
        function () {
            var a = this,
                c = a.hcLib,
                E = c.pluck,
            ...
            J.register("component", ["dataset", "DragColumn", {
                    configure: function () {
                        ...
                        case "touchmove":
                        case "mousemove":
                            m.dragStart ? (g.preventDefault ? g.preventDefault() : g.returnValue = !1, m._rollOverResponseSetterFire = !1, f.cursor = U, m._pointerDy++, v += m._dragBuffer, v < N ? v = N : v > h && (v = h), y = b < v ? b : v, P = M(b - v), V._yPos = y, V._height = P, f = m.setValue = X(ka.getValue((y >= b ? y + P : y) - N)), f = K.dataLabels(f), m.toolTipValue = f, m.displayValue = E(m.setDisplayValue, f), B && !n && (m.colorArr[0].FCcolor.angle = y < b ? 90 : 270), Z.attr({
                                y: V._yPos,
                                height: V._height,
                                fill: S(m.colorArr[0])
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragarea",
        function () {
            var a = this,
                c = a.hcLib,
            ...
            J.register("component", ["dataset", "DragArea", {
                configure: function () {
                    ...
                    var O = b.yAxis[0],
                        x = n.canvasTop,
                        p = n.canvasBottom,
                        G, u, b = this.graphics.lineElement,
                        da, ma, La;
                    u = u ? p : y;
                    ...
                    case "touchstart":
                    case "mousedown":
                        w.mouseIn && (w.mousedown = !0, G && n >= C - y && n <= C + y && P <= B + y && P >= B - y ? (t.dragStart = !0, t._pointerDy = 0, t._dragStartY = n, t._dragBuffer = C - n, Z.dragged = !0, Z.startValue = t.setValue, Z.name = w.seriesname, Z.datasetIndex = this.positionIndex) : t.dragStart = !1)
                    }
                }, getJSONData: function () {
                    var a = this.JSONData.data,
                        c = this.components.data,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragline",
        function () {
            ...
            J.register("component", ["dataset", "DragLine", {
                    ...
                    _firePlotEvent: J.get("component", ["dataset", "DragArea"]).prototype._firePlotEvent,
                    getJSONData: function () {
                        var a = this.JSONData.data,
                            E = this.components.data,
                            e = [],
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-selectscatter",
        function () {
            var a = this,
                c = a.hcLib,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-candlestick",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.line,
            ...
            J.register("component", ["dataset", "Candlestick", {
                    type: "Candlestick",
                    configure: function () {
                        if (this.plotType === e) this._configureVolume();
                        else {
                            var b = this.config,
                                c = this.chart,
                                k = c.components,
                                ...
                                u = k.numberFormatter,
                                n = k.colorManager,
                                m, z, aa, A, k = b.bearBorderColor = B(g(x.bearbordercolor, w)),
                                ...
                                ga, Ia, va, Fa, wa, oa, qa, la, ia, ea, sa, fa, ha, ca = !1,
                                Aa = -Infinity,
                                ya = Infinity,
                                Y = -Infinity,
                                ua = Infinity,
                        ...
                        var b = this.config,
                            ...
                            G, u, l, n, m, z, E = b.bearBorderColor = B(g(e.bearbordercolor, w)),
                        ...
                        Y || (ia = ["M", 0, ra.canvasTop, "L", 0, ra.canvasBottom, "M", 0, ia.canvasTop - ia.canvasBorderWidth, "L", 0, ia.canvasTop +
                            ia.canvasHeight + ia.canvasBorderWidth / 2
                        ], Y || (Y = k.graphics.rollOverBand = z.path(oa)), Y.transform(W), Y.attr({
                            path: ia,
                            "stroke-width": Da,
                            ishot: !0,
                            stroke: la,
                        ...
                        for (e = 0; e < za; e++)
                            if (oa = xa[0]) b._removeDataVisuals(oa.graphics), xa.shift();
                        b.drawn = !0;
                        ...
                        for (g = e.length; g--;)
                            if (k = f[e[g].originalIndex])
                                if (k = this.isWithinShape(k, e[g].originalIndex, a, b)) return k;
                        for (g = d.length; g--;)
                            if (k = f[d[g].originalIndex])
                                if (k = this.isWithinShape(k, d[g].originalIndex, a, b)) return k
                        ...
                        if (d && (d = d.errorBar))
                            for (g = d && d.length; g--;)
                                for (u = (e = d[g]) && e.length; u--;)
                                    if (e[u] && e[u]._xPos && (f = e[u]._xPos, l = e[u]._yPos, n = e[u]._height, m = e[u]._width, f = b >= f && b <= f + m && k >= l && k <= l + n)) return {
                                        pointIndex: a,
                                        hovered: f,
                                        pointObj: c[a]
                                    }
                        ...
                        for (d in a) {
                            ...
                            if (f instanceof Array)
                                for (e = 0, g = f.length; e < g; e++) this._removeDataVisuals(f[e]);
                            else f.hide && "function" ===
                        ...
                        d = this.visible;
                        var H,
                            P, I, Z = this.components.removeDataArr || [],
                            T = Z.lengt,
                            Q;
                        ...
                        var e = this.chart,
                            ...
                            z = n.trackerGroup,
                            v, y, E, B, C, D, V, e = e.get(L, A),
                            n = e.duration,
                            F = e.dummyObj,
                            U = e.animObj,
                            H, I, Z, Q;
                        v = this.drawn;
                        var T, M = this.components.pool || [],
                            R;
                        ...
                        for (d = 0; d <
                            ...
                            if (v = (m = p[d]) && m.config, B = v.y, w = v.errorValue, z = w.length, !m.graphics.error && (m.graphics.error = []), null !== B) {
                                ...
                                l = G.length;
                                if (l > z)
                                    for (Z = z; Z < l; Z++) I = G.pop(), this._removeDataVisuals(I);
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-trendset",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.configStr,
            ...
            J.register("component", ["dataset", "Trendset", {
                    configure: function () {
                        ...
                        r = 0;
                        for (F = n.length; r < F; r += 1)(z = n[r]) && !z.vline && (e = f[r] = f[r] || (f[r] = {}), E = e.config = e.config || (e.config = {}), c = E.setValue = w.getCleanValue(z.value), z = w.getCleanValue(z.x), z = E.x = null !== z ? z : r + 1, V = v(V, c), m = D(m, c), L = D(L, z), M = v(M, z), e.graphics || (e.graphics = {}));
                        b.max = V;
                        b.min = m;
                        b.xMax = M;
                        b.xMin = L;
                    ...
                    }, legendInteractivity: function () {}, draw: function () {
                        var a = this.chart,
                            c = a.components,
                            v = this.config,
            ...
            J.register("component", ["dataset", "boxandwhisker2d", {
                ...
                configure: function () {
                    var c = this.chart,
                        ...
                        aa, A = d.plotColor = v.getPlotColor(E),
                        B = f(e.dashed, l.plotborderdashed),
                        D = f(l.useplotgradientcolor, 1),
                        C, K = a.parseUnsafeString,
                        V = K(l.yaxisname),
                        L = K(l.xaxisname),
                        F = K(b(l.tooltipsepchar, ": ")),
                        I = a.parseTooltext,
                        H, Z, M, Q, W, S, X, J, ba, wa, oa, qa, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za, Ga, Ma, ra, Ba, Ua, Ja, ja, xb, eb, Qb, Db, Kb, pb, hb, Eb, Fb, Lb, ib = a.getDashStyle,
                        qb = this.components.data,
                        Ka = c.components.numberFormatter,
                        Xb, Mb, $a, Pb, yb, nb, Sa, Wa = 0,
                        ob = 0,
                        Jb = a.BoxAndWhiskerStatisticalCalc,
                        cb, Gb, jb, kb, zb, rb, Oa, fb, tb, Pa, sb, ab, na, Yb,
                        Ha, lb, mb, bb, Hb, Ca, Za, Rb, Sb, Nb, Ob, Ya, Ib, gb = 0,
                        ub;
                    ...
                    for (Sa = 0; Sa < u; Sa++)
                        if (ca = h && h[Sa], Y = (ya = qb[Sa]) && ya.config, ya ||
                            ...
                            ob = w(ob, rb);
                            if (Hb && ca.outliers)
                                for (ub = 0; ub < Y.outliers.length; ub++) Wa = U(Wa, Y.outliers[ub]), ob = w(ob, Y.outliers[ub]);
                    ...
                    var c = this.chart,
                        ...
                        e = f && f.length,
                        g = this.components,
                        h, l, f = c.components.legend,
                        m = {},
                        g = g.dataset || (g.dataset = []),
                        e = e * (a + 1) + this.index;
                    if (g[a]) l = g[a], l.index = e, c = V({}, this.JSONData), l.JSONData = c;
                    else if (h = J.get("component", ["dataset", "subDS"])) void 0 === m.subDS ? m.subDS = 0 : m.subDS++, l = new h, l.chart = c, l.index = e, g.push(l), c = V({}, this.JSONData), this.initSubDataset(c, l), l.name = b;
                    switch (a) {
                    case 0:
                    ...
                    var c = d.chart,
                        ...
                        m = p.data,
                        y, A = c.config.categories,
                        A = w(A && A.length, m && m.length),
                        B = e.numberFormatter,
                        D = c.use3dlineshift,
                        C, K = -Infinity,
                        V = Infinity,
                        L, F, I = b(h.tooltipsepchar, ": "),
                    ...
                    var c = d.chart,
                        ...
                        n = p.data,
                        A, D = c.config.categories,
                        D = w(D && D.length, n && n.length),
                        B = e.numberFormatter,
                        C = c.use3dlineshift,
                        K, V = -Infinity,
                        L = Infinity,
                        F, I, P = b(m.tooltipsepchar, ": "),
                    ...
                    var e = d.chart,
                        ...
                        v = m.data,
                        D, C = e.config.categories,
                        C = w(C && C.length, v && v.length),
                        B = g.numberFormatter,
                        K = e.use3dlineshift,
                        V, L = -Infinity,
                        F = Infinity,
                        I, P, Z = b(u.tooltipsepchar, ": "),
                    ...
                    var a, b, c, g, l, p, r, u = this,
                        ...
                        ua, xa = ca.xPosOffset || 0,
                        za = ca.height,
                        Ga, Ma = u.components.data,
                        ra, Ba, Ua, Ja, ja, xb, eb = Ra.getAxisBase(),
                        Qb, Db, Kb = z.showShadow,
                        ...
                        Ka, Xb, Mb, $a, Pb, yb, nb, Sa, Wa, ob, Jb, cb, Gb, jb, kb, zb, rb, Oa, fb, tb, Pa, sb, ab, na = ga.config.dataLabelStyle,
                        ...
                        Ca, Za, Rb, Sb, Nb, Ob, Ya, Ib, gb, ub, vb, Tb, Zb, dc, Ub, jc = Infinity,
                        Xa, ic, wb = !0,
                        yc = (u.components.removeDataArr || []).length,
                        kc, lc, mc, nc, oc, pc, qc, rc, sc, Vb, Wb, $b = z.showHoverEffect,
                        Ab,
                        ...
                        bc = function (a) {
                            return function (d) {
                                var b;
                                if (0 !== this.data(W))
                                    for (b in a) "label" !== b && (a[b].attr(this.data("setRolloverAttr")[b]), h.call(this, ga, d, "DataPlotRollOver"))
                            }
                        },
                        cc = function (a) {
                            return function (d) {
                                var b;
                                if (0 !== this.data(W))
                                    for (b in a) "label" !== b && (a[b].attr(this.data("setRolloutAttr")[b]), h.call(this, ga, d, "DataPlotRollOut"))
                            }
                        },
                        Cb = function () {
                    ...
                    for (m = 0; m < c; m++)
                        if (f = b[0], b.splice(0, 1), f && f.graphics) {
                            h = f.graphics;
                            for (g in h)
                                if ("label" !== g) h[g].shadow({
                                    opacity: 0
                                }), h[g].hide();
                                else
                                    for (l = h[g].length, n = 0; n < l; n++) h[g][n] && (h[g][n].shadow({
                                        opacity: 0
                    ...
                    d = d || 1;
                    a = a || 0;
                    if (a + d === f.length) this.endPosition = !0;
                    ...
                    if (c)
                        for (e.legendItemSymbol && e.legendItemSymbol.attr({
                            ...
                            for (e.legendItemSymbol && e.legendItemSymbol.attr({
                                ...
                                if (e = (f = this.components.items[c]) && f.graphics) f = f.config, h = b.color, m = f.fillColor, f = f.strokeColor, e.legendItemSymbol && e.legendItemSymbol.attr({
                                    fill: m,
                                    stroke: f
                                }), e.legendItemText && e.legendItemText.attr({
                                    fill: h
                    ...
                    for (c = 0; c < b; c++) this.components.outliers[c].visible = !1, this.components.outliers[c].draw()
                }
            }, "Column", {
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-subds",
        function () {
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-heatmap",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.colors.FFFFFF,
            ...
            J.register("component", ["dataset", "HeatMap", {
                ...
                configure: function () {
                        var c = this.chart,
                            ...
                            B = c.jsonData.chart,
                            V = c.components.colorManager,
                            L, F = p.plotColor = V.getPlotColor(this.index || this.positionIndex),
                            ...
                            Nb = Q,
                            Ob = Q,
                            Ya, Ib, gb, ub, vb, Tb, Zb = r.rows.row.length,
                            dc = r.columns.column.length,
                            Ub;
                        for (fb = 0; fb < Zb; fb++)
                            for (nb.push([]), tb = 0; tb < dc; tb++) nb[fb].push([]);
                        ...
                        for (Oa = 0; Oa < C; Oa++) Y = w && w[Oa], za = (xa = yb[Oa]) && xa.config, xa || (xa = yb[Oa] = {
                                graphics: {}
                        ...
                        if (eb && !ja) t({
                            ...
                            for (Oa = 0; Oa < Ga.colorArr.length; Oa++) p.colorMap[Oa] = {
                                ...
                                dataSet: this
                            }, p.colorMap[Oa].config.visible = !0;
                        ...
                        var d = this.components.data,
                            ...
                            h = b.dummyObj,
                            b = b.duration,
                            m, l, n = this.components.colorRange,
                            r, v, z, w;
                        z = a.config.code;
                        r = 0;
                        for (v = d.length; r < v; r++) m = d[r].config, l = m.plotFillAlpha / 100, w = n.getColorObj(d[r].config.value).code, z === w && (d[r].graphics.element && d[r].graphics.element.attr({
                                visibility: R
                            }).animateWith(h, g, {
                                "fill-opacity": l,
                        ...
                        var ia, D = m.components.legend.config.isActive,
                    ...
                    drawLabel: function () {
                        var a = this.chart,
                            ...
                            v = this.visible,
                            z, w, y, D, E, K, V = this.graphics.dataLabelContainer,
                            ...
                            H, N, Z, T, J, W, S, X, ka, wa, oa, qa, la, ia, a = a.get(e, ba),
                            ea = a.animObj,
                            sa = a.dummyObj,
                            fa = a.duration,
                            c = c.datalabelsGroup;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-kagi",
        function () {
            var a = this.hcLib,
                c = this.window.Image,
                E = a.preDefStr,
            ...
            J.register("component", ["dataset", "Kagi", {
                ...
                _parseShadowOptions: function () {
                    ...
                    var c, e, m = this.chart,
                        l = m.components.xAxis[0],
                        n = 0,
                        v, w = [],
                        z, g, y, A, E, d, C, F, h, q, k = a.getDashStyle,
                        t, I, x, p, G, u, H, M, J, Q;
                    h = 0;
                    var S;
                    this.__base__.configure.call(this);
                    ...
                    if (a < r.length)
                        for (e = a; e < r.length; e += 1, a = e) {
                            ...
                            n = l.data;
                            l = l.index - (e + 1);
                            if (l < c) n.lineposition = D(n.lineposition, f);
                            else if (l > c) break;
                            b.push(n)
                        }
                    return a
                }, manageSpace: function () {}, _getHoveredPlot: function (a, c) {
                    for (var b = this.chart, f = b.components.xAxis[0], e = this.config, l = e.trackIndex, n = this.components.data, r = b.components.canvas.config, r = a - b.config.canvasLeft - Math.max(r.canvasPaddingLeft, r.canvasPadding),
                        ...
                        for (r = (e = l[f]) && e.length; 0 <= r; r--)
                            if (g = e[r], g = this.isWithinShape(n[g], g, a, c)) return g
                }, draw: function () {
                    var b, f, m, l = this,
                        r = l.graphics,
                        B = l.JSONData;
                    ...
                    var w = b.getJobList(),
                        ...
                        x, p, G, u, R, X, La =
                        l.components.data,
                        aa, db, fc, ta = r.container,
                        xc, gc = D.datasetGroup,
                        Qa, D = y.shadow,
                        Ea, ec = r.dataLabelContainer,
                        Ta = {},
                        hc, pa, Na, Ra = function () {
                            ta.lineGroup.attr({
                                "clip-rect": null
                            });
                    ...
                    if (d.length) {
                        ...
                        Q(J, C);
                        if (d[0].config.setValue) Y = d[0].config.plotY;
                        else
                            for (b = 1; b < C; b += 1)
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-errorbar2d",
        function () {
            J.register("component", ["datasetGroup", "errorbar2d", {},
                this.hcLib.preDefStr.column
            ])
        }
    ]);
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragnode",
        function () {
            var a = this.hcLib,
                c = a.preDefStr,
                E = c.colors,
            ...
            J.register("component", ["datasetGroup", "DragColumn", {
                    getJSONData: function () {
                        ...
                        var I = this.stackSumValue && this.stackSumValue[0],
                            B, X, M, R;
                        B = this.chart.config;
                        var r, D, v = (a && a.length) - c,
                            A, F = B.isDataRestored,
                            l, C = E(1 / B.binSize * B.labelBinSize),
                            H, Q, n, b;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragarea",
        function () {
            ...
            J.register("component", ["datasetGroup", "DragArea", {
                getJSONData: function () {
                    ...
                    var W = this.chart.config,
                        S = W.isDataRestored,
                        I, B, X, M, R, r, D, v, A, F = (a && a.length) - e,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragline",
        function () {
            J.register("component", ["datasetGroup", "DragLine", {
                _decidePlotableData: J.get("component", ["datasetGroup", "DragArea"]).prototype._decidePlotableData
            }, "line"])
        }
    ]);
    J.register("module", ["private", "modules.renderer.js-dataset-group-boxandwhisker2d",
        function () {
            var a = this.hcLib,
                c = a.extend2,
                a = a.preDefStr,
            ...
            J.register("component", ["datasetGroup", "boxandwhisker2d", {
                    draw: function () {
                        ...
                        for (S = 0; S < J; S++)
                            for (I = a[S], B = I.length, this.manageClip = !0, I = 0; I < B; I++) X = a[S][I].dataSet, X.draw()
                    }
                },
                a.column
            ])
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-heatmap",
        function () {
            J.register("component", ["datasetGroup", "heatmap", {},
                this.hcLib.preDefStr.column
            ])
        }
    ])
