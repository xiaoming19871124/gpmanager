...
(function (Q) {
    ...
    Q.register("module", ["private", "modules.renderer.js-gantt",
        function () {
            var V = this,
                I = V.hcLib,
                ha = V.window,
                ia = /msie/i.test(ha.navigator.userAgent) && !ha.opera,
                da = I.chartAPI,
                ba = I.extend2,
                q = I.pluck,
                r = I.pluckNumber,
                sa = I.pluckFontSize,
                X = I.getFirstColor,
                oa = I.parseConfiguration,
                ta = I.setAttribDefs,
                P = I.graphics,
                T = P.convertColor,
                ea = P.getDarkColor,
                Y = I.parseUnsafeString,
                la = I.getFirstValue,
                ua =
                I.getValidValue,
                fa = I.toPrecision,
                W = I.Raphael,
                va = I.chartPaletteStr,
                Da = I.componentDispose,
                wa = I.schedular,
                Ea = I.COMMASTRING,
                U = I.setLineHeight,
                ma = I.getDashStyle,
                ...
                Fa = I.dropHash,
                Ga = I.HASHSTRING,
                ha = !I.CREDIT_REGEX.test(ha.location.hostname),
                ja = "rgba(192,192,192," + (ia ? .002 : 1E-6) + ")",
                ya = P.mapSymbolName,
                ia = Math,
                M = ia.max,
                na = ia.min,
                ...
                Ha = parseInt,
                Aa = parseFloat,
                Ba = I.graphics.getLightColor,
                N = I.plotEventHandler,
                ka, aa, pa = function (a) {
                    return void 0 !==
                        a && null !== a
                },
            ...
            da("gantt", {
                ...
                _createDatasets: function () {
                        var a = this.config,
                            ...
                            c = this.jsonData,
                            d = [],
                            f, e, h = this.defaultDatasetType,
                            m = this.applicableDSList,
                            g, l, n, u = a.datasetMap || (a.datasetMap = {
                                task: [],
                                milestone: [],
                                connectors: []
                            }),
                        ...
                        c = b.dataset = [];
                        for (b = 0; b < f; b++)
                            if (n = d[b], n.task ? x = g = "task" : n.milestone ? x = g = "milestone" : n.connector && (g = "connectors", x = "connector"), g = g && g.toLowerCase(), m[g] || (g = h), l = Q.get("component", ["dataset", g])) void 0 === k[g] ? k[g] = 0 : k[g]++, e = u[g], (t = e[0]) ? (l = t.JSONData, l = l[x].length, A = n[x].length, p[g].push(t), c.push(t), t.index = b, l > A && t.removeData(A -
                        ...
                        for (g in u)
                            if (d = u[g], f = d.length)
                                for (b = 0; b < f; b++)(e = d[b]) && Da.call(e);
                        a.datasetMap = p
                    }, configure: function () {
                        var a = this.config,
                            b = this.components.background.config,
                    ...
                    }, _setAxisLimits: function () {}, _createAxes: function () {
                        var a = this.components,
                            b = Q.get("component", ["axis", "time"]),
                        ...
                        var a, b = this.config,
                            ...
                            d = c.xAxis && c.xAxis[0],
                            f = c.yAxis && c.yAxis[0],
                            e = c.legend.config.legendPos,
                            h = 100 - (b.ganttwidthpercent || 67);
                        a = b.borderWidth;
                        var m = c = 0;
                        ...
                        var a = this.jsonData.chart,
                            ...
                            g = g.animType,
                            p = b.canvasElement,
                            t = c.actualCanvasLeft,
                            A = c.actualCanvasTop,
                            x = c.canvasWidth,
                            k = c.canvasHeight,
                            C = c.canvasLeft,
                            F = c.canvasTop,
                            q = c.canvasWidth + c.totalWidth,
                            c = c.canvasHeight + c.totalHeight,
                            d = d.canvasGroup,
                            y = h.canvasBorderRadius,
                            z = h.canvasBorderWidth,
                            v = .5 * z,
                            w = h.canvasBorderColor,
                            G = h.canBGColor,
                            D = h.shadow,
                            a = h.showCanvasBG = !!r(a.showcanvasbg, 1),
                            B = h.shadowOnCanvasFill,
                            E = h.showCanvasBorder,
                            h = {
                                x: t - v,
                                y: A - v,
                                width: q + z,
                        ...
                        var a = this.config,
                            ...
                            c = b.xAxis && b.xAxis[0],
                            d = b.yAxis && b.yAxis[0],
                            f = d.getAxisConfig("processTotalHeight"),
                            e = a.canvasHeight,
                            h = b.legend,
                            m = a.xDepth,
                            g = b.canvas.config,
                            l = g.canvasBorderWidth,
                            n = g.canvasPadding,
                            u = b.vScrollBar.userConf,
                            p, t = g.canvasPaddingLeft,
                            g = g.canvasPaddingRight,
                            A = a.ganttpanedurationunit,
                            x = b.hProcessScrollBar,
                            b = (b = b.hScrollBar) && b.userConf.height || 0,
                        ...
                        this._allocateSpace({
                            bottom: M(a.hProcessScrollHeight, a.hScrollHeight)
                        });
                        a.totalWidth = h;
                        a.totalHeight = m
                    }, updateManager: function (a, b) {
                        var c = this.config,
                            d = this.config.viewPortConfig,
                            f = d.scaleX,
                            e = this.components.xAxis[0],
                            h = this.components.yAxis[0],
                            m = this.graphics.datasetGroup,
                        ...
                        var a = this.components,
                            ...
                            e = new Date(d),
                            h = a.yAxis[0],
                            m = this.components.numberFormatter,
                            g = Number(b.ganttpaneduration),
                            l = b.scrollOptions ||
                            (b.scrollOptions = {}),
                            n = b.ganttpanedurationunit,
                            u = f - d,
                            d = b.canvasHeight,
                            p = b.scrolltodate,
                            t = b.canvasWidth,
                            A = b.canvasLeft,
                            x = a.hProcessScrollBar,
                            a = (a = a.hScrollBar) && a.userConf.height || 0,
                            x = x && x.userConf.height || 0,
                            k = c.getPixel(f) - A,
                            f = h.getAxisConfig("processTotalHeight");
                        if (void 0 === g || void 0 === n) b.hScrollEnabled = !1;
                        else {
                            switch (n) {
                            case "y":
                        ...
                        var a =
                            ...
                            h = b.viewPortConfig,
                            m = b.scrollOptions || (b.scrollOptions = {}),
                            g = e.max,
                            l = e.min,
                            n = m.horizontalVxLength,
                            u = c.hScrollBar,
                            e = u.node,
                            p = c.vScrollBar,
                            t = p.node,
                            A = c.hProcessScrollBar,
                            x = A.node,
                            k = b.useverticalscrolling,
                            q = g - l,
                            F = b.canvasRight,
                            H = h.scaleX,
                            y = h.scaleY,
                            z, v, w, G, D, B = b.vScrollEnabled,
                            E = c.yAxis[0],
                            I = B ? p.conf.width : 0,
                            L = a.graphics,
                            S = c.paper;
                        ...
                        var a = this.components.paper,
                            b = this.config,
                            c = b.style.inCanvasStyle,
                            d, f;
                    ...
                    _drawDataset: function () {
                        ...
                        var a = this.config,
                            ...
                            g = a.marginRight,
                            l = a.marginBottom,
                            n = a.totalWidth + a.canvasWidth,
                            u = a.totalHeight + a.canvasHeight,
                            a = a.height;
                        ...
                        var a = this.config,
                            ...
                            c =
                            this.graphics.datalabelsGroup,
                            d = this.graphics.trackerGroup,
                            f = a.viewPortConfig,
                            e = f.scaleX,
                            f = f.x,
                            h = this.config.animationObj,
                            m = h.dummyObj,
                            g = h.animObj,
                            l = h.animType,
                            h = h.transposeAnimDuration,
                            n = this.components.canvas.config.clip["clip-canvas"].slice(0);
                        this.config.clipSet ? (b.animateWith(m, g, {
                            "clip-rect": n
                        }, h, l), c.animateWith(m, g, {
                            "clip-rect": n
                        }, h, l), d.animateWith(m, g, {
                            "clip-rect": n
                        }, h, l)) : (b.attr({
                            "clip-rect": n
                        }), c.attr({
                        ...
                        var a = this.components,
                            ...
                            e = c.add,
                            h;
                        (a.chartMenuBar || {}).drawn || d && d.drawn || (da.mscartesian._createToolBox.call(this), d = a.tb, h = a.toolBoxAPI, h = h.Scroller, c.clear(), e({
                            isHorizontal: !0
                        }, {
                            scroll: function (a, b) {
                                return function (c) {
            ...
            Q.register("component", ["dataset", "Task", {
                ...
                configure: function () {
                    var a = this.chart,
                        b = ba({}, this.JSONData);
                    this.__setDefaultConfig();
                    oa(b, this.config, this.chart && this.chart.config, {
                        task: !0
                    });
                    ...
                    var b = this.config,
                        ...
                        e = this.JSONData;
                    a = a || e.task;
                    var h = (d.processes || {}).process || [],
                        d = a && a.length,
                        m = c.components.colorManager,
                        g = c.get("config"),
                        l = c.get("components", "numberFormatter"),
                        n = g.taskbarfillmix,
                        u = g.taskbarfillratio,
                        p = g.showslackasfill,
                        t = this.components.data,
                        A, x, k, C, F, H, y, z = g.dateintooltip,
                        v, w, h = h.length,
                        G = {
                            right: "right",
                            left: "left",
                        ...
                        D, B, E, O, L, S, K, J, Q = c.components.tasksMap = {},
                        N = g.style.inCanvasStyle,
                        P, Ca, R, W = 0,
                        V = g.dataLabelStyle,
                        Z;
                    ...
                    if (d)
                        for (c = 0; c < d; c += 1) w = a[c], A = W % h, (D = q(w.processid)) && "string" === typeof D && (D = D.toLowerCase()), R = w.id, B = r(w.alpha, b.alpha), S = q(w.color, b.color, m.getColor("plotFillColor")), E = r(w.borderalpha, b.borderalpha, "100"), O = q(w.bordercolor, b.bordercolor, m.getColor("plotBorderColor")), L = la(q(w.label, w.name), ""), C = m.parseColorMix(S, n), F = m.parseAlphaList(B.toString(), C.length), H = m.parseRatioList(u, C.length), K = r(w.angle,
                                b.angle), v = t[c] || (t[c] = {
                                config: {}
                            }), v = v.config, v.index = c, v.link = w.link, v.processId = q(w.processid, "__FCDPID__" + A), v.textColor = X(q(w.fontcolor, b.fontcolor, N.color)), v.style = ra({
                                fontSize: w.fontsize,
                                fontFamily: w.font
                ...
                }, getAxisValuePadding: function () {}, draw: function () {
                    var a;
                    a = this.visible;
                    var b = this.chart,
                        c = b.jsonData,
                        d = b.get("config"),
                        f = b.get("config", "animationObj"),
                        e = f.duration,
                        h = f.dummyObj,
                        m = f.animObj,
                        f = f.animType,
                    ...
                    var t = this.components,
                        A = t.data,
                        x, k, q = t.removeDataArr,
                        F = q && q.length;
                    k = b.graphics.datalabelsGroup;
                    var H = this.graphics.dataLabelContainer,
                        y = function () {
                            H.show()
                        },
                        z = this.graphics,
                        ...
                        z = z.shadowContainer,
                        t = t.pool || [],
                        w, G, D, B, E, O, L, S, K, J, M, Q, P, N, R, V, T, Z;
                    Z = d.showtooltip;
                    var X = d.datepadding,
                        U = d.viewPortConfig,
                        Y = U.x,
                        aa = b.getJobList(),
                        c = c.processes.process && c.processes.process.length,
                        U = U.scaleX,
                        ba = d.taskbarroundradius,
                        ca = d.showshadow;
                    G = this.config;
                    ...
                    for (a = Z = 0; a < u; a++) G = (k = (x = A[a]) &&
                        ...
                        Y * U, w = k.width = za(S = w - O), K = K.bottom + l - L, K = k.yPos = K + na(R, L - D), N = .5 * D, !x.graphics && (x.graphics = {}), R = W.crispBound(O, K, w, D, Q), O = R.x, K = R.y, w = R.width, D = R.height, !1 !== qa(O, K, w, D) && (L = x.graphics.element, k.showAsGroup ? (S = "path", J = {
                                path: ["M", O, K]
                            }, N = {
                                path: ["M", O, K, "v", D, "L", O + N, K + N, "H", O + w - N, "L", O + w, K + D, "v", -D, "H", O]
                            }) : (S = "rect", N = {
                                x: R.x,
                                y: R.y,
                                width: R.width || 1,
                                ...
                                z).tooltip(E).data("dataObj", x).data("chart", b).data("dataset", this).data("eventArgs", T), e && P && (H.hide(), L.animateWith(h, m, {
                                width: R.width || 1
                            }, e, f, y)), x = B ? "pointer" : "", B = k.labelAlign, E = k._labelTextAttr || (k._labelTextAttr = {}), E.x = O + w * Ja[B] + Ka[B], E.y = K - .5 * Ha(G, 10) - d.tasklabelspadding, E.text = k.label, E.direction = d.textDirection, E["text-anchor"] = Ia[B], E.cursor = x, E.ishot = !0, E.fill = k.textColor, E["line-height"] = G, B = k._startLabelTextAttr || (k._startLabelTextAttr = {}), B.x = O - 2 - X, B.y = K + .5 * D, B.text = k.startDate, B["text-anchor"] =
                    ...
                    var h = e.dummyObj,
                        ...
                        g = e.duration,
                        l = e.animType,
                        n, u, p, t = this.graphics.dataLabelContainer,
                        A, x = c.length;
                    ...
                    var a = this.data("dataObj") || {},
                        b = this.data("dataset").components.data,
                        a = a.config || {},
                        c = a.index,
                        b = b[c] && b[c].graphics,
                        c = {
                        ...
                        }; - 1 === a.percentComplete || a.showAsGroup || (b.slackElem.attr({
                            fill: a.slackHoverColor
                        }), b.taskFill.attr({
                            fill: a.hoverFillColor
                        }),
                        delete c.fill);
                    ...
                    b && (-1 === a.percentComplete || a.showAsGroup || (b.slackElem.attr({
                        fill: a.slackColor
                    }), b.taskFill.attr({
                        fill: a.color
                    }), delete c.fill), b.element.attr(c))
                    ...
                    var b = this.components.pool || (this.components.pool = {}),
                        c, d, f;
                    if (a)
                        for (c in d = a.graphics, d) a = b[c] || (b[c] = []), f = d[c], f.hide && "function" === typeof f.hide && (f.attr({
                            "text-bound": []
                        }), f.hide(), f.transform && f.transform("")), a.push(d[c])
                }
            }, "column", {
            ...
            Q.register("component", ["dataset", "Milestone", {
                ...
                configure: function () {
                    ...
                    var b = this.chart,
                        c = this.JSONData,
                        d = (a = a || c.milestone) && a.length,
                        f = b.components.colorManager,
                        e = b.get("config"),
                        h = b.get("components", "numberFormatter"),
                        m = this.components.data,
                        g = b.config.style,
                        l = g.inCanvasStyle,
                        n = b.components.tasksMap,
                        u, p, t, A, x, k, C, F = b.config.milestoneLabelStyle,
                        H;
                    m || (m = this.components.data = []);
                    for (b = 0; b < d; b += 1) p = a[b], (u = m[b]) || (u = m[b] = {
                            config: {}
                        }), u = u.config, C = la(p.taskid, "").toLowerCase(), A = q(p.shape, "polygon").toLowerCase(), t = r(p.numsides, 5), x = 0, "star" === A ? x = .4 : (ya(t), ya(t).split("-")), A = q(p.color, f.getColor("legendBorderColor")), k = ua(Y(q(p.tooltext, p.hovertext, e.milestonetooltext))), g = h.getDateValue(p.date).ms, H = h.getFormattedDate(g), void 0 !== k && n[C] ? (g = n[C].config,
                    ...
                    var a = this.chart,
                        ...
                        f = b.tasksMap,
                        e = a.config,
                        h = a.get("config", "animationObj"),
                        m = h.duration,
                        g = this.graphics.container,
                        l = a.graphics.parentMilestoneGroup,
                        n = this.graphics.dataLabelContainer,
                        u = this.visible,
                        b = b.paper,
                        p = this.components.removeDataArr || [],
                        t = p.length,
                        A = h.dummyObj,
                        x = h.animObj,
                        h = h.animType,
                        k, q, F, H, y, z, v, w, G = a.getJobList();
                    k = e.showtooltip;
                    ...
                    u = d && d.length;
                    for (n = 0; n < u; n += 1)
                        if (k = d[n]) l = k.config, q = f[l.taskId], !k.graphics && (k.graphics = {}), F = k.graphics, z = F.element,
                            v = F.label, q ? (y = q.config, w = W.animation({
                                ...
                                this.rollOutHandler(a))), z.show().animateWith(A, x, {
                                polypath: y
                            }, m, h).attr({
                                fill: l.fillColor,
                            ...
                            }).tooltip(l.toolText).data("eventArgs", H).data("dataObj", k), m && w && !this.drawn && F.element.animateWith(A, x, w.delay(m)), k = l._labelAttrs || (l._labelAttrs = {}), k.x = q, k.y = v, k.text = l.displayValue, k.groupId = "gId" + n, k.cursor = l.link ? "pointer" : "", k.ishot = !0, k.direction = e.textDirection, k["text-anchor"] = "middle", k.fill = l.textColor)) : (z && z.hide(), v && v.hide());
                    ...
                    var a = this.chart,
                        b = a.components.paper,
                        c = a.get("config", "animationObj"),
                        d = c.duration,
                        f = c.animType,
                        e = c.dummyObj,
                        c = c.animObj,
                        h = a.components.tasksMap,
                        m, g = this.graphics.dataLabelContainer,
                        l, n, u, p, t, A, x, k, r = this.components.pool || {},
            ...
            Q.register("component", ["dataset", "Connectors", {
                configure: function () {
                    ...
                    var b = this.config,
                        c = this.chart,
                        d = this.JSONData,
                        f = (a = a || d.connector) && a.length || 0,
                        e = c.components.colorManager,
                        c = c.get("config"),
                        h = this.components.data,
                        m, g, l, n, u, p, t;
                    h || (h = this.components.data = []);
                    for (m = 0; m < f; m += 1) l = a[m], (g = h[m]) || (g = h[m] = {
                            config: {}
                        }), !g.config && (g.config = {}), g = g.config, n = q(l.color, b.color, e.getColor("plotBorderColor")), u = r(l.alpha, b.alpha, 100), p = r(l.thickness,
                    ...
                    var a = this.chart,
                        ...
                        f = c.length,
                        b = b.tasksMap,
                        e = a.config.connectorextension,
                        h = a.graphics.parentConnectorsGroup,
                        m = this.graphics.container,
                        g = this.components.pool || [],
                        l = this.visible,
                        n = a.get("config", "animationObj"),
                        u = n.duration,
                        p = n.dummyObj,
                        t = n.animObj,
                        n = n.animType,
                        A = this.components.removeDataArr || [],
                        x = A.length,
                        k, r, q, H, y, z, v, w, G, D, B, E, I, J, N, K;
                    m || (m = this.graphics.container = d.group("connectors", h), l ? m.show() : m.hide());
                    for (K = 0; K <= f; K += 1)
                        if (h = c[K])
                            if (B = h.config, !h.graphics && (h.graphics = {}), l = h.graphics, k = B.fromTaskId && B.fromTaskId.toLowerCase(), r = B.toTaskId && B.toTaskId.toLowerCase(), k = b[k], q = b[r], r = l.connector, k && q) {
                                if (E = k.config, w = q.config, k = E.yPos + .5 * E.height, q = w.yPos + .5 * w.height, H = k == q, y = E.xPos, z = E.xPos + E.width, v = w.xPos, w = w.xPos + w.width, !1 !== qa(y, z, v, w)) {
                                    ...
                                    r || (r = g.connector && g.connector.length ? l.connector = g.connector.shift() : l.connector = d.path(m), u ? (N = W.animation({
                                        "stroke-opacity": B.alpha
                                    }, u, n), I = 0, J = u) : I = B.alpha);
                                    r.show().animateWith(p, t, {
                                        path: G
                                    }, u, n).attr({
                                        stroke: B.color,
                                        "stroke-opacity": I,
                    ...
                    return function (b) {
                        var c = this.data("dataObj"),
                            d = c.config,
                            f = a.components.tasksMap,
                            e = f[d.fromTaskId],
                            f = f[d.toTaskId],
                            h = {
                                stroke: d.hoverColor,
                                "stroke-dasharray": d.dashedStyle,
                                "stroke-width": d.hoverThickness
                            },
                        ...
                        d.showHoverEffect && (xa([e, f], function (a) {
                            var b = {
                                ...
                                c = a.graphics.slackElem,
                                d = a.graphics.element,
                                e = a.graphics.taskFill;
                            a.config.percentComplete && !a.config.showAsGroup && (c && c.attr({
                                fill: a.config.slackHoverColor
                            }), e && e.attr({
                                fill: a.config.hoverFillColor,
                                stroke: a.config.hoverBorderColor
                            }), delete b.fill);
            ...
            Q.get("component", ["axis", "ganttCommon", {
                _drawPlotLine: function () {
                    var a = this.config,
                        ...
                        c = a.canvas,
                        d = b.config,
                        f = a.ganttPlotLineContainer,
                        e = c.canvasBottom || d.canvasBottom,
                        h = c.canvasLeft || d.canvasLeft,
                        m = c.canvasRight || d.canvasRight,
                        g = c.canvasTop || d.canvasTop,
                        l = b.components.paper,
                        n = a.gridArr,
                        c = this.graphics.line || [],
                        d = a.animateAxis,
                        u, p = 0,
                        t, q, r = [],
                        k, C;
                    ...
                    c[p] ? (f = c[p].graphics, b && d ? f.animateWith(C, k, {
                        path: r
                    }, b, u) : f.attr({
                        path: r
                    }), f.attr(a)) : (f = l.path(r, f), f.attr(a), c[p] = {}, c[p].graphics = f);
                    t = p + 1;
                    for (q = c.length; t < q; t += 1) c[t].graphics.attr({
                        path: "M0,0"
                    });
                    this.graphics.line = c
                }, _drawPlotBand: function () {}, translateAxis: function (a,
                    b) {
                    var c = this.config,
                        d = c.isVertical,
                        f = c.lastTranslate || (c.lastTranslate = {
                            x: 0,
                            y: 0
                        }),
                        e = c.ganttPlotHoverBandContainer,
                        h, m;
                    h = void 0 !== a ? a - f.x : 0;
                    m = void 0 !== b ? b - f.y : 0;
                    f.x = void 0 !== a ? a : f.x;
                    ...
                    d ? (c.ganttPlotLineContainer && c.ganttPlotLineContainer.translate(0, m), e && e.translate(0, m)) : (c.ganttPlotLineContainer && c.ganttPlotLineContainer.translate(h,
                        0), e && e.translate(h, 0), this.setAxisConfig({
                        animateAxis: !1
                    }), c.drawTrendLines && this._drawTrendLine(), this.setAxisConfig({
                        animateAxis: !0
                    }))
                    ...
                    var b =
                        this.config,
                        c = this.chart,
                        d = c.linkedItems.smartLabel,
                        f = c.components.colorManager,
                        e = b.labels.style,
                        h = a.elem || {},
                        m = a.dimension,
                        g = h._attrib || {},
                    ...
                    var b = this,
                        ...
                        d = b.chart,
                        f = d.components,
                        e = b.components.categoryElement || [],
                        h = c.hoverElemsArr || (c.hoverElemsArr = []),
                        m = f.paper,
                        f = a.elemIndex,
                        g = c.labelHoverEventName,
                        l = c.animateAxis,
                        n, u, p, t, q, r, k = d.config.showtooltip,
                        C, F = function (a) {
                    ...
                    var a = this.config,
                        b = this.chart,
                        c = b.components.paper,
                        d = this.graphics.gridLine || [],
                        f = a.animateAxis,
                        e, h, m = 0,
                        g = 0,
                        l = 2,
                    ...
                    for (e = {
                        ...
                        if (0 === g) n = a.gridLinePath, h = a.labelLineContainer;
                        else if (n = a.gridLineHeaderPath, h = a.headerLineContainer, !n) continue;
                        d[m] ? (h = d[m].graphics, b && f ? h.animateWith(p, u, {
                            path: n
                        }, b, t) : h.attr({
                            path: n
                        }), h.attr(e)) : (h = c.path(n, h), h.attr(e), d[m] = {}, d[m].graphics = h);
                        m += 1
                    }
                    g = m;
                    for (l = d.length; g < l; g += 1) d[g].graphics.attr({
                        path: "M0,0"
                    });
                    ...
                    var a = this.data("data"),
                        ...
                        f = d.chart,
                        e = f.config,
                        h = f.components.paper,
                        m = d.config,
                        f = m.hoverElemsArr || [],
                        m = m.ganttPlotHoverBandContainer,
                        d = d.graphics.plotHoverElement || (d.graphics.plotHoverElement = []),
                        b = "category" === b ? {
                            x: c.left,
                            y: e.canvasTop,
                    ...
                    if (a.useHover && f[a.pos])
                        for (b = 0, c = f[a.pos].length; b < c; b += 1) f[a.pos][b].bgElem.attr({
                            fill: a.rollOverColor
                        })
                }, _gridOutHandler: function () {
                    var a = this.data("data"),
                        b = a.axis,
                        c = b.config.hoverElemsArr || [],
                        b = b.graphics.plotHoverElement || [],
                        d, f;
                    a.usePlotHover && b[0] && b[0].hide();
                    if (a.useHover && c[a.pos])
                        for (b = 0, d = c[a.pos].length; b < d; b += 1) f = c[a.pos][b], f.bgElem.attr({
                            fill: f.bgColor
                        })
                }, _disposeExtraProcessAndDataTableElement: function (a) {
                    var b = this.components.categoryElement || [],
                        c;
                    for (c = b.length; a < c; a += 1) b[a].graphics.label.attr({
                        text: ""
                    }), b[a].graphics.rect.attr({
                        x: 0,
                        y: 0,
                        width: 0,
                        heigth: 0
            ...
            Q.get("component", ["axis", "time", {
                configure: function () {
                    ...
                    if (a) {
                        ...
                        for (n in c)
                            if (c.hasOwnProperty(n) && "_attrib" !== n)
                                for (u = 0, a = c[n].category.length; u < a; u += 1) h = c[n].category[u], m = b.getDateValue(h.start).ms, h = b.getDateValue(h.end).ms, isNaN(m) && (m = void 0), m > l && (l = m), m <= g && (g = m),
                    ...
                    var a = this.config,
                        ...
                        f = f.numberFormatter,
                        g = a.canvas,
                        l = a.gridArr || (a.gridArr = []),
                        l = g.canvasLeft || e.canvasLeft,
                        n = g.canvasTop || e.canvasTop,
                        u = g.canvasHeight || e.canvasHeight,
                        p = g.canvasWidth || e.canvasWidth,
                        e = a.lastTranslate || (a.lastTranslate = {
                            x: 0,
                            y: 0
                        }),
                        t = d.graphics,
                    ...
                    t.ganttPlotHoverBandContainerParent = t.ganttPlotHoverBandContainerParent || m.group("gantt-plot-band-container-parent",
                        q);
                    a.ganttPlotHoverBandContainer ? a.ganttPlotHoverBandContainer.animateWith(F, d, {
                        "clip-rect": l + "," + n + "," + p + "," + u
                    }, H, C) : (a.ganttPlotHoverBandContainer = m.group("gantt-plot-band-container", t.ganttPlotHoverBandContainerParent), a.ganttPlotHoverBandContainer.attr({
                        "clip-rect": l + "," + n + "," + p + "," + u
                    }));
                    a.ganttPlotLineContainer ? a.ganttPlotLineContainer.animateWith(F, d, {
                        "clip-rect": l + "," + n + "," + p + "," + u
                    }, H, C) : (a.ganttPlotLineContainer = m.group("gantt-plot-line-container", q), a.ganttPlotLineContainer.attr({
                        "clip-rect": l +
                            "," + n + "," + p + "," + u
                    }));
                    a.labelContainer ? a.labelContainer.animateWith(F, d, {
                        "clip-rect": l + "," + (n - y) + "," + p + "," + y
                    }, H, C) : (a.labelContainer = m.group("gantt-label-container", q), a.labelContainer.attr({
                        "clip-rect": l + "," + (n - y) + "," + p + "," + y
                    }));
                    ...
                    if (a.hasCategory) {
                        ...
                        for (r in m)
                            if (m.hasOwnProperty(r) && "_attrib" !== r)
                                for (k in n = m[r].category, u = void 0, l = a.gridArr = [], n) p = f.getDateValue(n[k].start).ms, t = f.getDateValue(n[k].end).ms, !n.hasOwnProperty(k) || "_attrib" === k || isNaN(p) || isNaN(t) || (p = {
                                    elem: n[k],
                                    elemIndex: g,
                                    pos: g,
                                    dimension: {
                                    ...
                                    type: "category",
                                    isHeader: !1
                                }, u = p.dimension.right, this._drawProcessAndDataTableElement(p), g += 1, l.push({
                                    x: p.dimension.left
                                }));
                        0 < h.x ? e.x = -(h.x * h.scaleX) : a.lastTranslate = {
                            x: 0,
                            y: 0
                        }
                    }
                    ...
                    var b = this.config,
                        c = this.chart,
                        d = c.config,
                        f = c.get("components").numberFormatter,
                        ...
                        l = 0,
                        n, u, p, t, r, x, k, C = b.trend.trendStyle,
                        F = b.vTrendLines,
                        H = b.useEllipsesWhenOverflow,
                        y = 0,
                        z = 0;
                    ...
                    if (b.hasCategory)
                        for (p in n = b.categories.category, n)
                            if (n.hasOwnProperty(p) && "_attrib" !== p) {
                                m = 0;
                                u = n[p].category;
                    ...
                    u = a - l;
                    if (b.drawTrendLines && b.drawTrendLabels && F && b.isActive)
                        for (e.setStyle({
                                fontSize: C.fontSize,
            ...
            Q.get("component", ["axis", "process", {
                configure: function () {
                    ...
                    var a = this.config,
                        b = this.chart.config.canvasHeight,
                        c = a.processes.process.process,
                        d = a.processes.processHeightMap,
                        f = a.processMaxHeight,
                        e = 0,
                        h = a.forceRowHeight,
                        m = a.rowHeight;
                    ...
                    0 === h ? m && m > f && (f = m) : f = m || f;
                    h = 0;
                    for (b = c.length; h < b; h++) a = r(c[h].height, f), d[h] = {
                        top: e,
                        bottom: e + a,
                        height: a
                    }, e += a;
                    ...
                    var a = this.config,
                        ...
                        m = e.canvasTop || h.canvasTop,
                        g = e.canvasLeft || h.canvasLeft,
                        l = e.canvasHeight || h.canvasHeight,
                        n = e.canvasWidth || h.canvasWidth,
                        u = b.graphics,
                        p = u.axisBottomGroup,
                        e = a.totalVisiblelWidth,
                        t, q = 0,
                        r, k, C, F;
                    ...
                    a.ganttPlotHoverBandContainer ? a.ganttPlotHoverBandContainer.animateWith(C,
                        b, {
                            "clip-rect": g + "," + m + "," + n + "," + l
                        }, F, k) : (a.ganttPlotHoverBandContainer = f.group("gantt-plot-band-container", u.ganttPlotHoverBandContainerParent), a.ganttPlotHoverBandContainer.attr({
                        "clip-rect": g + "," + m + "," + n + "," + l
                    }));
                    a.ganttPlotLineContainer ? a.ganttPlotLineContainer.animateWith(C, b, {
                        "clip-rect": g + "," + m + "," + n + "," + l
                    }, F, k) : (a.ganttPlotLineContainer = f.group("gantt-plot-line-container", p), a.ganttPlotLineContainer.attr({
                        "clip-rect": g + "," + m + "," + n + "," + l
                    }));
                    a.headerContainer ? a.headerContainer.animateWith(C,
                        b, {
                            "clip-rect": g - a.totalVisiblelWidth + "," + (m - h.categorySpaceUsed) + "," + a.totalVisiblelWidth + "," + h.categorySpaceUsed
                        }, F, k) : (a.headerContainer = f.group("gantt-header-container", p), a.headerContainer.attr({
                        "clip-rect": g - a.totalVisiblelWidth + "," + (m - h.categorySpaceUsed) + "," + a.totalVisiblelWidth + "," + h.categorySpaceUsed
                    }));
                    ...
                    a.labelContainer ? a.labelContainer.animateWith(C, b, {
                        "clip-rect": g - a.totalVisiblelWidth + "," + m + "," + a.totalVisiblelWidth + "," + l
                    }, F, k) : (a.labelContainer = f.group("gantt-label-container", p), a.labelContainer.attr({
                        "clip-rect": g - a.totalVisiblelWidth + "," + m + "," + a.totalVisiblelWidth + "," + l
                    }));
                    ...
                    a.hotContainer ? a.hotContainer.animateWith(C, b, {
                        "clip-rect": g - a.totalVisiblelWidth + "," + (m - h.categorySpaceUsed) + "," + a.totalVisiblelWidth + "," + (l + h.categorySpaceUsed)
                    }, F, k) : (a.hotContainer = f.group("gantt-hot-container", a.axisLabelGroup), a.hotContainer.attr({
                    ...
                    if (a.hasProcess)
                        for (process = a.processes.process.process, g = {
                            ...
                            type: "process"
                        }, this._drawProcessAndDataTableElement(g), q += 1, f.push({
                            y: g.dimension.bottom
                        });
                    if (a.hasDataTables) {
                        f = a.dataTables.dataTable.datacolumn;
                        for (t in f)
                            if (f.hasOwnProperty(t) && "_attrib" !== t)
                                for (r in g = {
                                    elem: f[t],
                                    elemIndex: q,
                                    pos: t,
                                    dimension: {
                                        left: c - d + f[t]._attrib.leftPos,
                                        right: c - d + f[t]._attrib.rightPos,
                                        top: m - h.categorySpaceUsed,
                                        bottom: m
                                    },
                                    type: "header"
                    ...
                    var a = this,
                        ...
                        f = (b.axisDimention || {}).x,
                        e = b.totalWidth || 0,
                        h = b.canvas.canvasTop || d.canvasTop,
                        m = c.components.paper,
                        g = a.components.processVline ||
                        (a.components.processVline = []),
                        l = b.processVlineArr,
                        n = b.hotContainer,
                        u = 0,
                        p, t, q, r, k, C, F, H = function () {
                        ...
                        z = function () {
                            ...
                            c.trackerClicked = !1;
                            f.hide();
                            d.draged && (e.left.rightPos += d.lastX || 0, e.right.leftPos += d.lastX || 0, e.xPos += d.lastX || 0, l[g - 1] && (l[g - 1].rightLimit += d.lastX || 0), l[g + 1] && (l[g + 1].leftLimit += d.lastX || 0), b.drawFromProcessVlineDrag = !0, a._drawProcessAndDataTable(), a._drawVerticalLineAndTracker(), d = {
                                transform: "t0,0"
                            }, this.attr(d), f.attr(d))
                        };
                    k = {
                        stroke: b.gridResizeBarColor,
                        "stroke-width": b.gridResizeBarThickness,
                        visibility: "hidden"
                    };
                    C = {
                        stroke: ja,
                    ...
                    d = 0;
                    for (p = l.length; d < p; d += 1) t = "process" === l[d].type ? b.processes.process.process : b.dataTables.dataTable.datacolumn[l[d].ind], t = f - e + t._attrib.rightPos, t = ["M", t, r, "L", t, h + b.processTotalHeight], g[u] ? (F = g[u].graphics.vHoverLine, F.attr({
                        path: t
                    }).attr(k), q = g[u].graphics.hotElement, q.attr({
                        path: t
                    }).attr(C)) : (F = m.path(t, n), F.attr(k), q = m.path(t, n), q.attr(C), g[u] = {}, g[u].graphics = {}, g[u].config = {}, g[u].graphics.vHoverLine = F, g[u].graphics.hotElement = q), q.css("cursor", W.svg && "ew-resize" || "e-resize").drag(y, H,
                        z).data("drag-options", {
                    ...
                    d = u;
                    for (p = g.length; d < p; d += 1) g[d].graphics.vHoverLine.attr({
                        path: ["M", 0, 0]
                    }), g[d].graphics.hotElement.attr({
                        path: ["M", 0, 0]
                    })
                }, manageProcessScroll: function (a) {
                    var b = this.config,
                        c = b.totalWidth || 0,
                        b = b.totalVisiblelWidth;
                    ...
                    if (b.hasDataTables)
                        for (p in e = b.dataTables.dataTable.datacolumn, e)
                            if (e.hasOwnProperty(p) && "_attrib" !== p) {
                                u = e[p];
                                h = 0;
                    ...
                    if (a.hasDataTables)
                        for (n in g = a.dataTables.dataTable.datacolumn, g)
                            if (g.hasOwnProperty(n) && "_attrib" !== n) {
                                h = g[n];
                                h = h._attrib;
                                l = d;
