...
(function (P) {
    ...
    P.register("module", ["private", "modules.renderer.js-kdtree",
        function () {
            function K(f) {
                function x(f, E, H, r) {
                    var l = {},
                    ...
                    if (1 === H - E) return f[E][e] > f[H][e] ? (l.point = f[E], l.left = {
                        point: f[H]
                    }) : (l.point = f[H], l.left = {
                        point: f[E]
                    }), l;
                ...
                return {
                    tree: 0 === f.length ? {} : x(f, 0, f.length - 1, !1),
                    search: function (f,
                        e, x) {
                        function r(a, d) {
                        ...
                        function l(b) {
                            var c = f >= b.x1 && f <= b.x2 && e >= b.y1 && e <= b.y2,
                                J;
                            J = b.point.y;
                                ...
                                if (T(R, v, r, e, n) && 3 <= u) {
                                    ...
                                    for (F = 0; F < u; F++) {
                                        ...
                                        var E = D,
                                            ...
                                            q = v,
                                            I = Q(E, H, K, l, P, C),
                                            Y = Q(E, H, K, l, Infinity, q),
                                            Z = Q(P, C, Infinity, q, E, H),
    ...
    P.register("module", ["private", "modules.renderer.js-zoomscatter",
        function () {
            var K = this,
                e = K.hcLib,
                da = e.parseTooltext,
                ...
                C = e.chartAPI,
                q = e.HUNDREDSTRING,
                F = !e.CREDIT_REGEX.test(X.location.hostname),
                I = function (c, b) {
                    var a = l(b.linkedItems.container, c),
                        d = a.chartX,
                        h = a.chartY,
                        t = b.config,
                        J = t.canvasLeft,
                        e = t.canvasTop,
                        g = t.canvasLeft + t.canvasWidth,
                        t = t.canvasHeight + t.canvasTop;
                    a.insideCanvas = !1;
                    a.originalEvent = c;
            ...
            C("zoomscatter", {
                ...
                configure: function () {
                    ...
                    var c = this.jsonData,
                        b = this.components.xAxis,
                        a = y(c.chart.xaxislabelmode, "categories"),
                        c = c.categories && c.categories[0],
                        c = (c && c.category || []).slice(),
                        d, h = Infinity,
                        t = -Infinity,
                        e;
                    ...
                    c.yAxis[0].setAxisConfig({
                        animateAxis: !1
                    });
                    c.xAxis[0].setAxisConfig({
                        animateAxis: !1
                    })
                }, _spaceManager: function () {
                    var c, b, a = this.config,
                        d = this.components,
                        h = d.xAxis && d.xAxis[0];
                    b = d.yAxis && d.yAxis || [];
                    var t, e, m = d.legend.config.legendPos,
                        ...
                        p = a.canvasBgDepth,
                        f = a.canvasBaseDepth,
                        ia = a.canvasBasePadding,
                        G = d.canvas.config.canvasBorderWidth,
                        n = a.realTimeConfig && a.realTimeConfig.showRTValue,
                        w = a.borderWidth,
                        V = a.canvasMarginTop,
                        W = a.canvasMarginBottom,
                        z = a.canvasMarginLeft,
                        S = a.canvasMarginRight,
                        d = a.minCanvasHeight,
                        l = a.minCanvasWidth;
                    c = a.minChartWidth;
                    var r = a.minChartHeight,
                        u = a.height,
                        v = a.width,
                        q = a._initConfig || (a._initConfig = {}),
                        x = !1,
                        y = a.origCanvasTopMargin,
                        A = a.origCanvasBottomMargin,
                        B, C, D = [];
                    ...
                    w = 0;
                    for (e = b.length; w < e; w++) t = b[w], c = .7 * a.availableWidth, c = t && t.placeAxis(c) || {}, D.push({
                        axisIndex: w,
                        spaceTaken: c
                    }), t && this._allocateSpace(c);
                    b = .7 * a.canvasHeight;
                    this._manageActionBarSpace && this._allocateSpace(this._manageActionBarSpace(b));
                    this._manageLegendSpace(void 0);
                    k && (this._allocateSpace({
                        bottom: k
                    }), a.shift = g + ia + f);
                    p && this._allocateSpace({
                        right: p
                    });
                        ...
                        h = b.zoomInButton = (new a("zoomInIcon", void 0, c.idCount++, c.pId)).attachEventHandlers({
                            ...
                            click: function () {
                                var a = p.viewPortConfig,
                                    b = k.graphics;
                                1 < p.viewPortHistory.length && (a.isReset = !0, k.zoomSelection(0, 0, p.canvasWidth, p.canvasHeight), p.viewPortHistory.splice(1), b.trackerGroup.attr({
                                    cursor: "default"
                                }), k.updateButtonVisual(), k.updateSelectionBox(0, 0, 0, 0));
                    ...
                    var c = this.graphics,
                        ...
                        t = a.canvasWidth,
                        e = a.canvasHeight,
                        m = this.jsonData.chart,
                        g = this.linkedItems,
                        g = g.eventListeners || (g.eventListeners = []),
                        k = this.linkedItems.container,
                    ...
                    !c.trackerElem && (c.trackerElem = p.rect(d, h, t, e, 0, c.trackerGroup).attr({
                        fill: R,
                        stroke: R
                    }));
                    ...
                    h.cursor = g;
                    m.selectionDimensions || (m.selectionDimensions = {
                        startX: 0,
                        endX: 0,
                        startY: 0,
                        endY: 0
                    ...
                    var h = a.xAxis[0].config.axisRange,
                        a = a.yAxis[0].config.axisRange,
                        t = h.min,
                        e = a.max;
                    return {
                    ...
                    d = h.canvasWidth;
                    h = h.canvasHeight;
                    var m = B(c[0].chartX, c[1].chartX) - t,
                        g = B(c[0].chartY, c[1].chartY) - e,
                        k = Math.abs(c[1].chartX - c[0].chartX);
                    c = Math.abs(c[1].chartY - c[0].chartY);
                    var t = B(b[0].chartX, b[1].chartX) - t,
                        p = B(b[0].chartY, b[1].chartY) - e,
                    ...
                    var b = this.config,
                        a = b.status;
                    c && (b.status = "zoom" === a ? "pan" : "zoom", K.raiseEvent("zoomModeChanged", {
                        panModeActive: b.status
                    }, this.chartInstance, [this.chartInstance.id]));
                    this.updateButtonVisual()
                }, updateManager: function (c) {
                    var b, a = this.components.dataset,
                        d = a.length;
                    ...
                    var c, b = [],
                        ...
                        q = function (a) {
                            var b = a.chartX,
                                d = a.chartY,
                                c = m.getAxisConfig("axisDimention").x || h.canvasLeft,
                                t = h.canvasTop,
                                e = h.canvasRight,
                                g = h.canvasBottom;
                            b < c && (a.chartX = D(b, c));
                        ...
                        w = {
                            start: function (a) {
                                ...
                                h.isDragging = !1;
                                "pan" === h.status && (h.panStartX = k.x, h.panStartY = k.y, b[0].insideCanvas && t.trackerGroup.attr({
                                    cursor: "move"
                                }))
                            }, on: function (c) {
                                var g, m, f, w;
                                ...
                                var e = I(c, d),
                                    g = m.getAxisConfig("axisDimention").x || h.canvasLeft,
                                    k = h.canvasTop,
                                    J;
                                J = h.canvasWidth / 4;
                                var w = h.canvasHeight / 4,
                                    e = isNaN(e.chartX) || isNaN(e.chartY) ? a[0] || b[0] : e;
                                if (h.isDragging) {
                                    if (p) {
                    ...
                    var c, b = this.components.dataset,
                        a = b.length;
                    ...
                    if (h) this.updateManager(h);
                    else
                        for (1 < a || 1 < d ? ("zoom" === q && this.toogleDragPan(!0), a >= n.scaleX || d >= n.scaleY ? (w.push({
                            scaleX: a,
                            scaleY: d,
                            x: c,
                            y: b
                            ...
                            q = ["zoomed", "zoomOut"]), this.toogleDragPan(), G = t.canvasWidth, n = t.canvasHeight, c && (c = f.x *= G / k), b && (f.y *= n / l), t.canvasLeft = r.canvasLeft, t.canvasWidth = r.canvasWidth, t.canvasHeight = r.canvasHeight, t.canvasTop = r.canvasTop, t.availableHeight = r.availableHeight, t.availableWidth = r.availableWidth, this._spaceManager(), this._postSpaceManagement(), this.updateManager(), e.draw(), g.draw(), this._drawCanvas(), k = {
                            "clip-rect": t.canvasLeft + "," + t.canvasTop + "," + t.canvasWidth + "," + t.canvasHeight
                        }, t.viewPortConfig && this.graphics.imageContainer.attr({
                            x: t.canvasLeft,
                            y: t.canvasRight
                    ...
                    h = b && b.length;
                    var a =
                        a.xAxis[0].getPixel(c.x),
                        d = d.getPixel(c.y),
                        e, f, m, g, k, p;
                    if (h)
                        for (--h; 0 <= h; h--)
                            if (f = b[h], g = f.x1, k = f.y1, e = f.x2, p = f.y2, f.isTrendZone) {
                    ...
                    var b = this.components,
                        ...
                        d = b.xAxis[0],
                        h = b.yAxis[0],
                        t = this.jsonData.chart,
                        f = a.canvasLeft,
                        m = a.canvasTop,
                        g, k, p, n, l, q, r, w, u, v, z, x;
                    x = b.numberFormatter;
                    u = b.dataset;
                    for (g = u.length - 1; 0 <= g; --g)
                        if (b = u[g], z = b.config, k = z.showHoverEffect, w = z.showTooltip, b.components.kDTree && b.visible && (n = b.getElement(c), b = this._dist(c, n), !l || b < q))
                            if (p = g, l = n, q = b, r = u[p] && z.zoomedRadius || 0, q <= r) break;
                    q <= D(r + 2, 5) ? (c = d.getPixel(l.x) - f, m = h.getPixel(l.y) - m, f = y(l.tooltext, z.plotToolText), b = u[p], z = b.config, u = z.tooltip.toolTipSepChar, q = z.tooltip.seriesNameInToolTip, r = l.x, g = l.y, l && (v = x.yAxis(g), x = x.xAxis(r), v = Number(w) ? void 0 !== f ? da(f, [4, 5, 6, 7, 8, 9, 10, 11], {
                        ...
                        xaxisName: d.getAxisConfig("axisName"),
                        yDataValue: v,
                        xDataValue: x
                    ...
                    var q = g && n.hoverCosmetics,
                        g = q && q.fill,
                        n = q && q.borderColor,
                        q = q && q.borderThickness,
                        r = {},
                        r = function (a) {
                        ...
                        v = d && d.link;
                    l || (l = k.tracker = p.circle(0, 0, 0, k.trackerGroup).attr({
                        "clip-rect": m.canvasLeft + "," + m.canvasTop + "," + m.canvasWidth + "," + m.canvasHeight
                    }).click(r).trackTooltip(!0).hover(w, u));
                    d && l.data("eventArgs", {
                        x: d.x,
                        y: d.y,
                        tooltip: t,
            ...
            P.register("component", ["dataset", "zoomscatter", {
                ...
                configure: function () {
                    ...
                    d = this.chart;
                    a = d.components;
                    var h = d.graphics.imageContainer,
                        e = a.paper;
                    d = d.config;
                    var f = this.visible,
                        m = d.viewPortConfig,
                    ...
                    var p = h.scaleX,
                        l = h.scaleY,
                        m = this.graphics._grid || (this.graphics._grid = []),
                        g = p / g,
                        k = l / k,
                        l = e.canvasWidth * g,
                        e = e.canvasHeight * k;
                    ...
                    if (a && a.length)
                        for (; a.length;) clearTimeout(a.shift());
                    d.line.transform("t" + A(-h.x * h.scaleX) + "," + A(-h.y * h.scaleY));
                    d.plot.transform("t" + A(-h.x * h.scaleX) + "," + A(-h.y * h.scaleY));
                    for (c in m)
                        if (h = m[c])
                            for (b in h)(d = h[b]) && d.drawState && (a = d.image, a.attr({
                                x: d.xPixel * g,
                                y: d.yPixel * k,
                                width: l,
                                height: e
                            }), f && (a = d.lineImage, a.attr({
                                x: d.xPixel * g,
                                y: d.yPixel * k,
                                width: l,
                                height: e
                    ...
                    b = this.config;
                    var e = this.graphics,
                        f = e._imagePool || (e._imagePool = []),
                        m = e._canvasPool || (e._canvasPool = []),
                        g = e._lineImagePool || (e._lineImagePool = []),
                        k = e._lineCanvasPool || (e._lineCanvasPool = []),
                        p = e._grid || [];
                    if ((b = b._batchDarwTimers) && b.length)
                        for (; b.length;) clearTimeout(b.shift());
                    for (a in p)
                        if (h = p[a])
                            for (d in h)(b = h[d]) && b.drawState && (c = b.image, c.attr({
                                src: "",
                                width: 0,
                                height: 0
                    ...
                    var b = this,
                        a = b.graphics,
                        d = b.config,
                        e = b.chart.config.viewPortConfig;
                    ...
                    var c, b, a, d, e, f, l, m, g, k = this,
                        p = k.config,
                        n = k.graphics._grid,
                        q = p._drawGrid || (p._drawGrid = []),
                        r = k.chart,
                        u = r.config,
                        r = r.components;
                    e = u.viewPortConfig;
                    ...
                    var v = r.xAxis[0],
                        x = r.yAxis[0],
                        r = v.getAxisConfig("axisDimention").axisLength || u.canvasWidth,
                        u = u.canvasHeight,
                        z = v.config,
                        y = x.config,
                        A = z.axisRange.min,
                    ...
                    var a = this.chart.config,
                        d = a.viewPortConfig,
                        e = a.canvasWidth / d.scaleX,
                        a = a.canvasHeight / d.scaleY,
                        f = isNaN(c) ? d.x + e / 2 : c,
                        d = isNaN(b) ? d.y +
                        a / 2 : b;
                    return {
                    ...
                    var l = f.components,
                        ...
                        p = g._drawGrid,
                        n = [],
                        q = this.graphics.container,
                        r = l.paper,
                        l = l.xAxis[0].getAxisConfig("axisDimention").axisLength || b.canvasWidth,
                        u = b.canvasHeight,
                        w = this.graphics._grid,
                        v = this.graphics._imagePool || [],
                        x = this.graphics._canvasPool || [],
                        z = this.graphics._lineImagePool || [],
                        y = this.graphics._lineCanvasPool || [],
                        A = g.plotCosmetics,
                        m = g.radius * B(m.scaleX,
                            m.scaleY),
                    ...
                    if (0 <= l) {
                        ...
                        delete z._store;
                        if (F)
                            for (z = g.regressionData, p = 0; p < c.length; p += 1) d = c[p], l = d.xMinValue,
                        ...
                        for (p = 0; p < c.length; p += 1) d = c[p], n = d.image, f = d.canvas, d.drawState = 1, n.attr({
                            src: f.toDataURL("image/png")
                        }), C && (v = d.lineImage, x = d.lineCanvas, v.attr({
                            src: x.toDataURL("image/png")
                        }));
                    ...
                    var c = this.config;
                    c._kdPoints = (this.JSONData.data || []).slice();
                    ...
                    var c =
                        ...
                        d = this.JSONData,
                        e = c.getFillColor,
                        l = y(d.anchorbordercolor, b.anchorbordercolor),
                        n = r(y(l, a.plotBorderColor)),
                        ...
                        b = y(d.anchorbgalpha, d.alpha, b.anchorbgalpha, q),
                        d = {
                            color: a.lineColor,
                            alpha: a.lineAlpha
                        },
                    ...
                    var c, b, a, d, f, l, n, m, g, k = -Infinity,
                        p = Infinity,
                        q = Infinity,
                        r = -Infinity,
                        u = this.components.data || (this.components.data = []);
                    c = this.chart;
                    var v = e.parseUnsafeString,
                        w = this.config,
                        x = this.JSONData,
                        A = c.jsonData.chart,
                        z = x.data || [],
                        C = z.length,
                        E = c.components.numberFormatter,
                        F = v(A.yaxisname),
                        H = v(A.xaxisname),
                        I = w.lineDashed,
                        L = w.lineDashStyle,
                    ...
                    for (c = 0; c < C; c += 1) d = z[c], a = u[c] || (u[c] = {}), b = a.config || (a.config = {}), b.setValue = f = {
                        ...
                        (d = N ? N + M : U, d += f.x ? n + M : U, d += l) : d = !1, b.toolText = d, a ? a.graphics || (u[c].graphics = {}) : a = u[c] = {
                            graphics: {}
                        }, b.hoverEffects = this._parseHoverEffectOptions(a), b.anchorProps.isAnchorHoverRadius = b.hoverEffects.anchorRadius;
                    w.xMax = r;
                    w.xMin = q;
                    w.yMin = p;
                    w.yMax = k;
