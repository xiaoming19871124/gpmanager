...
(function (E) {
    ...
    E.register("module", ["private", "modules.renderer.js-spark",
        function () {
            var b = this.hcLib,
                k = b.BLANKSTRING,
                d = b.pluck,
                ...
                n = b.extend2,
                L = b.chartAPI,
                D = b.graphics.getLightColor,
                u = b.COMMASTRING,
                e = b.graphics.convertColor,
                C = b.getValidValue,
                N = Math,
                J = N.min,
                K = N.max,
                I = N.ceil,
                G = b.toRaphaelColor,
                Z = b.parseUnsafeString,
                S = b.graphics.getColumnColor,
                c = b.graphics.parseColor,
                F = b.COLOR_TRANSPARENT,
                g = b.POSITION_BOTTOM,
                H = b.POSITION_MIDDLE,
                B = b.POSITION_START,
                f = b.POSITION_END,
                r = b.HUNDREDSTRING,
                N = !b.CREDIT_REGEX.test(this.window.location.hostname),
                y = n({}, b.defaultGaugePaletteOptions),
                W = function () {
                    var c = this.chart,
                        v = c.config,
                        l = v.dataLabelStyle,
                        p = c.components.paper,
                        g = v.valuepadding + 2,
                        m = this.graphics.dataLabelContainer || c.graphics.datalabelsGroup,
                        h = v.sparkValues || (v.sparkValues = {}),
                        w = c.graphics,
                        w = w.sparkLabels || (w.sparkLabels = {}),
                        q = c.linkedItems.smartLabel,
                        z = c.get("config", "animationObj"),
                        c = z.transposeAnimDuration,
                        z = z.animType,
                        A = "[",
                        x = "]",
                        na = "|",
            ...
            L("sparkchartbase", {
                ...
                _setAxisLimits: function () {
                    ...
                    var c, v = this.config,
                        l = v.canvasBaseDepth,
                        p = this.components.canvas.config.canvasBorderWidth;
                    c = v.borderWidth;
                    var g = v.canvasMarginTop,
                        m = v.canvasMarginBottom,
                        h = v.canvasMarginLeft,
                        w = v.canvasMarginRight,
                        q = v.minCanvasHeight,
                        z = v.minCanvasWidth,
                        A = v.height,
                        x = v.width,
                        ...
                        pa = v.origCanvasBottomMargin,
                        ma = v.origCanvasLeftMargin,
                        R = v.origCanvasRightMargin;
                    this._allocateSpace({
                        top: c,
                        bottom: c,
                        left: c,
                    ...
                    var v = this.config,
                        ...
                        p = p.components,
                        g = g.components,
                        w = this.jsonData.chart,
                        q = this.linkedItems.smartLabel,
                        z = Z(w.caption),
                        A = Z(w.subcaption),
                        w = m.captionPadding = a(w.captionpadding, 2),
                        x = l.chartMenuBar,
                        x = x && x.getLogicalSpace(),
                        na = v.height - (x && x.height || 0),
                        ta = 0,
                        x = 0,
                        t = K(l.canvas.config.canvasBorderThickness, 0),
                        pa = 0,
                        l = {},
                        ma, R;
                    ...
                    var c = this.config,
                        v = this.components,
                        l = v.caption.config,
                        v = v.subCaption.config,
                        p = l.captionPosition,
                        a = K(l.width, v.width),
                        m = c.borderWidth || 0,
                        h = c.height,
                        w = (c.sparkValues || {}).openValueWidth || 0,
                        q = l.captionPadding,
                        z = l.captionSubCaptionGap;
                    switch (p) {
                    case H:
            ...
            L("sparkcolumn", {
                ...
                _parseCanvasCosmetics: function () {
                    ...
                    v = this.components;
                    var p = v.canvas.config,
                        g = this.jsonData.chart;
                    v = v.colorManager;
                    var m, h = this.is3D ?
                        b.chartPaletteStr.chart3D : b.chartPaletteStr.chart2D,
                        w = p.isRoundEdges = a(g.useroundedges, 0);
            ...
            E.register("component", ["dataset", "sparkcolumn", {
                _setConfigure: function (c) {
                    var p = this.chart,
                        ...
                        h = c || m.data,
                        w = h && h.length,
                        q = p.config.categories,
                        q = q && q.length;
                    c = c && c.data.length || J(q, w);
                    var w = b.plothovereffect,
                        z = p.components.colorManager,
                        b = b.useroundedges,
                        A, x, na, ta, t, pa, ma, R, Aa, f, y, H, M, F, B, W, n;
            ...
            E.register("component", ["datasetGroup", "SparkColumn", {}, "column"]);
            L("sparkwinloss", {
                standaloneInit: !0,
                ...
                _setAxisLimits: function () {
                    ...
                    var p = this.config,
                        l = this.linkedItems.smartLabel,
                        g = p.dataLabelStyle,
                        r = a(g.borderThickness, 0),
            ...
            E.register("component", ["dataset", "sparkwinloss", {
                _setConfigure: function (c, p) {
                    var l = this.chart,
                        ...
                        h = c || m.data,
                        w = h && h.length,
                        q = l.config.categories,
                        q = q && q.length,
                        w = c && c.data.length || J(q, w),
                        q = l.jsonData.chart,
                        z = l.components,
                        A = z.colorManager,
                        z = z.xAxis[0],
                        x = g.showplotborder,
                        na = f.plotColor = A.getPlotColor(this.index || this.positionIndex),
                        ta = b.parseUnsafeString,
                        t = d(q.plotfillcolor, A.getColor("plotFillColor")),
                        pa = d(q.wincolor, A.getColor("winColor")),
                        ma = d(q.losscolor, A.getColor("lossColor")),
                        R = d(q.drawcolor, A.getColor("drawColor")),
                        A = d(q.scorelesscolor, A.getColor("scorelessColor")),
                        Aa = q.winhovercolor,
                        y = q.losshovercolor,
                        H = q.drawhovercolor,
                        u = q.scorelesshovercolor,
                        M = 0,
                        F = 0,
                        B = 0,
                        W, n, e = g.plotborderthickness,
                        S = g.isroundedges,
                        Z = g.plothovereffect,
                        I = f.plotfillangle,
                        U, V, L, la, N = f.plotBorderDashStyle,
                        O, P, Y, T, qa, E, ja, ka, Fa, Ia, ea = b.getDashStyle,
                        va = this.components.data,
                        ga = l.isBar,
                        Ha = l.is3D,
                        Ca, Ja = f.maxValue || -Infinity,
                        Na = f.minValue || Infinity,
                        xa;
            ...
            E.register("component", ["datasetGroup", "SparkWinLoss", {
                manageSpace: function () {}, draw: function () {
                    var c = this.positionStackArr,
                        g = c.length,
                        p, r, f, m, h = this.chart;
                    ...
                    for (p = 0; p < g; p++)
                        for (r = c[p], f = r.length, this.manageClip = !0, r = 0; r < f; r++) m = c[p][r].dataSet, m.draw()
                }
            }, "column"]);
            L("sparkline", {
                standaloneInit: !0,
            ...
            E.register("component", ["dataset", "sparkline", {
                ...
                configure: function () {
                    ...
                    var g = this.chart,
                        ...
                        f = g.jsonData.chart,
                        r = p || r.data,
                        m, h = g.components.xAxis[0];
                    p = p && p.data.length || h.getCategoryLen();
                    var w = g.components.colorManager,
                        g = g.config,
                        q, z, h = c(d(f.opencolor, "0099FF")),
                        A = c(d(f.closecolor, "0099FF")),
                        x = c(d(f.highcolor, "00CC00")),
                        na = c(d(f.lowcolor, "CC0000")),
                        ...
                        R = a(f.showlowanchor, f.drawanchors, f.showanchors, 1),
                        Aa = a(f.anchoralpha, 100),
                        b = a(f.drawanchors,
                            f.showanchors, 0) ? a(f.anchoralpha, 100) : 0,
                        y = d(f.linecolor, w.getColor("plotFillColor")),
                        H, M, G, F, u, B;
                    this.__base__._setConfigure.call(this);
    ...
    E.register("module", ["private", "modules.renderer.js-messagelogger",
        function () {
            var b = this.window,
                k = b.document,
                d = 8 === k.documentMode,
                a = this.hcLib,
                n = a.Raphael,
                L = a.componentDispose,
                D = a.pluckNumber,
                u = a.isIE,
                e = a.graphics.HEXtoRGB,
            ...
            K.prototype = {
                draw: function () {
                    var a = this.config,
                        b = this.graphics,
                        c, F = b.element,
                        g = this.linkedItems.msgLogger,
                        H = g.graphics,
                        B = H && H.log && H.log.element,
                        H = H.logWrapper && H.logWrapper.element,
                        g = g.config;
                    if (!F) {
            ...
            E.register("component", ["logger", "message", {
                ...
                init: function (a) {
                    ...
                    var d = this.config,
                        ...
                        G = D(a.msgGoesToLog, d.messageGoesToLog),
                        g = D(a.msgGoesToJS, d.messageGoesToJS),
                        H = b[d.messageJSHandler],
                        u = N(a.msgId, ""),
                        f = N(a.msgTitle, ""),
                        r = N(a.msgText, ""),
                        y = N(a.msgType, "literal");
                    ...
                    var a = this.components.messages,
                        b, c = a.length;
                    ...
                    var a = this.config,
                        ...
                        c;
                    if (a.usemessagelog)
                        for (this._createHTMLDialogue(), a.visible || this.hide(), c = b.length, a = 0; a < c; a += 1) b[a] && b[a].draw && b[a].draw();
                    else this.isDrawn() && (this.clearLog(), this.hide())
                }, _createHTMLDialogue: function () {
                    var a = this,
                        b = a.config,
                        c = a.graphics,
                        d = a.components,
                        g = a.linkedItems.chart,
                        H = g.get("components", "paper"),
                        G = g.get("linkedItems", "container"),
                        f = g.get("config"),
                        r = f.width,
                        y = f.height,
                        u = (g = f.style) && g.inCanvasStyle,
                        p = b.messageLogShowTitle,
                        ia = b.messageLogIsCancelable,
                        v = b.messageLogColor,
                        l = b.messageLogTitle,
                        e = d.paper,
                        D = c.cg,
                        m = b.messageLogWPercent / 100 * r,
                        h = b.messageLogHPercent / 100 * y,
                        w = (r - m) / 2,
                        q = (y - h) / 2,
                        z = m - 18 - 22,
                        A = h - 18 - 22,
                    ...
                    g || (g = c.container = H.html("div", {
                        ...
                        var c = this && this.scrollTop,
                            t = this &&
                            this.scrollHeight,
                            q = this && this.offsetHeight;
    ...
    E.register("module", ["private", "modules.renderer.js-alertmanager",
        function () {
            var b = this,
                k = b.hcLib;
            E.register("component", ["manager", "alert", {
                ...
                init: function (b) {
                    ...
                    var b =
                        this.linkedItems.chart,
                        a = b.get("jsonData", "alerts"),
                        a = a && a.alert,
                        b = b.get("components", "numberFormatter"),
                        n = this.config || (this.config = {}),
                        k, D;
                    if (a && a.length)
                        for (n.alertArr = a, n = a.length, k = 0; k < n; k += 1) D = a[k], D.minvalue = b.getCleanValue(D.minvalue), D.maxvalue = b.getCleanValue(D.maxvalue);
                    else n.alertArr = []
                }, processRTData: function (b) {
                    var a = this.linkedItems.chart.get("components", "numberFormatter"),
                        n, k, D, u, e, C, N;
                    if (b && b.dataset && b.dataset.length)
                        for (D = b.dataset.length, n = 0; n < D; n += 1)
                            if (u = b.dataset[n], u.data &&
                                u.data.length)
                                for (e = u.data.length, k = 0; k < e; k += 1) N = (C = u.data[k]) && a.getCleanValue(C.value), null !== N && this._doAlert(a.getCleanValue(C.value))
                }, _doAlert: function (d) {
                    var a = this.linkedItems.chart,
                        n = this.config.alertArr,
                        L = n.length,
                        D, u, e;
                    for (u = 0; u < L; u += 1)
    ...
    E.register("module", ["private", "modules.renderer.js-realtime",
        function () {
            var b = this,
                k = b.window,
                d = Math.random,
                a = b.hcLib.pluckNumber,
                n = function (a, b, d) {
                    clearTimeout(d);
    ...
    E.register("module", ["private", "modules.renderer.js-widgets",
        function () {
            function b() {}
            var k = this.hcLib,
                d = k.extend2,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-funnelpyramidbase",
        function () {
            var b = this,
                k = b.hcLib,
                d = k.pluck,
                ...
                n = k.BLANKSTRING,
                L = k.preDefStr,
                D = L.showHoverEffectStr,
                u = k.graphics.convertColor,
                e = k.extend2,
                C = k.parseUnsafeString,
                N = k.graphics.getLightColor,
                J = k.COMMASTRING,
                K = k.ZEROSTRING,
                I = k.getValidValue,
                G = k.parseTooltext,
                ...
                r = k.COMMASPACE,
                y = {},
                W = k.graphics.getDarkColor,
                p = L.colors.c000000,
                ia = L.configStr,
                v = L.animationObjStr,
                l = L.POSITION_START,
                ra = L.POSITION_MIDDLE,
                L = b.window,
                L = /msie/i.test(L.navigator.userAgent) && !L.opera,
                Da = k.regex.hexcode,
                m = "rgba(192,192,192," + (L ? .002 : 1E-6) + ")",
                h = k.regex.dropHash,
                w = k.HASHSTRING,
                q = k.toRaphaelColor,
                z = k.plotEventHandler,
                A = k.regex.startsRGBA,
                x = function (c) {
                    var a = [],
                        t;
                    (function (c) {
            ...
            E.register("component", ["dataset", "FunnelPyramidBase", {
                ...
                init: function (c) {
                    var a = this.utils(this).invokeHookFns,
                        t = this.postInitHook;
                    if (!c) return !1;
                    this.JSONData = c;
                    this.components = {};
                    ...
                    a(t);
                    this.configure()
                }, removeData: function () {}, _configure: function () {
                    var c = this.chart,
                        q = c.components.colorManager,
                        t = c.config,
                        h = t.style,
                        p = this.components,
                        b = this.conf || {},
                        g = this.JSONData.data || [],
                        c = c.jsonData ? c.jsonData.chart : {},
                        l = this.utils(this),
                        f = l.invokeHookFns,
                        l = l.copyProperties,
                        m = k.setLineHeight,
                        t = t.canvasHeight,
                        x = this.configureSpecifics,
                        v = this.preDrawingHook,
                        z = q.getColor("baseFontColor");
                    l(c, b, [
                        ["showlabels", "showLabels", a, 1],
                        ["showvalues", "showValues", a, 1],
                        ["plottooltext", "toolText", d, n],
                        ["enableslicing", "enableSlicing", a, 1],
                        ["plotfillalpha", "plotFillAlpha", a, 100],
                        ["showplotborder", "showPlotBorder", a, 0],
                        ["plotborderalpha", "plotBorderAlpha", a, void 0],
                        ["plotbordercolor", "plotBorderColor",
                            d, void 0
                        ],
                        ["plotborderthickness", "plotBorderThickness", a, 1],
                        ["showshadow", "showShadow", a, 1],
                        ["showhovereffect", D, a, 0],
                        ["hovercapsepchar", "hoverCapSepChar", d, r],
                        ["tooltipsepchar", "tooltipSepChar", d, "$hoverCapSepChar"],
                        ["labelsepchar", "labelSepChar", d, "$tooltipSepChar"],
                        ["showpercentintooltip", "showPercentInToolTip", a, 1],
                        ["showpercentvalues", "showPercentValues", a, 0],
                        [n, "slicingDistance", a, .1 * t],
                        ["slicingdistance", "slicingHeight", a, "$slicingDistance",
                            function (c) {
                        ...
                        [n, "blankSpace", a, 3],
                        ["labeldistance", "labelDistance", a, 50],
                        ["issliced", "isSliced", a, 0],
                        ["is2d", "is2d", a, 0],
                        [n, "blankSpace", a, 3],
                        ["showlabelsatcenter", "showLabelsAtCenter", a, 0],
                        ["smartlinethickness", "connectorWidth", a, 1],
                        ["smartlinealpha", "connectorAlpha", a, 100],
                        ["smartlinecolor", "rawSmartLineColorCode", d,
                            function () {
                                return q.getColor("baseFontColor")
                            }
                        ],
                        ["labelalpha", "labelAlpha", a, 100],
                        ["basefont", "baseFont", d, "Verdana,sans"],
                        ["basefontsize", "baseFontSize", a, 10],
                        ["basefontcolor",
                            "baseFontColor", d, z
                        ],
                        ["labelfontcolor", "labelFontColor", d, "$baseFontColor"],
                        ["showtooltip", "showTooltip", a, 1],
                        ["percentofprevious", "percentOfPrevious", a, 0],
                        ["animationduration", "animationDuration", a, 1,
                            function (c) {
                    ...
                    var c = this.chart,
                        q = c.jsonData.chart,
                        t, h = this.JSONData.data,
                        b = c.components.legend;
                    b.emptyItems();
                    ...
                    var t = this.getPointInContext(),
                        h = this.chart,
                        b = this.conf,
                        p = h.components,
                        g = p.numberFormatter,
                        l = this.chart.linkedItems.smartLabel,
                        p = p.colorManager,
                        f, m = [],
                        x, r, v, z = 0,
                        w, A, y, H, ia, F = 0,
                        B, W, ra, D, S, P, Da = b.showPercentValues,
                        Z = b.labelSepChar,
                        L = h.jsonData.chart,
                        E = b.isSliced,
                        ja, ka, Fa, Ia, ea = {
                    ...
                    var Ca = h.config.PLOT_COLOR_INDEX_START,
                        Ja, Na, xa, ca;
                    ...
                    if (r)
                        for (b.sumValue = z, r = g.dataLabels(z), w = x.length, l.useEllipsesOnOverflow(h.config.useEllipsesWhenOverflow), h = 0; h < w; h += 1) {
                            ...
                            W = S;
                            P = ga;
                            var Ga = k.parsexAxisStyles(f, {}, L, va, ja),
                                Oa;
                            Oa = f;
                            var Ka = {
                    ...
                    var a = this.chart.components.numberFormatter,
                        t, q, b, h, p = {
                            refreshedData: []
                        };
                    ...
                    t = 0;
                    for (q = c.length; t < q; t++) b = c[t], b.vline || (b.cleanValue = h = Math.abs(a.getCleanValue(b.value, !0)), null !== h && (p.hasValidPoint = !0, p.highestValue = p.highestValue || h, p.refreshedData.push(b), p.sumValue += h, p.countPoint += 1, p.highestValue = Math.max(p.highestValue, p.itemValue)));
                    return p
                }, pointHoverOptions: function (c, b) {
                    var t = this.chart,
                        q = a(c.showhovereffect, this.conf.showHoverEffect),
                        h = {
                            enabled: q
                        },
                        p = {},
                        f, t = t.jsonData ? t.jsonData.chart : {};
                    ...
                    var c = this.getPointInContext(),
                        ...
                        t = h.config,
                        b = h.components,
                        q = b.caption.config.height || 0,
                        p = b.subCaption.config.height || 0,
                        f = this.conf,
                        l = f.showTooltip,
                        x = f.slicingDistance,
                        m;
                    m = t.height - (t.marginTop + t.marginBottom);
                    var r = t.width - (t.marginRight + t.marginLeft),
                        v = this.components.data,
                        z, w;
                    z = f.blankSpace;
                    var d = this.LABEL_PLACEMENT_ITERATOR_INDEX_START,
                        c = c.upperRadiusFactor,
                        A, y, G, H, ia, B, u = h.linkedItems.smartLabel,
                        W, e, ra, n, K, k, D;
                    K = 0;
                    var I, C = 0;
                    ...
                    for (u.useEllipsesOnOverflow(t.useEllipsesWhenOverflow); d <
                        x; d += 1) e = v[d], e.legendItemId && S.configureItems(e.legendItemId, {
                        configuration: {
                    ...
                    if (!w)
                        for (d = this.LABEL_PLACEMENT_ITERATOR_INDEX_START, x = v.length; d < x; d += 1) e = v[d], K = e.y, K = e.getModifiedCurrentValue && e.getModifiedCurrentValue(W) || K,
                    ...
                    var h, a, b;
                    if (c && 0 !== c.length)
                        for (h = 0, a = c.length; h < a; h++) b = c[h], b.connector && b.connector.hide(),
                    ...
                    for (w = c.length; d < w; d++)
                        if (A = c[d])
                            if (a.length)
                                for (y = 0, G = a.length; y < G; y++) g = c[d][h][a[y]], f(g, A.point);
                            else g =
                                A, f(g[h], A.point)
                    ...
                    var b = this.conf,
                        ...
                        l = c.labelX,
                        m = c.style || {},
                        x = a(parseInt(m.fontSize, 10), b.baseFontSize),
                        r = b.lineHeight,
                        v = .3 * x,
                        z = .3 * r,
                        d, w = b.connectorEndSwitchHistoryY,
                        A = b.labelDistance,
                        y = b.blankSpace,
                        x = b.streamLinedData;
                    ...
                    var c = this.chart,
                        b = c.graphics,
                        h = this.graphics.plotItems,
                        a = this.labelDrawingConfig,
                        q = b.datalabelsGroup,
                        p = ["fontFamily", "fontSize", "fontWeight",
                            "fontStyle"
                        ],
                        f = {},
                        c = c.components.paper,
                        g = this.conf,
                        l, m, x, r;
                    r = 0;
                    ...
                    var c = this.trackerArgs,
                        b, h;
                    b = 0;
                    for (h = c.length; b < h; b++) this.drawTracker(c[b])
                }, drawTracker: function (c) {
                    var b = this.chart,
                        h = b.components.paper,
                        b = b.graphics.trackerGroup,
                        a, q, f = +new Date,
                        p, g;
                    ...
                    var a = this.conf,
                        ...
                        y = a.isHollow,
                        G = .3 * r.style.fontSize,
                        H = a.yScale,
                        ia = a.blankSpace,
                        W = a.lastRadius,
                        F = x.linkedItems.smartLabel,
                        B, u = 0,
                        e, K, n = c.length - 1,
                        k = !1,
                        D = 0,
                        I, C, S = a.lineHeight,
                        Da = .8 / r.effCanvasHeight,
                        Z = x.config.width - 2,
                        J = a.streamLinedData;
                    B = {
                        flag: !1,
                    ...
                    for (B = c.length; r < B; r++)
                        if (e = c[r]) e.x = r, m[r] && (e.isSliced = m[r].sliced || !!e.isSliced || !!a.isSliced), r ? (h && (k = !k), e.isSliced && (C = e.x, 1 < C && !Ca[C] && (Ca[C] = !0, a.noOfGap += 1), C < n && (Ca[C + 1] = !0, a.noOfGap +=
                    ...
                    var a = this.conf,
                        ...
                        l = b.lLargestLabel,
                        r = b.rLargestLabel,
                        m = h.linkedItems.smartLabel,
                        x = 0,
                        v = a.streamLinedData,
                        d = a.blankSpace,
                        a = q.width - a.blankSpace;
                    if (!f.flag || !g.flag) {
                        if (g.flag) {
                            if (!l.point) return;
                            p = g.sLabel;
                        ...
                        if (p)
                            for (l = 0, r = c.length; l < r; l++) q = c[l], !l && v ? q.labelX += p : (q.alignmentSwitch ? (h = 0 > p ? m.getSmartText(q.oriText, q.pWidth, Number.POSITIVE_INFINITY, !0) : m.getSmartText(q.oriText, q.pWidth + p, Number.POSITIVE_INFINITY, !0), q.isLabelTruncated && (x = h.width - q.pWidth)) : h = 0 < p ? m.getSmartText(q.oriText, q.pWidth, Number.POSITIVE_INFINITY, !0) : m.getSmartText(q.oriText, q.pWidth - p, Number.POSITIVE_INFINITY, !0), q.virtualWidth = h.width, q.displayValue = h.text, q.labelX += p - x, q.shapeArgs && (q.shapeArgs.x +=
                                p), x = 0);
                        else
                            for (m.useEllipsesOnOverflow(q.useEllipsesWhenOverflow), l = 0, r = c.length; l < r; l++) q = c[l], 0 < (x = q.labelX + q.pWidth - a) && (q.lOverflow = x, q.labelX -= x, h.isLegendRight ? q.displayValue = m.getSmartText(q.oriText, q.pWidth - x, Number.POSITIVE_INFINITY, !0).text : (q.lOverflow = x, q.labelX -= x))
                    }
                }, getPlotData: function (c) {
                    var b = this.components.data[c],
                        a = this.userData || (this.userData = []),
                    ...
                    var b = {
                        ...
                        p = function (b, a, h, q, p, g, l, r, m, x, t) {
                            ...
                            if (l) A = {
                                ...
                                for (A in z)
                                    if (isNaN(z[A].x) || isNaN(z[A].y)) z[A].x = "topLeft" === A || "bottomLeft" === A ? -a : a, z[A].y = "bottomRight" === A || "bottomLeft" === A ? p : d;
                                p = z.topLeft;
                                h = z.bottomLeft;
                                A = v + p.x;
                                w = v + z.topRight.x;
                        ...
                        g = function (c, f) {
                            ...
                            if ("string" === typeof c) r = b[c] ? this._3dAttr[c] : this._attr(c);
                            else {
                        ...
                        r = function (c, b, a) {
                            var h = c.chart.get(ia, v),
                                q = h.duration,
                                p = h.dummyObj,
                                f = h.animObj,
                                g = h.animType;
                            return function (h, l, r) {
                                if (h = a[h]) return h.animateWith(p, f, {
                                    path: l
                    ...
                    return function (c, b, h, q, f, d, x,
                        z, v, A, w, y) {
                        var e = this.chart.graphics.datasetGroup,
                            G;
                        ...
                        if (G) {
                            if (q = G._3dAttr, q.isFunnel !== c.isFunnel || q.is2D !==
                                ...
                                for (f = 0, w = h.length; f < w; f++)
                                    if (d = h[f], q = G[d]) delete G[d], q.remove()
                        } else G = void 0;
                        x = G || v.group(x, e);
                        x.toFront();
                        x.Shapeargs = b;
                ...
                utils: function (c) {
                    ...
                    a.prototype.distribute = function (a) {
                        ...
                        if (a) {
                            ...
                            for (d in this.nonDistributedMatrix)
                                for (h = this.nonDistributedMatrix[d], x = 1; x < h.length - 1; x++) v = h[x], v.dontPlot = !0, v.displayValue = n;
                        if (A.length > this.distributionLength && !a) {
                            r.exhaustion = !0;
                            for (d in this.nonDistributedMatrix)
                                for (h = this.nonDistributedMatrix[d], x = 0, a = h.length; x < a; x++) v = h[x], v.dontPlot ? q ? m = l : m = g : (q ? m = p : m = f, m.getEffectiveLength() > parseInt(d, 10) ? v.distributionFactor =
                            ...
                            for (t in this.nonDistributedMatrix)
                                for (h = this.nonDistributedMatrix[t], x = 0, a = h.length; x < a; x++) v = h[x], v.dontPlot ? m = l : (m = p, m.getEffectiveLength() > parseInt(t, 10) ? v.distributionFactor = m.getEffectiveLength() - 1 - t : v.distributionFactor = 0), m.set(z++, v);
                            this.distributedMatrix = p.mergeWith(l)
                        }
                    };
                    ...
                    var g = f.dummyObj,
                        ...
                        f = f.animType,
                        r = p.conf,
                        x = r.slicingDistance / 2,
                        d = 0,
                        A = 0,
                        w = p.graphics.plotItems,
                        y = w.length,
                        e, G, H, W, F;
                    if (!r.sliceLock)
                        ...
                        }, d = 0; d < y; d += 1) c = w[d], c !== a ? G = c.sliced = !1 : (G = !0, H = d), c.graphic && (e = c.dy, e = -e, q && (c.x < a.x ? (e += W, A += 1) : c.x == a.x ? A ? d == y - 1 && (e += .5 * x) : e += .5 * -x : e += x), c.graphic.attr({
                                transform: "t0," + c.dy
                            }), c.dy += e, e = {
                                transform: "...t0," + e
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-funnel",
        function () {
            ...
            E.register("component", ["dataset", "Funnel", {
                ...
                configure: function () {
                    var b = this.chart,
                        a = b.components.numberFormatter,
                        d = this.utils(this).sortObjArrByKey,
                        e = b.jsonData ?
                        b.jsonData.chart : {},
                        b = this.JSONData.data,
                        u, c, F;
                    ...
                    var b = this.chart,
                        a = this.conf,
                        d = b.jsonData ? b.jsonData.chart : {},
                        e = this.utils(this).copyProperties;
                    e(d, a, [
                        ["streamlineddata", "streamLinedData", k, 1],
                        ["funnelyscale", "yScale", k,
                            void 0,
                            function (b) {
                                var c = b.yScale;
                        ...
                        ["usesameslantangle", "useSameSlantAngle", k,
                            function (b) {
                                return b.streamLinedData ? 0 : 1
                            }
                        ],
                        ["ishollow", "isHollow", k, void 0,
                            function (b) {
                    ...
                    b.prototype.getLowestRadiusFactor = function (b) {
                        var d = a.conf,
                            e = d.useSameSlantAngle;
                        return d.streamLinedData ? this.y ? e ? this.y / b : Math.sqrt(this.y / b) : 1 : .2
                    };
                    return b
                }, datasetCalculations: function (b) {
                    var a = this.conf,
                        d = this.chart.components.numberFormatter,
                        e, u, c, F = {},
                        g = a.streamLinedData,
                        H = a.percentOfPrevious;
                    F.highestValue = Number.NEGATIVE_INFINITY;
                    F.refreshedData = [];
                    a = F.sumValue = F.countPoint = 0;
                    for (e = b.length; a < e; a++) u = b[a], u.vline || (u.cleanValue = c = Math.abs(d.getCleanValue(u.value, !0)), null !== c && (F.hasValidPoint = !0, F.highestValue = F.highestValue || c, F.refreshedData.push(u), F.sumValue += c, F.countPoint += 1, F.highestValue = Math.max(F.highestValue, c)));
                    ...
                    var a = this,
                        ...
                        F = a.utils(a),
                        g = a.trackerArgs = [],
                        H = F.getSumValueOfObjArrByKey,
                        B = F.DistributionMatrix,
                        f = a.calculatePositionCoordinate,
                        r = k.marginTop,
                        y = k.marginBottom,
                        F = a.components.data,
                        W, p, ia, v = e.datalabelsGroup,
                        l = c.streamLinedData,
                        ra, D = 2;
                    W = F.length;
                    ...
                    if (c.sumValue && (a.preDrawingSpaceManagement(), a.hide(a.graphics.plotItems), a.rolloverResponseSetter = function (c, a) {
                        ...
                        F.length = 0;
                        if (void 0 === l.matrix[1])[].push.apply(F, l.matrix[0]);
                        else
                            for (h = l.matrix[0], w = l.matrix[1], W = Math.max(h.length, w.length), B = 0; B < W; B++) ra = h[B], q = w[B], F.push(ra ? ra : q);
                    ...
                    var G = this.conf,
                        ...
                        r = this.chart,
                        y = r.graphics.trackerGroup,
                        W = r.components.paper,
                        p = !!a.link,
                        ia = G.distanceAvailed,
                        v = r.components.legend,
                        r = r.get(u, e).duration,
                        l = this.labelDrawingConfig,
                        F = F ? 1 : a.isSliced,
                        B = {
                            text: c,
                            ishot: !0,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-pyramid",
        function () {
            var b = this,
                k = b.hcLib,
                d = k.BLANKSTRING,
                ...
                C = n.POSITION_MIDDLE,
                n = b.window,
                N = /msie/i.test(n.navigator.userAgent) && !n.opera ? .002 : 1E-6,
                J = k.plotEventHandler,
                K = k.schedular,
                I = {
                    right: e,
                    left: u,
            ...
            E.register("component", ["dataset", "Pyramid", {
                ...
                configure: function () {
                    ...
                    var b = this.chart,
                        d = this.conf,
                        e = b.jsonData ? b.jsonData.chart : {},
                        c = this.utils(this).copyProperties;
                    c(e, d, [
                        ["pyramidyscale", "yScale", a, void 0,
                            function (c) {
                                var a = c.yScale;
                ...
                }, preDrawingHook: function () {}, draw: function () {
                    this._configure();
                    var a = this,
                        b = a.chart,
                        d = b.getJobList(),
                        c = b.config,
                        e = a.conf,
                        g = a.utils(a).DistributionMatrix,
                        H = a.trackerArgs = [],
                        u = a.calculatePositionCoordinate,
                        f = c.marginTop,
                        r = c.marginBottom,
                        y = a.components.data,
                        W, p, ia, v = b.graphics.datalabelsGroup,
                        l, n = 2,
                        D = y.length,
                        m, h = m = 0,
                        w = e.lineHeight,
                    ...
                    if (e.sumValue) {
                        ...
                        y.length = 0;
                        if (void 0 === h.matrix[1])[].push.apply(y, h.matrix[0]);
                        else
                            for (w = h.matrix[0], q = h.matrix[1], W = Math.max(w.length, q.length), g = 0; g < W; g++) m = w[g], ia = q[g], y.push(m ? m : ia);
                        switch (h.suggestion) {
                        case l["default"]:
                            u.call(a, y, !1);
                            break;
                    ...
                    var e = this.conf,
                        c = e.is2d,
                        F = e.x,
                        g = this.graphics.plotItems || [],
                        H = this.chart,
                        B = H.config,
                        f = B.canvasTop,
                        r = e.unitHeight,
                        y = e.labelDistance,
                        W = e.showLabelsAtCenter,
                        p = .3 * B.style.fontSize,
                        ia = e.yScale,
                        v = e.blankSpace,
                        l = e.lastRadius,
                        k = H.linkedItems.smartLabel,
                        n, m, h, w = a.length - 1,
                        q = !1,
                        z = 0,
                        A, x, na = e.lineHeight,
                    ...
                    for (n = a.length; B < n; B++)
                        if (m = a[B]) m.x = B, g[B] && (m.isSliced = g[B].sliced ||
                    ...
                    var e = this.conf,
                        ...
                        r = B.graphics.trackerGroup,
                        y, W = B.components.paper,
                        p = !!a.link,
                        ia = e.distanceAvailed;
                    y = a.labelAline;
                    var v = a.appliedStyle,
                        l = a.style,
                        k = B.components.legend,
                        B = B.get(L, D).duration,
                        n = this.labelDrawingConfig,
                        l = v && v.color || l && l.color || this._chartLevelAttr.color,
                        H = H ? 1 : a.isSliced,
                        l = {
                            text: g,
                            ishot: !0,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-hlineargauge",
        function () {
            var b = this,
                k = b.hcLib,
                d = k.pluckNumber,
                ...
                D = k.BLANKSTRING,
                u = k.getValidValue,
                e = k.parseUnsafeString,
                C = k.parseTooltext,
                N = k.graphics.convertColor,
                J = k.POSITION_MIDDLE,
                K = k.preDefStr,
                I = K.configStr,
                G = K.animationObjStr,
                ...
                F = K.POSITION_START,
                K = K.POSITION_END,
                g = k.plotEventHandler,
                H = b.window,
                B = void 0 !== H.document.documentElement.ontouchstart,
                k = Math,
                f = k.max,
                r = k.min,
                y = {
            ...
            E.register("component", ["dataset", "hlineargauge", {
                ...
                init: function (a) {
                    ...
                    var c = this.chart,
                        ...
                        l = g.numberFormatter,
                        g = g.colorManager,
                        r = this.config || (this.config = {}),
                        y = this.components || (this.components = {}),
                        m = (b = b.pointers && b.pointers.pointer) && b.length || 1,
                        h, w, q, z, A, x, H, B, t, pa, k, c = c.config.style,
                        F, G, I, K, J, M, L, E, fa, sa, ha, da, X, ba;
                    ...
                    var c = this.chart,
                        ...
                        f = c.config,
                        l = this.config,
                        g = c.linkedItems.smartLabel,
                        r = f.canvasWidth,
                        m, h = f.dataLabelStyle,
                        e = f.style.trendStyle,
                        q = c.jsonData,
                        z = q.trendpoints && q.trendpoints.point,
                        A = d(parseInt(h.lineHeight, 10), 12),
                        q = l.valuePadding,
                        x = l.valueInsideGauge,
                        y, H = y = 0,
                        t = 0,
                        u = 0,
                        B = 0,
                        k = 0,
                        n = 0,
                        F = c.components.scale.config.spaceTaken,
                        C = 0,
                    ...
                    var f =
                        ...
                        q = e.paper,
                        z = e.scale,
                        A = f.pointerArr && f.pointerArr.pointer,
                        e = y.canvasWidth,
                        y = y.canvasHeight,
                        x = f.config,
                        y = x.pointerOnOpp ? y : 0,
                        u = x.showPointerShadow,
                        k = x.showTooltip,
                        t = z.config.axisRange.min,
                        n = z.config.axisRange.max,
                        F = (n - t) / e,
                        A = A && A.length || 1,
                        C, K, Q, J;
                    C = z.config.prevAxisMinMax || (z.config.prevAxisMinMax = {});
                    var N = f.components.data,
                        M = l.get(I, G),
                        L = M.animObj,
                        Z = M.dummyObj,
                        fa = M.animType,
                        ...
                        X = function (a, c) {
                            var b = c[2],
                                ...
                                p = q.min,
                                q = q.max,
                                g = d(this.itemValue, p),
                                r = g - (this.dragStartX - b) * F,
                                l = 0,
                                m = [],
                                x = [];
                            if (!1 !== this.editMode) {
                    ...
                    w || (w = m.tempGroup = q.group("tempGroup",
                        h).trackTooltip(!0));
                    m = function (a) {
                        var c = this.data("eventArgs").index,
                            c = N[c].config;
                    ...
                    var a = this.removeDataArr,
                        c = a.length,
                        b, f, r, g, d = this.pool || (this.pool = {
                            pointer: [],
                            pointerValue: []
                        });
                    ...
                    var f = this.chart,
                        ...
                        e = g.scale,
                        H = g.paper,
                        m = f.graphics.datalabelsGroup,
                        h = e.config.axisRange.min,
                        w = e.config.axisRange.max,
                        q = this.config,
                        e = q.textDirection,
                        z = g.colorRange && g.colorRange.getColorRangeArr(h, w),
                        g = q.colorRangeStyle || {},
                        A = q.showvalue,
                        x, u = f.jsonData.trendpoints && f.jsonData.trendpoints.point,
                        B = r.trendPointConfig,
                        t = r.canvasWidth,
                        k = r.canvasHeight,
                        n = r.marginRight,
                        F = q.pointerOnOpp;
                    x = q.valueInsideGauge;
                    var C = q.showGaugeLabels,
                        K = r.dataLabelStyle,
                        J = f.get(I, G),
                        L = J.animObj,
                        M = J.dummyObj,
                        ...
                        fa, E, ha, da, X, ba, U, V;
                    U = !1;
                    var f = f.linkedItems.smartLabel,
                        aa, la, oa = d(parseInt(K.fontHeight, 10), parseInt(K.lineHeight, 10), 12),
                        O = q.currentValuePadding + .5 * oa,
                        J = q.currentTrendPadding + .5 * oa,
                        P, q = q.currentTrendPadding;
                    ha = {
                    ...
                    var Y = this.pointerArr && this.pointerArr.pointer,
                        T, K = this.components,
                        qa = K.data,
                        wa = K.dataLabels || (K.dataLabels = []),
                        ja = K.trendLabels || (K.trendLabels = []);
                    ...
                    f.setStyle(g);
                    if (z && C)
                        for (r = 0, b = z.length; r < b; r += 1) A = wa[r] || (K.dataLabels[r] = {}), A = A.graphics || (A.graphics = {}), x = z[r], F = a(x.label, x.name), X = da(x.minvalue, x.maxvalue), aa = X.width - 4 > la && X.height - 4 > oa ? f.getSmartText(F, X.width - 4, X.height - 4) : f.getSmartText(F, X.width, X.height), F = {
                                "text-anchor": c,
                                "vertical-align": c,
                                x: X.x,
                                y: X.y,
                    ...
                    var c = this.chart,
                        b = c.graphics.datalabelsGroup,
                        f = c.components.paper,
                        r = this.components.data,
                        g = this.config,
                        d = g.pointerOnOpp,
                        m = g.valueInsideGauge,
                        g = g.textDirection,
                        h, e = c.linkedItems.smartLabel,
                        q = this.pointerArr && this.pointerArr.pointer,
                        z = c.config.dataLabelStyle,
                        q = q && q.length,
                        A, x = c.get(I, G),
                        H = x.animObj,
                        u = x.dummyObj,
                    ...
                    var f = this.chart,
                        r = f.components.numberFormatter,
                        g = this.components.data,
                        d, m = this.components.data,
                        m = m && m.length || 0,
                        h, y, q = null,
                        z = [],
                        A, x, H;
                    ...
                    if (m) {
                        for (; m--;)
                            if (h = {}, H = {}, y = g[m].config, d = a[m]) A = d.value, f = d.tooltext, c = d.label, d = d.showlabel, void 0 !== A && A !== D ? (h.value = H.value = A, q = H.displayvalue = H.tooltext = r.dataLabels(H.value), H.hasNewData = !0) : H.value = y.formatedVal, c && (H.displayvalue = c, H.hasNewData = !0), "0" == d && (H.displayvalue = D, H.hasNewData = !0), f && (f = u(e(f)), H.hasNewData = !0), H.hasNewData && (z[m] = H, L(y, {
                                itemValue: H.value,
                                displayValue: "0" !== d ? H.displayvalue || D : D,
                                toolText: void 0 !== f ? C(f, [1, 2], {
                                    formattedValue: q
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-bullet",
        function () {
            var b = this.hcLib,
                k = b.preDefStr,
                d = b.BLANKSTRING,
                ...
                n = b.getValidValue,
                L = b.COMMASTRING,
                D = b.plotEventHandler,
                u = k.showHoverEffectStr,
                e =
                k.configStr,
                C = k.animationObjStr,
                N = b.getColorCodeString,
                J = k.ROUND,
                K = k.miterStr,
                I = b.HUNDREDSTRING,
                G = Math,
                ...
                B = b.COMMASPACE,
                f = b.getFirstValue,
                r = b.graphics.getDarkColor,
                y = this.window,
                G = void 0 !== y.document.documentElement.ontouchstart,
                ...
                v = k.POSITION_START,
                l = k.POSITION_TOP,
                ra = k.POSITION_MIDDLE,
                Da = k.PLOTFILLCOLOR_STR,
                k = b.TOUCH_THRESHOLD_PIXELS,
                m = G ? k : W,
                h = b.pluckNumber,
                w = b.schedular;
            E.register("component", ["dataset", "bullet", {
                init: function (a) {
                    ...
                    var c = this.chart,
                        ...
                        r = this.JSONData,
                        d = c.jsonData.chart,
                        l = c.components.colorManager,
                        m, p = f.plotColor = l.getColor(Da),
                        e = h(r.dashed, d.plotborderdashed);
                    h(d.useplotgradientcolor, 1);
                    var v, y, w, H = b.getDashStyle,
                    ...
                    var l = this.chart,
                        ...
                        e = c || p.data,
                        v = e && e.length,
                        t = l.config.categories,
                        t = t && t.length,
                        v = c && c.data.length || S(t, v),
                        y = l.jsonData.chart,
                        t = l.components.colorManager,
                        w = m.showplotborder,
                        u = m.showPlotBorderOnHover,
                        k = m.plotColor,
                        F = b.parseUnsafeString,
                        C = F(a(y.tooltipsepchar, B)),
                        W = h(y.seriesnameintooltip,
                            1),
                        D = b.parseTooltext,
                        G, I, ia, K, ra, J, N = m.plotBorderThickness,
                        L = m.isRoundEdges,
                        U = m.showHoverEffect,
                        V = m.plotFillAngle,
                        Da, E = m.plotBorderAlpha,
                        oa, O = m.plotBorderDashStyle,
                        P, Y, T, qa, wa, ja, ka, Fa, Ia, ea, va, ga, Ha = b.getDashStyle,
                        Ca = this.components.data,
                        Ja = l.isBar,
                        Na = l.is3D,
                        xa = -Infinity,
                        ca = Infinity,
                        Ga = l.components.numberFormatter,
                        Oa = function (a) {
                    ...
                    for (l = 0; l < v; l++) P = c ? c && c.data[l] : e[l], T = (k = Ca[l]) && k.config, k || (k = Ca[l] = {}), k.config || (T = Ca[l].config = {}), T.showValue = h(P.showvalue, m.showValues), T.valuePadding = h(y.valuepadding, 2), T.setValue = Y = Ga.getCleanValue(P.value), T.target = k = Ga.getCleanValue(P.target), T.setLink = a(P.link), T.toolTipValue = oa = Ga.dataLabels(Y), T.toolTipValueTarget = Ga.dataLabels(k), T.setDisplayValue = qa = F(P.displayvalue), T.displayValue =
                        a(P.label, qa, oa), oa = h(P.dashed), qa = h(P.dashlen, void 0), wa = J = h(P.dashgap, J), xa = Z(xa, Y, k), ca = S(ca, Y, k), T.plotBorderDashStyle = oa = 1 === oa ? Ha(qa, wa, N) : 0 === oa ? "none" : O, k = a(P.color, m.plotColor), Da = a(P.alpha, m.plotFillAlpha), 0 > Y && !L && (ra = V, V = Ja ? 180 - V : 360 - V), T.colorArr = Y = b.graphics.getColumnColor(k, Da, void 0, V, L, m.plotBorderColor, E.toString(), Ja ? 1 : 0, Na ? !0 : !1), 0 !== U && (qa = a(P.hovercolor, p.hovercolor, y.plotfillhovercolor, y.columnhovercolor, k), wa = a(P.hoveralpha, p.hoveralpha, y.plotfillhoveralpha, y.columnhoveralpha,
                            ...
                            fill: Na ? [H(qa[0]), !m.use3DLighting] : H(qa[0]),
                            stroke: H(qa[1]),
                    ...
                    var c = this.config,
                        ...
                        f = this.chart,
                        r = f.components.caption.config,
                        g = f.config,
                        f = f.linkedItems.smartLabel,
                        m = g.dataLabelStyle,
                    ...
                    for (f.setStyle(m); 1 > y; y += 1) c.showValue && (g = f.getOriSize(b.toolTipValue), b.toolTipValue === d && (g = {
                        height: l
                    ...
                    var c = this.config,
                        ...
                        f = f.linkedItems.smartLabel,
                        g = r.dataLabelStyle,
                        m = h(parseInt(g.lineHeight, 10), 12),
                        l = c.valuePadding,
                        p = 0,
                        e = 0,
                        b = (b = b[e]) &&
                        b.config;
                    f.useEllipsesOnOverflow(r.useEllipsesWhenOverflow);
                    for (f.setStyle(g); 1 > e; e += 1) b && b.displayValue !== d && void 0 !== b.displayValue && c.showValue && (r = f.getOriSize(b.displayValue), b.displayValue === d && (r = {
                        height: m
                    ...
                    var f = this.config,
                        ...
                        d = f.prevMin,
                        r = this.chart,
                        g = this.groupManager || this,
                        m = r.components.scale;
                    this._setConfigure(a, c);
                    this.setMaxMin();
                    if (f.maxValue !== h || f.minValue !== d) this.maxminFlag = !0;
                    ...
                    var c = this.chart,
                        ...
                        J = ia.dummyObj,
                        ia = ia.duration,
                        Da, V, E = c.components.colorManager,
                        S, oa, O, P, Y, T, qa, wa;
                    Da = I ? 270 : 180;
                    ...
                    y = f && f.length;
                    if (l)
                        for (p = l.colorRangeElems.length; p > y; --p) l.colorRangeElems[p - 1].hide(), l.colorRangeElems[p - 1].shadow({
                            opacity: 0
                        });
                    else p.canvasElement = l = {}, l.colorRangeElems = [];
                    ...
                    var f = this,
                        h = f.JSONData,
                        r = f.chart.jsonData.chart,
                        g = f.config,
                        y = f.chart.config.categories,
                        k = h.data,
                        t = y && y.length,
                        B = k && k.length,
                        n, F, y = f.visible,
                        ...
                        Da = I.canvasHeight,
                        E = I.canvasWidth,
                        Z = W.components.paper,
                        da = W.components.scale,
                        X = W.graphics.datasetGroup,
                        ba, U, V, aa = W.graphics,
                        la = b.parseUnsafeString,
                        oa = b.getValidValue,
                        O = b.Raphael,
                        P = g.showTooltip,
                        Y = W.get(e, C),
                            ...
                            if (null !== ea) {
                                if (B.graphics.element ?
                                    (B.graphics.element.show(), F = {
                                        ...
                                        opacity: Na
                                    }, La).data("BBox", V), va || P) ka < m && (U -= (m - ka) / 2, ka = m), Xa.attr = {
                                    x: ba,
                                    y: U,
                                    width: ja,
                                    height: ka,
                    ...
                    var a =
                        ...
                        c = this.components,
                        b = c.pool,
                        f = a.config.plothovereffect,
                        h = a.components.paper,
                        d = this.graphics.trackerContainer,
                        r, g, l, p, m, e, y = function (c) {
                            D.call(this, a, c)
                        },
                        v = function (c) {
                            return function (b) {
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-led",
        function () {
            var b = this.hcLib,
                ...
                a = b.pluckNumber,
                n = b.plotEventHandler,
                L = b.getColorCodeString,
                D = b.graphics.getDarkColor,
                u = b.graphics.getLightColor,
                e = b.graphics.convertColor,
                C = b.preDefStr,
                N = C.colors.c000000,
                J = C.configStr,
                K = C.animationObjStr,
                I = C.showHoverEffectStr,
                G = C.POSITION_MIDDLE,
                Z = b.COMMASTRING,
                C = this.window,
            ...
            E.register("component", ["dataset", "led", {
                init: function (c) {
                    ...
                    var r = this.chart,
                        ...
                        A = Da.canvasElement,
                        x = Da.canvasElementPath,
                        na = Da.canvasHotElement,
                        ta = C.canvasLeft,
                        t = C.canvasRight,
                        pa = C.canvasTop,
                        ma = C.canvasBottom,
                        ...
                        ya = Q.getLimit().min,
                        ua = Q.getLimit().max,
                        M = a(r.jsonData.chart.reverseaxis, r.isAxisReverse),
                        Ba = r.isHorizontal,
                        za = function (a, c) {
                            if (M && !Ba) return {
                                x: ta,
                        ...
                        fa, sa, ha, da = r.components.colorManager,
                        X, ba, U, V, aa, la, oa, O, P, Y, T, qa, wa, ja, ka, Fa, Ia, ea, va, ga, Ha, Ca, Ja;
                    V = r.components.numberFormatter;
                    var Na, xa, ca, Ga = y.showHoverEffect,
                        Oa = function (a) {
                            n.call(this, r, a)
                        },
                        Ka = function (a) {
                            ...
                            return function () {
                                h = this;
                                if (0 !== h.data(I))
                                    for (c = 0, b = a.length; c < b; c += 1) f = a[c], f.attr(h.data("setRolloverAttr")[c])
                            }
                        },
                        Ea = function (a) {
                            var c = 0,
                            ...
                            return function () {
                                h = this;
                                if (0 !== h.data(I))
                                    for (c = 0, b = a.length; c < b; c += 1) f = a[c], f.attr(h.data("setRolloutAttr")[c])
                            }
                        },
                        La = [],
                        Ma = [],
                        Qa = this.graphics.trackerContainer,
                        Q = r.graphics.trackerGroup,
                        Ra = 0,
                        Sa, Pa, Wa = !1;
                    ...
                    if (ha &&
                        0 === ha.length)
                        for (V = 0, aa = A.colorRangeElems.length; V < aa; V++) A.colorRangeElems[V].hide();
                    Ja = {
                        link: p,
                        value: xa
                    };
                    ...
                    var b = this.config,
                        ...
                        l = g.canvasHeight,
                        H = g.canvasWidth,
                        u = d.components.paper,
                        m = d.graphics.datasetGroup,
                        h = this.graphics.container,
                        w, q = d.components.numberFormatter,
                        z = a(this.chart.jsonData.chart.reverseaxis, d.isaxisreverse),
                        A = d.isHorizontal,
                        x = d.get(J, K),
                        n = x.animType,
                        F = x.animObj,
                        ...
                        C = f.graphics,
                        D = f && f.config,
                        I = this.graphics.dataLabelContainer,
                        N = d.graphics.datalabelsGroup,
                        Q = d.config.dataLabelStyle,
                        C = b.heightUsed,
                        L = b.initAnimation,
                        E;
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-thermometer",
        function () {
            var b = this.hcLib,
                k = b.pluckNumber,
                d = b.pluck,
                ...
                L = b.getValidValue,
                D = b.parseTooltext,
                u = b.graphics.convertColor,
                e = b.HUNDREDSTRING,
                C = b.graphics.getDarkColor,
                ...
                G = J.POSITION_TOP,
                Z = J.POSITION_MIDDLE,
                S = J.gaugeFillColorStr,
                c = J.gaugeBorderColorStr,
                F = b.plotEventHandler,
                g = b.toRaphaelColor,
                b = this.window,
            ...
            E.register("component", ["dataset", "thermometer", {
                init: function (a) {
                        ...
                        var b = this.config,
                            g = this.chart,
                            e = g.jsonData.chart,
                            g = g.components.numberFormatter,
                            p = a.value;
                        ...
                        var b = this.chart,
                            f = b.jsonData,
                            g = f.chart,
                            y = this.config || (this.config = {}),
                            H = b.components.colorManager,
                            p = b.config,
                            n, v = k(g.showhovereffect),
                            l;
                        ...
                        var a = this.config,
                            c = this.chart,
                            b = c.get("linkedItems", "smartLabel");
                        ...
                        var c =
                            this.config,
                            b = this.chart,
                            d = b.graphics.datalabelsGroup,
                            e = b.get("graphics", "trackerGroup"),
                            n = this.graphics || (this.graphics = {}),
                            p = b.get("components", "scale"),
                            D = b.get("graphics", "datasetGroup"),
                            v = b.get(K),
                            l = b.get("components", "paper"),
                            ra = v.canvasLeft,
                            J = v.canvasTop,
                            m = v.canvasHeight,
                            h = v.effectiveR || 10,
                            ...
                            za = parseInt(z - .6 * w,
                                10),
                            w = z + w / 2,
                            fa = ta - Math.abs(Math.sqrt(S * S - E * E)),
                            sa = n.container,
                            ha = n.fluid,
                            da = n.topLightGlow,
                            X = n.topLight,
                            ba = n.label,
                            U = n.dataLabelContainer,
                            ba = n.canvasBorderElement,
                            E = n.bulbBorderLight,
                            V = n.bulbTopLight,
                            aa = n.bulbCenterLight,
                            la = n.trackerContainer,
                            oa = n.cylLeftLight,
                            O = n.cylRightLight,
                            P = n.cylLeftLight1,
                            Y = n.cylRightLight1,
                            la = n.hotElement,
                            T = C(c.gaugeFillColor, q ? 70 : 80),
                            qa = c.gaugeFillAlpha,
                            wa = c.gaugeContainerColor,
                            ja = C(wa, 80),
                            wa = N(wa, 80),
                            ka = c.gaugeBorderThickness,
                            Fa = c.gaugeBorderColor,
                            Ia = c.showHoverEffect,
                            ea =
                            c.plotFillHoverAlpha,
                            va = c.plotFillHoverColor,
                            ga = b.get(K, I),
                            Ha = ga.animType,
                            Ca = ga.animObj,
                            Ja = ga.dummyObj,
                    ...
                    }, addData: function () {}, removeData: function () {}
            }])
        }
    ]);
    E.register("module", ["private", "modules.renderer.js-dataset-cylinder",
        function () {
            var b = this.hcLib,
                k = b.preDefStr,
                d = b.COMMASTRING,
                a = b.plotEventHandler,
                n = k.configStr,
                L = k.animationObjStr,
                D = Math,
                u = D.max,
                e = D.min,
                C = b.graphics.convertColor,
                N = b.toRaphaelColor,
                J = b.graphics.getDarkColor,
                D = this.window,
                K = "rgba(192,192,192," + (/msie/i.test(D.navigator.userAgent) && !D.opera ? .002 : 1E-6) + ")",
                I = k.POSITION_TOP,
                G = k.POSITION_MIDDLE,
                Z = b.pluckNumber,
                S = b.graphics.getLightColor;
            E.register("component", ["dataset", "cylinder", {
                _manageSpace: function () {
                    ...
                    var c = this.config,
                        ...
                        m = g.btnBorder,
                        h = g.label,
                        w = g.dataLabelContainer,
                        h = g.trackerContainer,
                        h = g.hotElement,
                        q = b.components,
                        z = q.scale,
                        A = b.config,
                        ...
                        ta = A.canvasHeight,
                        t = A.effectiveR || 40,
                        pa = Z(c.value, z.getLimit().min),
                        ma = z.getPixel(pa),
                        z = x + t,
                        pa = b.config.dataLabelStyle,
                        R = c.gaugeFillColor,
                        Aa = J(R, 70),
                        Q = S(R, 70),
                        ya = J(Aa, 90),
                        ua = A.gaugeFillAlpha,
                        M = c.gaugeContainerColor,
                        R = J(M, 80),
                        Ba = J(M, 90),
                        za = S(M, 80),
                        fa = g.container,
                        ...
                        T = z - Y,
                        qa = z + Y,
                        Y = Math.sqrt((1 - Y * Y / (t * t)) * M * M),
                        wa = na + Y,
                        ja = ha + Y,
                        Y = na - 1,
                        ka = A.use3DLighting,
                        Fa = c.showHoverEffect,
                        Ia = c.plotFillHoverAlpha,
                        ea = c.plotFillHoverColor,
                        va = b.get(n, L),
                        ga = va.animType,
                        Ha = va.animObj,
                        Ca = va.dummyObj,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-angulargauge",
        function () {
            var b = this,
                k = b.hcLib,
                d = k.Raphael,
                ...
                y = k.toRaphaelColor,
                W =
                void 0 !== g.document.documentElement.ontouchstart,
                p = k.getPosition,
                ia = k.plotEventHandler,
                v = function (a) {
                ...
                Da = function () {
                    return function (a, c, b) {
                        ...
                        if ("string" === typeof a || void 0 === a) g = "angle" == a ? g._Attr[a] : g._attr(a);
                        else
                            for (f in a) c = a[f], "angle" === f ? (l[f] = c, y = c * r, l.tooltipPos[0] = l.cx + l.toolTipRadius * Math.cos(y), l.tooltipPos[1] =
            ...
            E.register("component", ["dataset", "angulargauge", {
                ...
                init: function () {
                    ...
                    var b = this.chart,
                        ...
                        H = g.scale,
                        g = g.colorManager,
                        F = this.config || (this.config = {}),
                        t = u(d.gaugescaleangle, 180),
                        B = u(d.gaugestartangle),
                        I = u(d.gaugeendangle),
                        W = v(B),
                        K = e ? .001 : .01,
                        ia = v(I),
                    ...
                    var d = this,
                        ...
                        U = M - ua,
                        V = ba / U,
                        aa, la = u(A.showhovereffect),
                        oa = d.showValue = u(A.showvalue, A.showrealtimevalue, 0),
                        O = 0,
                        ...
                        T = k.scaleFactor,
                        qa = u(parseInt(P.lineHeight, 10), 12),
                        wa = C.valueBelowPivot,
                        ja = l.get(K,
                            I),
                        ka = ja.duration,
                        Fa = ja.dummyObj,
                        ...
                        ga = 0,
                        Ha, Ca, Ja, Na = {},
                        xa = S.config.prevAxisMinMax || (S.config.prevAxisMinMax = {}),
                        ca, Ga, Oa, Ka, Ea, La, Ma, Qa, Ra = x && x.length,
                        Sa, Pa, Wa, Ta = {
                            pageX: 0,
                            pageY: 0
                        },
                        ...
                        Ya, cb = function (a, c) {
                            ...
                            if (b.editMode) {
                                ...
                                var h = [Q, ya],
                                    f = B(d - h[1] - Ya.top, f - h[0] - Ya.left);
                    ...
                    O = ga;
                    for (Ra = G.pointersPath.length; O < Ra; O += 1) G.pointersPath[O].attr({
                        path: ["M", 0, 0]
                    ...
                    O =
                        va;
                    for (Ra = G.dataLabel.length; O < Ra; O += 1) G.dataLabel[O].attr({
                        text: a,
                        "text-bound": []
                    })
                    ...
                    var b = this.chart,
                        f = this.components.data,
                        d, g, l = (g = this.components.data) && g.length || 0,
                        p, r;
                    a = a.data;
                    if (l) {
                        for (; l--;)
                            if (d = a[l]) r = d.animation || b.get(K, I), p = d.value, g = d.tooltext, d = d.label, f[l].value = u(p, f[l].value, 0), f[l].tooltext = n(g, f[l].value), f[l].displayvalue = d;
    ...
    E.register("module", ["private",
        "modules.renderer.js-dataset-bulb",
        function () {
            var b = this.hcLib,
                k = b.pluckNumber,
                d = b.pluck,
                ...
                e = b.schedular,
                C = b.getValidValue,
                N = b.graphics.convertColor,
                J = b.graphics.getDarkColor,
                K = b.graphics.getLightColor,
                I = b.preDefStr,
                G = b.parseConfiguration,
                Z = b.parseUnsafeString,
                S = I.configStr,
                c = I.animationObjStr,
                F = I.POSITION_TOP,
                g = I.POSITION_MIDDLE,
                H = I.showHoverEffectStr,
                B = I.visibleStr,
                f = I.ROUND,
                r = b.plotEventHandler,
                y = Math.min,
                I = this.window,
            ...
            E.register("component", ["dataset", "bulb", {
                    ...
                    _manageSpace: function (a) {
                            var c = this.config,
                                ...
                                f = this.chart,
                                d = f.config,
                                g = f.linkedItems.smartLabel,
                                r = d.dataLabelStyle,
                                f = k(parseInt(r.lineHeight, 10), 12),
                                h = d.valuepadding,
                                e = 0,
                                b = (b = b[0]) && b.config;
                            ...
                            var f = this.chart,
                                ...
                                m = c && c.data.length || m,
                                h = f.jsonData.chart,
                                y = f.components.colorManager,
                                q = k(h.showtooltip, 1),
                                H = b.parseUnsafeString;
                            H(d(h.tooltipsepchar,
                                n));
                            var F = b.parseTooltext,
                                x, B, G = l.showhovereffect,
                                t = this.components.data,
                                D, I, W, L = k(h.is3d, 1),
                                E, Z = f.components.numberFormatter,
                                S, M, Ba, za, fa, sa, ha, da, X, ba, U, V, aa, la, oa, O = function (c, b, f) {
                                    return f ? {
                                        FCcolor: {
                                            cx: .4,
                                            cy: .4,
                            ...
                            for (E = 0; E < m; E++) D = c ? c && c.data[E] : e[E], I = (x = t[E]) && x.config, x || (x = t[E] = {}), x.config || (I = t[E].config = {}), I.setValue = x = Z.getCleanValue(D.value) || 0, x = Z.dataLabels(x),
                                W = C(H(D.displayvalue)), I.colorRangeGetter = S = f.components.colorRange, M = S.getColorObj(I.setValue), M = M.colorObj || M.prevObj || M.nextObj, Ba = k(h.gaugefillalpha, M.alpha, 100), S = H(d(M.label, M.name)), B = d(M.bordercolor, h.gaugebordercolor, J(M.code, 70)), za = k(M.borderalpha, h.gaugeborderalpha, "90") * Ba / 100, B = (fa = /\{/.test(B)) ? y.parseColorMix(d(M.bordercolor, M.code), B)[0] : B, I.gaugeBorderColor = ha = N(B, za), I.gaugeBorderThickness = da = l.showgaugeborder ? k(h.gaugeborderthickness, 1) : 0, I.fillColor = sa = O(M.code, Ba, L), 0 !== G && (G ||
                                    ...
                                    formattedValue: x
                                }, D, h) : g.useColorNameAsValue ? S : null === x ? !1 : x : !1, D = void 0 !== W ? W : D.label || (g.useColorNameAsValue ? S : x), I.toolText = B, I.displayValue = D, I.rolloverProperties = {
                                    enabled: G,
                                    hoverAttr: U,
                            ...
                            var a = this.components.data,
                                ...
                                C = w.canvasHeight,
                                x = w.canvasWidth,
                                G = d.components.paper,
                                D = d.graphics.datasetGroup,
                                t = this.graphics.container,
                                I = this.graphics.trackerContainer,
                                K = d.graphics,
                                J = K.trackerGroup,
                                E, N = a[0],
                                a = N && N.config,
                                Z = w.gaugeoriginx;
                            E = w.gaugeoriginy;
                            var ua = w.gaugeradius,
                                M = w.hasgaugeoriginx,
                                Ba = w.hasgaugeoriginy,
                                za = w.hasgaugeradius,
                                fa = this.graphics.dataLabelContainer,
                            ...
                            var a = this.chart,
                                c = a.config.plothovereffect,
                                b = a.components.paper,
                                f = this.graphics.trackerContainer,
                                d, g, e, h, y, q = function (c) {
                                    r.call(this, a, c)
                                },
                                n = function (c) {
                                    return function (b) {
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-progressgauge",
        function () {
            var b = this.hcLib,
                k = b.BLANKSTRING,
                d = b.pluck,
                ...
                e = this.window,
                I = "rgba(192,192,192," + (/msie/i.test(e.navigator.userAgent) && !e.opera ? .002 : 1E-6) + ")",
                e = Math,
                G = e.max,
                Z = e.min,
                S = b.regex.dropHash,
            ...
            E.register("component", ["dataset", "progressgauge", {
                ...
                configure: function () {
                    var a = this.chart,
                        ...
                        H = a.config,
                        p = a.jsonData.chart,
                        k = a.components.colorManager,
                        v, l = c.plotColor = k.getPlotColor(this.index || this.positionIndex),
                        u = n(e.dashed, p.plotborderdashed);
                    n(p.useplotgradientcolor, 1);
                    var F, m, h, w = b.getDashStyle,
                        q = a.isBar,
                        B = a.is3D,
                        D = a.isStacked,
                        x = {},
                        x = x.dataObj || (x.dataObj = {}),
                        x = x.chart || (x.chart = {});
                    ...
                    var e = this.chart,
                        ...
                        C = c || p.data,
                        v = C && C.length,
                        l = e.config.categories,
                        I = e.singleseries,
                        l = l && l.length,
                        v = c && c.data.length || Z(l, v),
                        l = e.jsonData.chart,
                        K = e.components.colorManager,
                        m = u.showPlotBorder,
                        h = u.plotColor = K.getPlotColor(this.index || this.positionIndex),
                        w = n(l.showtooltip, 1),
                        q = b.parseUnsafeString,
                        z = q(l.yaxisname),
                        A = q(l.xaxisname),
                        x = q(d(l.tooltipsepchar, H)),
                        J = n(l.seriesnameintooltip, 1),
                        E = b.parseTooltext,
                        t, N, S, R, Aa, Q, ya, ua = u.plotBorderThickness,
                        M = u.isRoundEdges,
                        Ba = u.showHoverEffect,
                        za = u.plotFillAngle,
                        fa, sa, ha, da = u.plotBorderDashStyle,
                        X, ba, U, V, aa, la, oa, O, P, Y = b.getDashStyle,
                        T = this.components.data,
                        qa = e.isBar,
                        wa = e.is3D,
                        ja, ka = u.maxValue || -Infinity,
                        Fa = u.minValue || Infinity,
                        Ia = this.chart.components.numberFormatter,
                        ea;
                    T || (T = this.components.data = []);
                    ...
                    var a = this.chart,
                        b = a.jsonData.chart,
                        d = this.JSONData.data,
                        g, e, u, v = this.components.data,
                        l;
                    ...
                    var b =
                        a.components.data[c.configuration.index],
                        d = a.config,
                        g = b.graphics,
                        e = b.config.visible,
                        v = this.config,
                    ...
                    var c = this,
                        b = c.JSONData,
                        g = c.config,
                        e = c.chart.jsonData.chart,
                        p = c.components.data,
                        n = c.components.data,
                        v = c.chart,
                        l = v.components.paper,
                        H = v.config,
                        B = H.canvasLeft,
                        m = H.canvasTop,
                        h = H.canvasHeight,
                        w = H.canvasWidth,
                        q = v.graphics.datasetGroup,
                        H = c.graphics.gaugeBackgroundContainer,
                        C = c.graphics.gaugeMeterContainer,
                        D = c.graphics.trackerContainer,
                        x = v.graphics.trackerGroup,
                        G = c.components.data.length || 0,
                        E, t, L, S, R, Aa, Q, ya, ua, M, Ba, za = g.animation.duration,
                        fa = g.transposeAnimation,
                        g = g.transposeAnimDuration;
                    Aa = 0;
                    var sa = function () {
                        var a = c.components.data,
                            b, d = c.components.data.length,
                            g;
                    ...
                    m += .5 * h;
                    for (E = 0; E < G; E++)
                        if (t = p[E], L = (q = n[E]) && q.config, (w = L.visible) || za) q.graphics || (n[E].graphics = {}), S = L.setValue, h = L.setLink, t = a(K(d(t.tooltext, b.plottooltext, e.plottooltext))), t = L.toolText + (t ? k : L.toolTipValue), R = L.colorArr, Ba = E, M = {
                                index: E,
                                link: h,
                                value: S,
                    ...
                    var d = this.components,
                        g =
                        d.data,
                        e = d.removeDataArr || (d.removeDataArr = []),
                        n = this.config,
                        l = this.maxminFlag;
                    c = c || 1;
                    a = a || 0;
                    if (a + c === g.length) this.endPosition = !0;
                    else if (0 === a || void 0 === a) this.endPosition = !1;
    ...
    E.register("module", ["private", "modules.renderer.js-realtimecolumn",
        function () {
            var b = this,
                k = b.hcLib,
                d = !k.CREDIT_REGEX.test(b.window.location.hostname),
                a = k.BLANKSTRING,
                n = k.COMMASPACE,
                E = Math.max,
                D = k.regex.dropHash,
                u = k.HASHSTRING,
                e = k.graphics.convertColor,
                C = k.preDefStr,
                N = C.animationObjStr,
                J = C.visibleStr,
                K = C.configStr,
            ...
            C("realtimecolumn", {
                ...
                _realTimeConfigure: function () {
                    var c = this.config,
                        b = c.animationObj,
                        c = c.realTimeConfig || (c.realTimeConfig = {}),
                        d, e, k, f;
                    d = this.jsonData;
                    var r = d.chart;
                    ...
                    var a = this.components.xAxis[0],
                        b = [],
                        d = this.config.realTimeConfig,
                    ...
                    var b = this.components,
                        d = this.linkedItems.smartLabel,
                        n;
                    n = this.config;
                    var u = n.realTimeConfig || (n.realTimeConfig = {}),
                        f = u.realTimeValuePadding,
                        b = b.xAxis[0].config,
                        r = b.trend.trendStyle,
                        b = u.style = {
                    ...
                    var c = this.components,
                        ...
                        m = b.canvasRight,
                        h = f.style || {},
                        c = c.realTimeValue || (c.realTimeValue = {}),
                        w = c.graphics,
                        q = this.graphics,
                        z = q.parentGroup,
                        A = q.realTimeValueGroup,
                        x;
                    ...
                    if (b) {
                        ...
                        for (e = 0; e < r; e++)
                            for (k = f[e] = [], k[0] = a.getLabel(e).label, n = 1; n <= d; n++) u = b[n - 1].components.data[e], k[n] = u && u.config.setValue;
                        return f
                    }
                    ...
                    feedData: function () {
                        ...
                        else return a.feedData.apply(a, arguments)
                    }, setData: function () {
    ...
    E.register("module", ["private", "modules.renderer.js-realtimestackedcolumn",
        function () {
            var b = this.hcLib.chartAPI;
            b("realtimestackedcolumn", {}, b.realtimecolumn, {
                isstacked: !0,
                enablemousetracking: !0
            })
        }
    ]);
    E.register("module", ["private", "modules.renderer.js-gaugebase",
        function () {
            var b = this.hcLib,
                k = !b.CREDIT_REGEX.test(this.window.location.hostname),
                d = b.chartAPI,
                a = b.extend2,
            ...
            d("gaugebase", {
                ...
                isWidget: !0,
                _createAxes: function () {}, _feedAxesRawData: function () {},
                    _setCategories: function () {}, _setAxisLimits: function () {}, realTimeUpdate: function (a) {
                        var b = this.components.dataset,
                            d = a.dataset;
                        a = a.categories && a.categories.category || [];
                        var u = this.config.realTimeConfig = this.config.realTimeConfig || (this.config.realTimeConfig = {}),
                            e, k, E;
                        if (b) {
                            E = d[0];
                            d = E.data;
                    ...
                    }, _clearChart: function () {}, _realTimeConfigure: d.realtimecolumn,
                _setRTmenu: function () {
                    var a =
                        this,
                        b = a.chartMenuTools,
        ...
        function () {
            ...
            k("axisgaugebase", {
                ...
                _createAxes: function () {
                    var a = this.components,
                        b = E.register("component", ["axis", "gauge"]);
                    a.scale = a = new b;
                    a.chart = this;
                    a.init()
                    ...
                    var n = this.components,
                        ...
                        J = a(k.ticksbelowgauge),
                        K = a(k.ticksonright),
                        J = a(k.axisontop, void 0 !== k.axisonleft ? !a(k.axisonleft) : void 0, void 0 !== J ? !J : void 0, void 0 !== K ? K : void 0, this.isAxisOpposite),
                        K = a(k.reverseaxis, this.isAxisReverse),
                        I = a(k.showtickmarks, 1),
                        G = a(k.showtickvalues),
                        I = G || void 0 === G ? I || void 0 !== G ? !0 : !1 : !1,
                        u = {
                    ...
                    var b = this.components,
                        d = this.jsonData.chart,
                        e = b.scale,
                        b = b.dataset[0].getDataLimits(); - Infinity === b.max && (b.max = 0);
                    ...
                    var b, d = this.config,
                        ...
                        k = e.dataset[0],
                        e = e.scale,
                        n = this.jsonData.chart,
                        E = a(n.showborder, this.is3D ? 0 : 1),
                        K = this.isHorizontal,
                        I = d.minChartWidth,
                        G = d.minChartHeight,
                        n = d.borderWidth = E ? a(n.borderthickness, 1) : 0,
                        L;
                    ...
                    var a = 0,
                        ...
                        E = [],
                        L = [],
                        K = this.components.dataset[0].components.data;
    ...
    E.register("module", ["private", "modules.renderer.js-funnelpyramidbase",
        function () {
            var b = this.hcLib,
                k = b.chartAPI,
                d = b.preDefStr,
    ...
    E.register("module", ["private", "modules.renderer.js-funnel",
        function () {
            var b = this.hcLib,
                k = !b.CREDIT_REGEX.test(this.window.location.hostname),
                b = b.chartAPI;
    ...
    E.register("module", ["private", "modules.renderer.js-pyramid",
        function () {
            var b = this.hcLib,
                k = !b.CREDIT_REGEX.test(this.window.location.hostname),
                b = b.chartAPI;
    ...
    E.register("module", ["private", "modules.renderer.js-vled",
        function () {
            var b = this.hcLib,
                k = b.pluckNumber,
                d = !b.CREDIT_REGEX.test(this.window.location.hostname),
                b = b.chartAPI;
            b("vled", {
                showRTvalue: !1,
                canvasPadding: !1,
                ...
                _getData: function () {
                    ...
                    u && (C = E.get("component", ["dataset", u])) && (k = "datasetGroup_" + u, e = E.register("component", ["datasetGroup", u]), u = a[k], e && !u && (u = a[k] = new e, u.chart = this, u.init()), b[0] ? (a = b[0].JSONData, a = a.data.length, u = d.data.length, a > u && b[0].removeData(u - 1, a - u, !1), b[0].JSONData = d, b[0].configure()) : (a = new C, b.push(a), a.chart = this, u && u.addDataSet(a, 0, 0), a.init(d)))
                }, _createAxes: function () {
                    var a = this.components,
                        b = E.register("component", ["axis", "gauge"]);
                    a.scale = a = new b;
        ...
        function () {
            ...
            a("vbullet", {
                ...
                _createAxes: function () {
                    ...
                    var a = this.components,
                        u = a.colorManager,
                        e = this.jsonData.chart,
                        C = b.chartPaletteStr.chart2D,
    ...
    E.register("module", ["private", "modules.renderer.js-hled",
        function () {
            var b = this.hcLib,
                k = !b.CREDIT_REGEX.test(this.window.location.hostname),
                b = b.chartAPI;
    ...
    E.register("module", ["private", "modules.renderer.js-hlineargauge",
        function () {
            var b = this.hcLib,
                k = b.pluck,
                d = b.getValidValue,
                ...
                n = b.getDashStyle,
                L = b.getFirstValue,
                D = b.parseUnsafeString,
                u = b.preDefStr,
                e = u.animationObjStr,
                C = u.configStr,
                N = b.pluckNumber,
                J = b.getFirstDefinedValue,
                K = b.graphics.convertColor,
                I = b.getColorCodeString,
                G = b.COMMASTRING,
                Z = Math.max,
                S = b.toRaphaelColor,
                c = b.priorityList,
                ...
                g = u.POSITION_TOP,
                H = u.POSITION_BOTTOM,
                u = !b.CREDIT_REGEX.test(this.window.location.hostname),
                B = b.chartAPI;
            B("hlineargauge", {
                showRTvalue: !1,
                canvasPadding: !1,
                ...
                _drawCanvas: function () {
                    var a = this.components,
                        ...
                        v = b.canvasLeft,
                        l = a.scale,
                        u = l.config.axisRange.min,
                        F = l.config.axisRange.max,
                        m = this.jsonData,
                        l = m.chart,
                        h = m.trendpoints && m.trendpoints.point,
                        m = N(l.showgaugeborder, 1),
                        ...
                        A = N(l.colorrangeborderalpha, l.gaugeborderalpha, 100),
                        x = m ? N(l.colorrangeborderthickness,
                            l.gaugeborderthickness, 1) : 0,
                        D = a.colorRange && a.colorRange.getColorRangeArr(u, F),
                        E = N(l.showshadow, 1),
                        t, L, ma, R, Aa = a.paper,
                        Q = a.colorManager,
                        ya, ua, M, l = this.get(C, e),
                        Ba = l.duration,
                        za = l.dummyObj,
                        fa = l.animObj,
                        sa = l.animType,
                    ...
                    if (h)
                        for (b = b.trendPointConfig, a.trendObjElems || (a.trendObjElems = []), a.trendZoneElems || (a.trendZoneElems = []), a.marker || (a.marker = []), c = 0, v = b.length; c < v; c += 1) h = b[c], R = t(h.startValue - u, h.endValue - u), h.isTrendZone ? ((w = a.trendZoneElems[l]) || (w = a.trendZoneElems[l] = Aa.rect({
                    ...
                    if (E = a.trendZoneElems)
                        for (; E[l];) E[l].hide(), l++;
                    if (q = a.marker)
                        for (; q[m];) q[m].hide(), q[m].shadow(!1), m++
                }, _configueTrendPoints: function () {
                    var c = this.jsonData,
                        g = this.config,
                        e = g.style,
                        u = c.trendpoints && c.trendpoints.point,
                        p, H = this.components,
                        v = H.scale.config,
                        l = v.axisRange,
                        F = l.max,
                    ...
                    var a = this.components,
                        b = this.jsonData.pointers,
                        c;
                    c = this.defaultDatasetType;
                    var d, a = a.dataset || (a.dataset = []);
                    c && (c = E.get("component", ["dataset", c])) && (a[0] ? (c = a[0].pointerArr && a[0].pointerArr.pointer && a[0].pointerArr.pointer.length, d = b && b.pointer && b.pointer.length || 0, c > d && a[0].removeData(c - d), a[0].pointerArr = b, a[0].configure()) : (c = new c, a.push(c), c.chart = this, c.init(b)))
                }, _getData: function (a, b) {
                    var d = this.components.dataset,
                        g, e, k = this.getJobList(),
                        n = function () {
                            return (e = d[0].components.data) && e[--a] ? (g = e[a].config, N(g.setValue, g.itemValue)) : null
                        };
                    if (d)
                        if ("function" === typeof b) k.eiMethods.push(F.addJob(function () {
                            b(n())
                        }, c.postRender));
                        else return n()
    ...
    E.register("module", ["private", "modules.renderer.js-hbullet",
        function () {
            var b = this.hcLib,
                k = b.pluck,
                d = b.pluckNumber,
                a = b.parseUnsafeString,
                n = !b.CREDIT_REGEX.test(this.window.location.hostname),
                E = b.chartAPI,
                D = b.BLANKSTRING,
                b = b.preDefStr,
            ...
            E("hbullet", {
                ...
                _RTmanageSpace: function () {
                    ...
                    var a, b = this.config,
                        ...
                        c = e.scale,
                        n = this.jsonData.chart,
                        g = d(n.showborder, this.is3D ? 0 : 1),
                        u, B = b.minChartWidth,
                        f = b.minChartHeight,
                        n = b.borderWidth = g ? d(n.borderthickness, 1) : 0;
                    ...
                    var b = this.config,
                        ...
                        g = this.linkedItems.smartLabel,
                        H = a(F.caption),
                        B = a(F.subcaption),
                        F = d(F.captionpadding, 2),
                        f = b.height,
                        r = 0,
                        y = 0,
                        K = 0,
                    ...
                    var a = this.config,
                        b = this.components,
                        d = b.caption.config,
                        b = b.subCaption.config,
                        e = d.captionPosition,
                        c = K(d.width, b.width),
                        k = a.borderWidth || 0,
                        g = d.captionSubCaptionGap;
                    switch (e) {
                    case N:
    ...
    E.register("module", ["private", "modules.renderer.js-thermometer",
        function () {
            var b = this.hcLib,
                k = b.chartAPI,
                d = b.pluck,
                ...
                D = b.HUNDREDSTRING,
                u = b.graphics.convertColor,
                e = L.gaugeFillColorStr,
                C = L.gaugeBorderColorStr,
                N = b.graphics.getLightColor,
                J = function (a) {
                    return void 0 !== a && null !== a
                },
    ...
    E.register("module", ["private", "modules.renderer.js-cylinder",
        function () {
            var b = this.hcLib,
                ...
                a = b.pluckNumber,
                n = b.extend2,
                E = b.graphics.getLightColor,
                D = b.graphics.convertColor,
                u = b.chartAPI,
                e = b.preDefStr,
                C = e.colors.FFFFFF,
                N = e.gaugeFillColorStr,
                J = e.gaugeBorderColorStr,
                K = function (a) {
                    return void 0 !== a && null !== a
                };
            u("cylinder", {
    ...
    E.register("module", ["private", "modules.renderer.js-angulargauge",
        function () {
            var b = this.hcLib,
                k = b.pluck,
                d = b.getValidValue,
            ...
            G("angulargauge", {
                ...
                _spaceManager: function () {
                    ...
                    var k = k.scale,
                        ...
                        v = 0,
                        v = f.pivotRadius,
                        l = g.dataLabels.style.fontSize,
                        D = g.dataLabels.style.lineHeight,
                        E = g.displayValueCount,
                        C = g.borderWidth,
                        G = g.minChartWidth,
                        m = g.minChartHeight,
                        v = 0,
                    ...
                    var a = this.components,
                        b = E.register("component", ["axis", "polarGauge"]);
                    a.scale = a = new b;
                    a.chart = this;
                    a.init()
                }, _feedAxesRawData: function () {
                    ...
                    var a = this.components,
                        b = a.dataset[0],
                        d = b.config,
                        b = b.graphics || (b.graphics = {}),
                        n = a.scale,
                        B = a.colorManager,
                        f = n.config.axisRange,
                        r = a.colorRange,
                        y = this.graphics.datasetGroup,
                        E = this.graphics.datalabelsGroup,
                        a = a.paper,
                        p = d.gaugeOuterRadius,
                        G = d.gaugeInnerRadius,
                        v = d.gaugeFillRatio,
                        l = d.gaugeBorderColor,
                        J = d.gaugeBorderThickness,
                        K = d.gaugeBorderAlpha,
                        m = d.gaugeFillMix,
                        h = d.gaugeOriginX,
                        w = d.gaugeOriginY,
                        q = d.gaugeStartAngle,
                    ...
                    for (b.pointGroup ? b.pointGroup.animateWith(A, Z, {
                        transform: "t" + h + C + w
                    }, r, S) : b.pointGroup = a.group("pointers", E).translate(h, w); t < pa; t += 1) ma = x[t], y = n.getAngle(Math.min(ma.maxvalue, f)), Aa = B.parseColorMix(ma.code, m), Q = B.parseAlphaList(ma.alpha, Aa.length), ya = B.parseRatioList(G / p * 100 + v, Aa.length), ua = ma.bordercolor, R = u(ma.borderAlpha,
                ...
                }, _setCategories: function () {}, _angularGaugeSpaceManager: function (a,
                    b, d, e, k, f, n, u, D, p) {
                    var E = void 0 !== k && null !== k,
                        v = void 0 !== f && null !== f,
                        l = void 0 !== n && null !== n,
                        C = 2 * Math.PI,
                        G = Math.PI,
    ...
    E.register("module", ["private", "modules.renderer.js-bulb",
        function () {
            var b = this.hcLib,
                k = !b.CREDIT_REGEX.test(this.window.location.hostname),
                d = b.chartAPI,
            ...
            d("bulb", {
                ...
                _createDatasets: function () {
                    ...
                    }, _drawCanvas: function () {}, _spaceManager: function () {
                        ...
                        var k = this.components,
                            ...
                            E = a(C.showborder, this.is3D ? 0 : 1),
                            J, K, I = b.minChartWidth,
                            G = b.minChartHeight,
    ...
    E.register("module", ["private", "modules.renderer.js-progressgauge",
        function () {
            var b = this.hcLib,
                k = b.chartAPI,
                b = !b.CREDIT_REGEX.test(this.window.location.hostname);
            k("progressgauge", {
                ...
                _createDatasets: function () {
                    var b = this.components,
                        ...
                        D = k.data || L && L[0].data,
                        u = this.defaultDatasetType,
                        e, C, L = this._dataSegregator(D);
                    this.config.categories = L.data;
                    k = b.dataset || (b.dataset = []);
                    if (!D || 0 === D.length) this.setChartMessage();
                        ...
                        if (D =
                            ...
                            if (D > C) {
                                if (a)
                                    for (u = C; u < D; u++) b[u] && b[u].legendItemId && a.removeItem(b[u].legendItemId);
    ...
    E.register("module", ["private", "modules.renderer.js-drawingpad",
        function () {
            var b = this.hcLib,
                k = b.Raphael,
                d = b.preDefStr,
    ...
    E.register("module", ["private", "modules.renderer.js-realtimearea",
        function () {
            var b = this.hcLib.chartAPI;
            b("realtimearea", {
    ...
    E.register("module", ["private", "modules.renderer.js-realtimeline",
        function () {
            var b = this.hcLib.chartAPI;
            b("realtimeline", {
    ...
    E.register("module", ["private", "modules.renderer.js-realtimelinedy",
        function () {
            var b = this.hcLib.chartAPI;
            b("realtimelinedy", {
                    isRealTime: !0,
