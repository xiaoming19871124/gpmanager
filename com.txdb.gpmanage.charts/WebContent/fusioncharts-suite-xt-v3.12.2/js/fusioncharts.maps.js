...
(function (T) {
    ...
    T.register("module", ["private", "modules.renderer.js-kdtree",
        function () {
            function q(h) {
                function m(h, p, z, q) {
                    var I = {},
                    ...
                    if (1 === z - p) return h[p][B] > h[z][B] ? (I.point = h[p], I.left = {
                        point: h[z]
                    }) : (I.point = h[z], I.left = {
                        point: h[p]
                    }), I;
                ...
                return {
                    tree: 0 === h.length ? {} : m(h, 0, h.length - 1, !1),
                    search: function (h,
                        m, z) {
                        function q(a, b) {
                        ...
                        function x(a) {
                            var c = h >= a.x1 && h <= a.x2 && m >= a.y1 && m <= a.y2,
                                d;
                            d = a.point.y;
                                ...
                                if (S(O, u, p, x, C) && 3 <= y) {
                                    ...
                                    for (M = 0; M < y; M++) {
                                        ...
                                        var Q = E,
                                            ...
                                            A = u,
                                            K = W(Q, V, Y, I, B, Z),
                                            ca = W(Q, V, Y, I, Infinity, A),
                                            ea = W(B, Z, Infinity, A, Q, V),
    ...
    T.register("module", ["private", "modules.renderer.js-gradientlegend",
        function () {
            function q(e, b) {
                (function c(b, g) {
                    var l, f;
            ...
            var L = this,
                ...
                B = G.getLightColor,
                Z = G.getValidColor,
                A = "rgba(192,192,192," + (N.isIE ? .002 : 1E-6) + ")",
                K, ca = N.COLOR_BLACK,
                ea = {}.hasOwnProperty,
                da, fa = {};
            K = function () {
                function e(a) {
                    var c = b.numberFormatter,
                        l, f, k;
                    l = 0;
                    for (f = a.length; l < f; l++)
                        if (k = a[l].maxvalue) a[l].maxvalue = c.getCleanValue(k)
                }
                var b, a, c = {
                    legendCarpetConf: {
                        spreadFactor: .85,
                ...
                return {
                    init: function (c) {
                        a =
                            c.chart;
                        b = a.components
                    }, setConf: function (a) {}, legacyDataParser: function (a, c) {
                        var l = {},
                            f = b.numberFormatter,
                            k, t, n, F, h, m, r, v, q;
                        if (!a) return !1;
            ...
            da = function (e) {
                ...
                return function () {
                    function c() {
                        ...
                        for (b in a)
                            for (c in d = a[b], d)
                                if (g = d[c], g instanceof Array)
                                    for (l = 0, e = g.length; l < e; l++) g[l] && g[l].hide();
                                else g.hide()
                    }
                    var d, g = {},
                        l;
            ...
            U.prototype.draw = function (e) {
                var b = this.conf,
                    a = this.compositionsByCategory,
                    c = e.paper,
                    d = e.parentGroup,
                    g = e.componentPool,
                    l, f, k = g.getChart().get("config", "animationObj").duration,
                    t, n = g.getKeys();
            ...
            h.prototype.getBoundingBox = function (e) {
                var b = this.conf,
                    ...
                    g = e.x,
                    l = e.y,
                    b = b.height = a * b.spreadFactor;
                !c || void 0 !== l && null !== l || (l = (d + a) / 2 - b / 2);
                return {
                    width: e.maxOtherSide,
                    height: b,
                    x: g,
                    y: l
                }
            ...
            y.prototype.getLogicalSpace =
                function (e, b, a) {
                    ...
                    n = 0;
                    for (F = y.SC_STACK.length; n < F; n++)
                        if (d = g[y.SC_STACK[n]]) l = k(l, d.conf.spreadFactor), l = d.getLogicalSpace(q(l, {}), b, a), t += this.getSpaceTaken(l);
            ...
            y.prototype.draw = function () {
                var e = this.childTextConf,
                    b = this.conf.bound.style || {},
                    a = this.compositionsByCategory,
                    c, d, g, l, f, k, t;
                ...
                f.moveInstructions && e.attr({
                    transform: f.moveInstructions
                });
                return {
                    bound: b,
                    group: e
            ...
            m.prototype.getLogicalSpace = function (e, b, a) {
                ...
                m = b.getSmartText("W");
                f = 0;
                for (d = l.length; f < d; f++)(n = l[f].label) ? (r++, p.push({
                    oriIndex: f,
                    label: n
                })) : h[f] = void 0;
                d = p.length;
            ...
            m.prototype.draw = function () {
                ...
                for (g = l.length; f < g; f++)
                    if (c = l[f]) k = d.y + c.height / 2, t = f === g - 1 ? d.x + c.x - c.width / 2 : f ? d.x + c.x : d.x + c.x + c.width / 2, this.node.push(n({}, e).attr({
                        text: c.text,
                        x: t,
                        y: k,
                        lineHeight: this._metaStyle.lineHeight,
            ...
            W.prototype.draw = function () {
                ...
                f = 0;
                for (g = l.length; f < g; f++)
                    if (c = l[f]) k = d.x + c.height / 2, t = f === g - 1 ? d.y + c.y - c.width / 2 : f ? d.y + c.y : d.y + c.y + c.width / 2, this.node.push(n({}, e).attr({
                        text: c.text,
                        x: k,
                        y: t,
                        lineHeight: this._metaStyle.lineHeight,
            ...
            z.prototype.draw = function () {
                ...
                for (f = c.length; a < f; a++)
                    if (t = k[a]) c = l.y + t.height / 2, d = a === f - 1 ? l.x + t.x - t.width / 2 : a ? l.x + t.x : l.x + t.x + t.width / 2, n({},
                        g).attr({
                        text: t.text,
                        x: d,
                        y: c,
            ...
            x.prototype.draw = function () {
                ...
                for (k = l.length; f < k; f++)
                    if (l = g[f]) d = c.x + l.width / 2, t = f === k - 1 ? c.y + l.y - l.height / 2 : f ? c.y + l.y : c.y + l.y + l.height / 2, n({}, e).attr({
                        text: l.text,
                        x: d,
                        y: t,
                        lineHeight: this._metaStyle.lineHeight,
            ...
            J.prototype.getLogicalSpace = function (e, b, a) {
                ...
                var f = this.compositionsByCategory,
                    k;
                k = 0;
            ...
            J.prototype.draw = function () {
                var e, b = this.conf,
                    a = b.line,
                    c = (b.bound || {}).style || {},
                    d, g, l = this.compositionsByCategory,
                    f, k, t, n, h, m;
                2 <= arguments.length ?
            ...
            p.prototype.draw = function (e, b, a) {
                ...
                this.updateWhenInMove = function (a, b) {
                    this.updateWhenInMove = function (c, d) {
                        var g = this.extremes,
                            g = this.getValueFormPixel(c.sliderIndex ? g[1] - g[0] + d : d);
            ...
            p.prototype.dragStarted = function (e) {
                ...
                L.raiseEvent("legendpointerdragstart", {
                    ...
                    pointers: [{
                        value: this.getValueFormPixel(b[!1].currPos)
                    }, {
            ...
            p.prototype.dragCompleted = function (e, b, a) {
                var c = this.sliders,
                    d = this.extremes,
                    g = e.conf,
                    l = this.getValueFormPixel(c[!1].currPos),
                    c = this.getValueFormPixel(d[1] - d[0] + c[!0].currPos),
                    f = this._fcChart,
                    k;
            ...
            C.prototype.draw = function (e, b, a, c) {
                var d = c.parentLayer,
                    ...
                    l = g.outerCircle,
                    f = g.innerCircle,
                    k = Math.ceil(l.rFactor * c.rCalcBase / 2),
                    t = Math.ceil(f.rFactor * c.rCalcBase / 2),
                    n = k - t,
                    h = this.rangeGroup,
                    m = this.sliderIndex,
                    w, r, v = c.componentPool,
                    q = v.getKeys();
                g.outerRadius = k;
                g.innerRadius = t;
                this._scaleVal = b;
                ...
                d = this.node = r("fc-gl-slider", d).attr({
                    cursor: "pointer",
                    transform: "t0,0"
                });
            ...
            C.prototype.getDragAPI = function (e) {
                ...
                return {
                    dragging: function (n, h) {
                        ...
                        v < m ? r += m - v : v > w && (r -= v - w);
                        a.attr({
                            transform: e ? "t0," + (b.currPos + r) : "t" + (b.currPos + r) + ",0"
                        });
                        l = r;
                        f && clearTimeout(f);
                        ...
                        c.preventDefault();
                        a.attr({
                            transform: e ? "t0," + b.currPos : "t" + b.currPos + ",0"
                        });
                        g = g || b.swing;
                        t = !1;
                        d.dragStarted(b)
            ...
            T.register("component", ["gradientLegend", "gradientLegend", {
                ...
                init: function (e) {
                    ...
                    var e = this._chart,
                        ...
                        a = this.conf = {},
                        c = b.outcnvbasefont,
                        d = b.outcnvbasefontsize,
                        g = b.outcnvbasefontcolor,
                        e = e.config.dataLabelStyle,
                        l, f, k, t, n, h, m;
                    ...
                    a.sliderGroupConf = {
                        ...
                        outerCircle: {
                            ...
                            style: {
                                stroke: V(D(b.legendpointerbordercolor, "757575"), E(b.legendpointerborderalpha, 100))
                            }
                        },
                        innerCircle: {
                            rFactor: E(b.sliderholediameterfactor),
                            style: {
                                stroke: V(D(b.legendpointercolor, "FFFFFF"), E(b.legendpointeralpha, 100))
                            }
                        }
                    };
                    a.legendCarpetConf = {
    ...
    T.register("module", ["private", "modules.renderer.js-maps",
        function () {
            var q = this,
                R = q.window,
                u = q.hcLib,
                ...
                X = u.parseTooltext,
                m = u.pluckNumber,
                W = u.graphics.getLightColor,
                z = u.dropHash,
                x = u.HASHSTRING,
                J = u.parseUnsafeString,
                P = u.getDashStyle,
                p = u.schedular,
                ...
                O = u.setLineHeight,
                M = u.graphics.convertColor,
                L = R.navigator.userAgent,
                N = /msie/i.test(L) && !R.opera,
                E = u.hasSVG,
                D = R.Math,
                H = D.min,
                G = D.max,
                ga = /stroke/ig,
                ha = /AppleWebKit/.test(L),
                V = D.ceil,
                Y = Math.PI / 180,
                I = u.hasTouch,
                R = !u.CREDIT_REGEX.test(R.location.hostname),
                B = u.toRaphaelColor,
                Z = "rgba(192,192,192," + (N ? .002 : 1E-6) + ")",
                A = function (b, a) {
                    var c;
                    b || (b = {});
                    for (c in a) b[c] = a[c];
            ...
            S("geo", {
                ...
                init: function (b, a, c, d) {
                    ...
                    var b = this.graphics || (this.graphics = {}),
                        a = this.components.paper,
                        b = this.graphics;
                    ...
                    var b = this.linkedItems,
                        b = b.eventListeners || (b.eventListeners = []),
                    ...
                    if (a.linkedItems.container) {
                        var d = u.getMouseCoordinate(a.linkedItems.container, b),
                            g = d.chartX,
                            l = d.chartY,
                            f = a.config,
                            k = f.canvasLeft,
                            e = f.canvasTop,
                            n = f.canvasLeft + f.canvasWidth,
                    ...
                    var b = this.components,
                        ...
                        g = a.markers,
                        a = 0,
                        l = this.components.dataset,
                        l = b.dataset || (b.dataset = []);
                    c && c.toLowerCase();
                    ...
                    var b = this.components.background.config,
                        a = this.components.colorPalette,
                    ...
                    var b = this.jsonData.chart || this.jsonData.map,
                        a = this.components.colorPalette;
                    return {
                        FCcolor: {
                    ...
                    var b = this.config,
                        a = this.jsonData.chart || this.jsonData.map,
                        c = this.components.canvas.config;
                    ...
                    b.addEventListener("internal.mapdrawingcomplete", function () {
                        return function (a) {
                            a.detachHandler();
                            E && (c.datasetGroup && c.datasetGroup.attr({
                                    transform: g.transformStr
                                }),
                                c.shadowGroup && c.shadowGroup.attr({
                                    transform: g.transformStr
                                }));
                    ...
                    if (h)
                        for (w in h.calculateMarkerRadiusLimits(),
                    ...
                    var b = this.config,
                        a = this.components.legend.config.legendPos,
                        c = this.jsonData.chart,
                        d = b.origMarginLeft,
                        g = b.origMarginTop,
                        l = this.baseWidth,
                        ...
                        h = 0,
                        ba, e = b.markerOpts,
                        c = b.borderWidth = b.showBorder ? m(c.borderthickness, 1) : 0;
                    this._allocateSpace({
                        top: c,
                        bottom: c,
                        left: c,
                    ...
                    var b =
                        this,
                        a = b.getJobList(),
                        c = b.components.mapAnnotations,
                        d = b.components.mapLabelAnnotations || [],
                        g = d.length,
                        l, f, k = function (a, k) {
                            return function () {
                                l.draw.call(a, k, !0);
                                b.config.labelDrawCount++;
                                if (b.config.labelDrawCount === g && e && (h = c.groups && c.groups[0] && c.groups[0].wrapper))
                                    for (f = 0; f < g; f++)(m = d[f].groups[0] && d[f].groups[0].wrapper) && m.insertAfter(h)
                            }
                        },
                        e = b.config.entityOpts.labelsOnTop,
                        h, m;
                    ...
                    if (b.config.entityFlag && b.config.entitiesReady) {
                        ...
                        q.raiseEvent("internal.mapdrawingcomplete", {
                            renderer: b
                        }, b.chartInstance)
                    }
                }, colorPaletteMap: {
                    ...
                    getMapName: function () {
                        ...
                        var b = this.jsVars.instanceAPI.components.dataset || [],
                            a, c, d, g = b.length,
                            l = [],
                            f;
                        for (a = 0; a < g; a++)
                            if (d = b[a] || [], f = d.type, "entity" === f) {
                                c = d;
                                break
                            }
                        b = c.components.data;
                        ...
                        var c = this.jsVars.instanceAPI.components.dataset || [],
                            d = c.length,
                            g, l, f, k;
                        for (g = 0; g < d; g++)
                            if (l = c[g] || [], k = l.type, "markers" === k) {
                                f = l;
                                break
                            }
            ...
            T.register("component", ["dataset", "Entities", {
                ...
                configure: function () {
                        var b = this.chart,
                            ...
                            d = b.components,
                            g = a.map || a.chart,
                            l, b = u.nonGradientColorRange,
                            f = (a.colorrange || {}).gradient,
                            k = d.postLegendInitFn,
                            e = d.numberFormatter,
                            h, F = {},
                            d = a.entitydef || [];
                        ...
                        f ? k({
                            min: F.min,
                            max: F.max
                        }) : this.components.colorRange = new b({
                        ...
                        for (k in c) g = c[k], l = g.config, f = l.cleanValue, l = l.alphaArr || [], l = {
                            "fill-opacity": l[0] / 100 || 1
                        }, f < b || f > a ? (this.setCustomAttrs(g, e, d), g.hidden = !0) : (g.hidden = !1, this.setCustomAttrs(g, l, d))
                    }, _addLegend: function () {
                        var b = this.chart.components.legend,
                            a = (this.components.colorRange || {}).colorArr || [],
                            c = this.components.entityColorMap = this.components.entityColorMap ||
                            (this.components.entityColorMap = []),
                            d, g, l = a.length,
                            f, k, e;
                        b.emptyItems();
                        g = c.length = 0;
                        for (l = a.length; g < l; g++) d = a[g], k = h(d.code, d.color), f = W(k, 60).replace(z, x), e = W(k, 40), k = {
                            ...
                            config: {}
                        }), k.config = d, k.visible = !0, k.dataset = this, k.legendItemId = b.addItems(k, this.legendInteractivity, f)
                        ...
                        var c = this.config,
                            ...
                            e, h, m = a.config,
                            ba = a.graphics,
                            w, r = l.components.colorRange,
                            v = c.itemHiddenStyle.color,
                            c = c.itemStyle.color,
                            q = m.fillColor;
                        h = {};
                        var p, u = {},
                        ...
                        var b = this.chart,
                            a = this.conf,
                            c = b.jsonData.data || [],
                            b = b.components.numberFormatter,
                            d, g = Infinity,
                            l = -Infinity,
                            f, k;
                        k = 0;
                        ...
                        var d = this.chart,
                            ...
                            f = d.components,
                            k = f.numberFormatter,
                            e = d.config.entityOpts,
                            n = a.config,
                            d = a.labelConfig,
                            F = c.value,
                            q = l.colorrange && l.colorrange.gradient,
                            w = (f = f.gradientLegend) && f.colorRange,
                            r = this.components.colorRange,
                            f = n.cleanValue = k.getCleanValue(F),
                            v = n.formattedValue = void 0 !== f ? k.dataLabels(f) : void 0,
                            k = m(c.showtooltip, e.showTooltip),
                            l = this._getDefaultTooltip.call(a, c, this),
                            v = {
                                formattedValue: v,
                                sName: c.shortLabel,
                                lName: c.label
                        ...
                        d.toolText = k;
                        d.link = f;
                        if ("object" === typeof n.options)
                            for (f = n.entityLabels = n.entityLabels || [], l = n.labels || [], v = l.length; v--;) f[v] || (f[v] = {
                                config: {}
                            }), d = f[v].config, (F = l[v].labelAlignment) ? (g = F[0], F = F[1]) : (g = "center", F = "middle"), d.align = g, d.vAlign = F, d.displayValue = this.getDisplayValue.call(a, l[v], n.options.isDataEnabled, !v, c), d.bgColor = "", d.borderColor = "", d.toolText = k, d.align = g, d.vAlign = F, d.bgColor = "", d.borderColor = "", d.fontColor = e, d.fontFamily = b, d.fontBold = x, d.toolText = k;
                        else n = {
                            shortText: n.shortLabel,
                            text: n.label
                        }, d.displayValue = this.getDisplayValue.call(a, n, !0, !0, c)
                    }, getDisplayValue: function (b, a, c, d) {
                        var g = this.dataset.chart.config.entityOpts,
                            l = this.config,
                            f = l.cleanValue,
                            e = l.formattedValue,
                            m = g.labelSepChar;
                        ...
                        var a = this.conf,
                            c = {},
                            d = {},
                            g = this.chart.entities,
                            l = a.useSNameAsId,
                            f, e, h, n, m, q, w, r = 0,
                            v, p;
                        for (f = b.length; f--;)
                            if (e = b[f], h = e.internalid, n = e.newid ? e.newid : h, m = e.sname, q = e.lname, v = g[h], h = u.trimString(h), n = (n = u.trimString(n)) &&
                                n.toLowerCase(), v) {
                                c[n] = n = {
                                    origId: h
                                };
                        ...
                        for (w in c) w = w.toLowerCase(), v[w] || (v[w] = {
                            config: {}
                        }), v[w].config = c[w], r += 1;
                        c = v;
                        for (w in g)
                            if (n = g[w], w = u.trimString(w), !d[w]) {
                        ...
                        var b = this,
                            ...
                            c = b.chart,
                            d = c.getJobList(),
                            c = c.entities.firstEntity,
                            g = b.components.data,
                            l = a.BATCH_SIZE,
                            f = a.entityKeys = c ? b._getKeys(c, g) : Object.keys(g),
                            e = a.entityLength = f.length,
                            h, n, m, q, w, r = function (a) {
                                return function () {
                                    v(a)
                                }
                            },
                        ...
                        for (var a =
                            ...
                            if (e = c[f[b]], n = e.config, (n = n.options) && !1 === n.isDataEnabled || a.addMouseGestures.call(e), h++, h === l) {
                        ...
                        var a = this.config.cleanValue,
                            c = this.config.formattedValue,
                        ...
                        var c = this.chart,
                            d = c.components.paper,
                            g = b.config,
                            e = E || !N ? "litepath" : "path",
                            f = g.outlines,
                            k = c.graphics.datasetGroup,
                            h = c.graphics.shadowGroup,
                            n = g.toolText,
                            c = c.config.entityOpts.shadow,
                            m, q = [],
                            w,
                            r, v, p, u, x, B, A;
                        ...
                        if ("object" === typeof g.options) {
                            for (; m--;) {
                                q = f[m].outline;
                                if (!0 === g.options.isDataEnabled) v = r;
                                else {
                                    v = y({}, r);
                                    p = f[m].style;
                                    u = B;
                                    ...
                                    if (p && "object" === typeof p)
                                        for (z in p) ga.test(z) || ("stroke-width" === z ? (C[z] =
                                ...
                                !p[m] && (p[m] = {});
                                (u = p[m].outline) ? u.attr({
                                    "fill-opacity": w
                                }): u = p[m].outline = d[e](q, k);
                            ...
                            if (b.graphics.outlines) b.graphics.outlines.attr(r).attr({
                                "fill-opacity": w
                            });
                            else {
                                for (; m--;)
                                    if (w = f[m], q = w.concat(q), x++, g.outlineStartIndex = m, x === a) return g.outlinePath = q, x;
                        ...
                        var a = this.chart,
                            c = a.config,
                            d = a.components.gradientLegend,
                            g = b.config,
                            e = a.config.scalingParams,
                            f = !N || E,
                            k = e.scaleFactor,
                            h = e.strokeWidth,
                            n = (f ? a.baseScaleFactor : 1) * h,
                            m = 1 === a.config.entityOpts.scaleBorder,
                            q = g.borderThickness,
                            p = g.origConnectorThickness,
                            r = g.hoverBorderThickness,
                            v = g.visibleEntityAttr,
                            u = v["fill-opacity"];
                        g.shadowOptions = {
                            scalefactor: [k,
                                k * a.baseScaleFactor
                            ],
                            opacity: G.apply(D, g.alphaArr) / 100
                        };
                    ...
                    drawLabels: function (b) {
                        ...
                        for (var a = this, c = a.conf, d = a.chart.getJobList(), g = a.components.data, e = c.BATCH_SIZE, c = c.entityKeys, f, k = c.length, h, n, m = function (b) {
                            ...
                            n = g[c[b]];
                            f = n.config;
                            if ("object" === typeof f.options)
                                for (f = (h = f.labels) && h.length || 0; f--;) h[f].labelConnectors && (a.drawLabelConnectors.call(n, h[f].labelConnectors), q++);
                            else f.labelConnectors && (a.drawLabelConnectors.call(n,
                                f.labelConnectors), q++); if (q === e) {
                        ...
                        var c = this,
                            ...
                            g = d.chart,
                            e = c.config,
                            f, k = g.config.scalingParams,
                            h, n, m = c.graphics && c.graphics.outlines,
                            p, w = e.fontSize,
                            r = e.labelPadding;
                        n = e.labels || [];
                        f = e.entityLabels || [];
                        ...
                        return {
                            ...
                            onclick: function (a) {
                                ...
                                var b = c.graphics.outlines,
                                    g, f;
                                if (b instanceof Array)
                                    for (g = 0, f = b.length; g < f; g++) d.entityRollOver.call(b[g].outline, a);
                                else d.entityRollOver.call(b,
                                    a)
                            }, onmouseout: function (a) {
                                var b = c.graphics.outlines,
                                    g, f;
                                if (b instanceof Array)
                                    for (g = 0, f = b.length; g < f; g++) d.entityRollOut.call(b[g].outline, a);
                                else d.entityRollOut.call(b, a)
                            }, ontouchstart: function (a) {
                                var b = c.graphics.outlines,
                                    g, f;
                                if (b instanceof Array)
                                    for (g = 0, f = b.length; g < f; g++) d.entityRollOver.call(b[g].outline, a);
                                else d.entityRollOver.call(b, a);
                        ...
                        var a = this.dataset,
                            ...
                            d;
                        if (c.showLabel)
                            if ("object" === typeof c.options)
                                for (d = (d = c.labels) &&
                                    d.length || 0, c = c.options.isDataEnabled; d--;) b.push(a._getLabelObject.call(this, d, c, !d));
                            else b.push(a._getLabelObject.call(this, void 0, !0, !0))
                        ...
                        for (var a = this.config, c = this.dataset.chart, d = c.components.paper, g = c.config.scalingParams, c = c.graphics.datasetGroup, e = b && b.length || 0, f, k, h = a.showLabel; e--;) k = b[e], f = this.graphics.connectorElem, h ? (f || (this.graphics.connectorElem = f = d.path(k, c)), f.show().attr({
                            transform: E || !N ? "" : g.transformStr,
                            stroke: M(a.connectorColor, a.connectorAlpha),
                            "shape-rendering": "crisp",
                            "stroke-width": a.connectorThickness
                        })) : f && f.hide()
                    }, entityClick: function (b) {
                        var a = this.node.__entity,
                            c = a.dataset.chart,
                            d = c.linkedItems.linkClickFN,
                            a = a.config,
                            g = a.link;
                        ...
                        var a = this,
                            c = this.node.__entity,
                            d, g = c.config.revertAttr;
                        ...
                        var b = this,
                            ...
                            c = b.dataset,
                            d = b.graphics,
                            g = a.hoverBorderThickness,
                            e = a.hoverBorderColor,
                            f = a.hoverBorderAlpha,
                            k = a.entityBorderThickness,
                            h = a.borderColor,
                            n =
                            a.borderAlpha,
                            q = a.link,
                            p = a.visibleEntityAttr,
                            w = "groupId" + a.originalId,
                            r, v = function (d) {
                                void 0 !== q && d.css({
                                    cursor: "pointer",
                                    _cursor: "hand"
                        ...
                        a.revertAttr = {
                            fill: B(a.fillColor),
                            stroke: B(a.borderColor, a.borderAlpha)
                        };
                        ...
                        for (r in d)
                            if (d.hasOwnProperty(r)) {
                                if (d[r] instanceof Array)
                                    for (k = d[r], g = 0, f = k.length; g < f; g++) e = k[g].outline, v(e);
                                else e = d[r], v(e);
            ...
            T.register("component", ["dataset", "Markers", {
                ...
                configure: function () {
                    ...
                    var b = this.chart,
                        a = b.jsonData.markers,
                        c = a.items,
                        d = a.shapes,
                        a = b.config.markerOpts,
                        g = b.components.numberFormatter,
                    ...
                    if (c && c.length) {
                        if (d && d.length)
                            for (k = d.length; k; --k)
                                if (n = d[k - 1], r = n.id.toLowerCase()) e[r] = n;
                        for (k = c.length; k--;)
                            if (n = c[k], r = n.id && n.id.toLowerCase()) d = n.value, void 0 !== d && "" !== d && (d = parseFloat(d)), t = this._initializeMarkerItem(r, n, null, b), (q = t.config.options.shapeid) && "string" === typeof q && (q = q.toLowerCase()), p = t.config, w = p.options, p.cleanValue = g.getCleanValue(d), p.formattedValue = null !== p.cleanValue ? g.dataLabels(d) : void 0, p.fillColor = h(w.fillcolor, w.color, a.fillColor), p.fillAlpha = h(w.fillalpha, w.alpha, a.fillAlpha), p.fillRatio = h(w.fillratio, a.fillRatio), p.fillAngle = h(w.fillangle, a.fillAngle), p.borderThickness = m(w.borderthickness, a.borderThickness), p.borderColor = h(w.bordercolor, a.borderColor), p.borderAlpha = h(w.borderalpha, a.borderAlpha),
                    ...
                    var b = this.chart,
                        a = b.jsonData.markers,
                        c = a.definition,
                        d = b.components.numberFormatter,
                        g = b.config.markerOpts,
                        e = fa(c) || {},
                        f = fa(a.application) || {},
                        k = a.shapes,
                        a = this.components.shapeObjs = this.components.shapeObjs || (this.components.shapeObjs = {}),
                        q = this.components.markerObjs = this.components.markerObjs || (this.components.markerObjs = {}),
                        n, p, u, w;
                    if (c && c.length) {
                        if (k &&
                            k.length)
                            for (c = k.length; c; --c)
                                if (n = k[c - 1], w = n.id.toLowerCase()) a[w] = n;
                    ...
                    d = parseFloat(d);
                    c = parseFloat(c);
                    return isNaN(d) || isNaN(c) ? isNaN(d) ? isNaN(c) ? {
                        min: b,
                        max: a
                    } : {
                    ...
                    var b = this.chart,
                        a = b.jsonData.markers || {},
                        a = a.connector || a.connectors || [],
                        c = this.components.markerObjs,
                        d = a.length,
                        g = this.components.connectors,
                        e = function (a) {
                            return function (c) {
                                var d = c.data,
                                    g = d.wrapper;
                        ...
                        t = b.config.connectorOpts,
                        n = {},
                        p, u, w, r, v, x, z, A, B, C, E, D, H;
                    g || (g = this.components.connectors = []);
                    for (H = 0; H < d; H++)
                        if (D = a[H], D.from || D.to) u = c[D.from.toLowerCase()], w = c[D.to.toLowerCase()], u && w && (r = a[H].label, n = g[H], !n && (n = g[H] = {}), !n.config && (p = n.config = {}), !n.graphics && (n.graphics = {}), p = n.config = y({}, D), p.fromMarker = u, p.toMarker = w, p.link = D.link, p.showTooltip = m(D.showtooltip, t.showTooltip), v = p.tooltext =
                            p.showTooltip ? h(D.tooltext, t.tooltext) : "", x = p.thickness = h(D.thickness, t.thickness), z = p.color = h(D.color, t.color), A = p.alpha = h(D.alpha, t.alpha), p.hoverEffect = m(D.showhovereffect, t.showHoverEffect), B = h(D.hovercolor, t.hoverColor, z), C = h(D.hoveralpha, t.hoverAlpha, A), E = h(D.hoverthickness, t.hoverThickness, x), p.dashed = h(D.dashed, t.dashed), p.dashLen = m(D.dashlen, t.dashlen), p.dashGap = m(D.dashgap, t.dashgap), v && (p.tooltext = v = J(X(v, [3, 40, 41, 42, 43], {
                                label: r,
                                fromId: u.config.definition.id,
                                toId: w.config.definition.id,
                                fromLabel: u.config.definition.label,
                                toLabel: w.config.definition.label
                            }, void 0))), p.eventArgs = {
                    ...
                    var b = this,
                        a = b.chart,
                        c = b.conf,
                        d = a.components.mapAnnotations,
                        g = b.components.markerObjs,
                        e = a.config,
                        f = e.markerOpts,
                        k = e.scalingParams,
                        e = [],
                    ...
                    var b = this.components.kdArrayMap,
                        a = this.components.markerGroup,
                        c = [],
                        d, g = a && a.items,
                        l = g && g.length || 0;
                    for (d = 0; d < l; d++) a =
                    ...
                    var b = this,
                        ...
                        p = f.definition,
                        n = d.markerOpts,
                        d = n.dataLabels.style,
                        q = k.shapeid,
                        u = k.scale || 1,
                        w = k.label || "",
                        r = c.config.scalingParams.scaleFactor * c.baseScaleFactor,
                        c = (k.labelpos || "top").toLowerCase(),
                        v = f.formattedValue,
                        x = k.tooltext,
                        g = m(p.radius, f.radius, n.radius) * u * g.autoScale || 1E-4,
                        p = f.fillColor,
                        z = f.fillAlpha,
                        A = f.fillRatio,
                        C = f.fillAngle,
                        ...
                        E = f.borderColor,
                        H = f.borderAlpha,
                        G, I, K = a.components.kdArrayMap || (a.components.kdArrayMap = {}),
                        L = b.config.id;
                    ...
                    if (q) {
                        ...
                        q = {
                            alpha: k.fillalpha,
                            color: k.fillcolor,
                            angle: 360 - k.fillangle,
                            ratio: k.fillratio
                        };
                        x = {
                            alpha: k.hoverfillalpha,
                            color: k.hoverfillcolor,
                            angle: 360 - k.hoverfillangle,
                            ratio: k.hoverfillratio
                        };
                        k._defaultattrs = {
                            fill: B(q),
                        ...
                        "image" === k.type ? (k.borderthickness = k.borderthickness || 0, k.onload = function (c) {
                            ...
                            c = c.height;
                            var f = {},
                                k = (Number(d.x) - g / (2 * e.sFactor)) * e.sFactor,
                        ...
                        return {
                            markerShape: k,
                            markerLabel: f.drawOptions.label
                        }
                    }
                }, getHoverFn: function () {
                    var b = this.chart;
                    return function () {
                        var a = this.data("marker"),
                            c = a.markerShape,
                            d = c.options,
                            g = c.bounds,
                            e = d._markerEventArgs,
                            f = c.wrapper,
                            k = c.fillOptions,
                    ...
                    var b = this;
                    return function (a) {
                        var c = this.data("marker"),
                            d = b.chart,
                            e = d.config.scalingParams,
                            h = e.translateX,
                            e = e.translateY,
                            f = c.markerShape,
                            c = f.options,
                            f = f.bounds,
                            k = c._markerEventArgs;
                    ...
                    var a = b.element,
                        c = this.chart,
                        d = c.graphics,
                        e = c.components.paper,
                        h = d.trackerElems || (d.trackerElems = {}),
                        f = b.shapeInfo,
                        k, m = b.x,
                        n = b.y,
                        p, q, u;
                    ...
                    !1 === b ? (k = k && k.shapeInfo.type, (h = h[k]) &&
                        h.hide(), c.config.lastHoveredPoint = null) : (k = f.type, "circle" === k && (k = "polygon"), h = h[k], "polygon" === k ? (p = f.sides || 1, q = f.startAngle, f = f.radius, h ? h.attr({
                        polypath: [p, m, n, f, q]
                    }) : (h = d.trackerElems[k] = e.polypath(p, m, n, f, q), r = !0)) : "rect" === k ? (q = f.width, f = f.height, h ? h.attr({
                        x: m,
                        y: n,
                        width: q,
                        height: f
                    }) : (h = d.trackerElems[k] = e.rect(m, n, q, f), r = !0)) : "arc" === k && (p = a.markerShape.bounds.innerR, u = a.markerShape.bounds.angles, q = u.start * Y, u = u.end * Y, f = f.radius, h ? h.attr({
                        ringpath: [m, n, f, p, q, u]
                    }) : (h = d.trackerElems[k] = e.ringpath(m,
                    ...
                    var b = this.chart,
                        a = this.components.connectors,
                        c = a.length,
                        d = b.config.scalingParams,
                        e = b.config.connectorOpts,
                        h = e.showLabels,
                        f = b.components.mapAnnotations,
                        k, m = [],
                        n = [],
                        p, q, u, r, v = [];
                    v.push({
                    ...
                    var a = this.components.markerObjs,
                        c = this.components.shapeObjs,
                        d = this.components.markerGroup,
                        e = this.components.markerLabelGroup,
                        h, f;
                    ...
                    var c = this.chart.components.mapAnnotations,
                        d, e = this.components.markerObjs[b];
