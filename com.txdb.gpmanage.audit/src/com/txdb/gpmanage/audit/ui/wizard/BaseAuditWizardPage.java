...
public abstract class BaseAuditWizardPage extends WizardPage {
	...
	public final static String AUDIT_NAME = "#AUDIT_NAME";

	protected BaseAuditWizardPage(String pageName, String title) {
		super(pageName);
		setTitle(title);
	}
