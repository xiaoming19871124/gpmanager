package com.txdb.gpmanage.audit.i18n;
...
public class ResourceHandler {
	private static final String DEFAULT_RES_BUNDLE_NAME = "com.txdb.gpmanage.audit.i18n.message";
	...
	public static String getValue(String key, Object[] paramValues) {
		...
		return MessageFormat.format(
				getBundle(Locale.getDefault()).getString(key), paramValues);
	}
